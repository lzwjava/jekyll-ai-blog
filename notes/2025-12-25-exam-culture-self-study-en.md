...
title: Exam Culture and Self-Study Frustrations in China
translated: false
type: note
---
...
- High pressure leading to anxiety, burnout, or mental health issues.
- Suppression of individuality and innovation.
...
**Positive views**:
- People praise it for enabling self-improvement, career advancement (e.g., promotions, civil service exams), and lifelong learning.
- Many who persist value the challenge and see it as rewarding.

**Negative views**:
- Many call it difficult due to self-discipline requirements, limited study time for working adults, and low pass rates (often 10-30%, partly from absences or dropouts).
- Frustration arises from repeated failures, especially in math-heavy or theoretical subjects.
- Some criticize mandatory ideological courses (e.g., Mao Zedong Thought or Xi Jinping Thought) as outdated or propagandistic, though this complaint is less vocal than for general exams.
- Dropouts often express regret or "hate" the process for its demanding nature.
