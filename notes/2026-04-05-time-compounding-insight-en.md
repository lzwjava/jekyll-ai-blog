...
lang: en
layout: post
title: "Time Compounding: A Universal Insight"
translated: false
type: note
---

**Question:** Is the idea "spend your time only on things whose value increases over time" a powerful and well-grounded insight — considering that Naval Ravikant said it, Li Xiaolai repeatedly referenced it in his books, and Jiang Hu recently repeated it in a livestream?
...
- **Naval** is a Silicon Valley angel investor and philosopher, thinking in terms of wealth-building, leverage, and mental models.
- **Li Xiaolai** is a Chinese educator-turned-crypto-investor, whose work centers on attention, accumulation, and self-directed learning. Li Xiaolai's core teaching is that attention is our most precious resource, and that it should be placed on things that allow for personal growth — and specifically, on things that are valuable to society, because such efforts generate enormous long-term returns. He also emphasizes that gossip and trending information depreciate rapidly — something useful today as conversation fodder may be completely worthless a week later — whereas knowledge from a book remains usable years later.
- **Jiang Hu** is a newer-generation Chinese content creator and livestreamer, speaking to a generation shaped by short-video culture and attention fragmentation.
