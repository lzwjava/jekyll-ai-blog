...
title: Guangdong University Self-Study Exam Registration Guide
translated: false
type: note
---
...
**Step 2:** Click "Modify", accurately and truthfully fill in the scores of courses you have already passed. If using old plan courses to substitute new courses, click "View Substitution Courses". After completing score entry, click "Next Step".

**Step 3:** Select the courses you need to register for and submit.

**Step 4:** After submission, please wait for the Self-Examination Office's review.
...
**Special Reminder:** Before clicking "Generate Order", please confirm the number of courses you need to register for. Errors in registration or multiple registrations will not be refunded.

[Images: Screenshots showing course selection for payment and order generation]

**Step 7:** Click "Proceed to Payment". The system will pop up the payment interface. Verify that the payment amount matches the number of registered courses, then select the appropriate method to complete the payment.

[Image: Payment success screenshot]

**Step 8:** After successful deduction, due to system delay, the "Payment Status" may not update immediately. If it still shows "Unpaid", do not make repeated payments and do not delete the order. You can check again the next day. If it remains abnormal, please contact the Self-Examination Office.

**Note:** Highlighted in the document: Please confirm the number of courses you need to register for before generating the order. Errors or multiple registrations will not be refunded.