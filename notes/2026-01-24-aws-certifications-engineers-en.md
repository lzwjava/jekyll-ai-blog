...
title: Best AWS Certifications for Software Engineers
translated: false
type: note
---
...
1. AWS Certified Cloud Practitioner (optional but helpful if you're new to cloud)
2. AWS Certified Developer – Associate **or** AWS Certified Solutions Architect – Associate (many people do both)
3. Later: AWS Certified DevOps Engineer – Professional (if you like automation & deployment)
