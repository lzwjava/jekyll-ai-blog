...
title: HSBC Enterprise Technology Division Overview
translated: false
type: note
---
...
This team enables efficient, secure, and insightful operations for HSBC's internal stakeholders and employees. It handles infrastructure, application development (often using technologies like Java, Spring Boot, microservices, cloud platforms such as GCP, databases, and DevOps tools), modernization efforts, resilience engineering, automation, and risk/control management for these foundational systems.

Unlike customer-facing digital banking teams, Enterprise Technology primarily supports back-office and internal enterprise platforms to ensure seamless internal customer experiences and operational reliability across the global organization.
