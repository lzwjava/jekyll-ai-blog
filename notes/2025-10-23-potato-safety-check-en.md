...
1. **Storage Conditions**:
   ...
   - Check for spoilage signs:
     ...
     - **Appearance**: Look for green spots (indicating solanine, a toxin), excessive sprouting, soft or shriveled texture, or mold. Small sprouts can be cut away, but green or heavily sprouted potatoes should be discarded.
     - **Texture**: If the potatoes are still firm and not mushy, they are likely fine.
...
1. **Preparation**:
   - **Wash and Inspect**: Thoroughly wash the potatoes. Cut away any green spots or sprouts.
   - **Slicing**: Slice the potatoes thinly (about 3–5 mm thick) for crispy results. Uniform slices ensure even cooking.
   - **Seasoning**: Toss the slices with a small amount of oil (e.g., 1–2 tsp for 1–2 potatoes), salt, and optional spices (e.g., pepper, paprika, or garlic powder).

2. **Air Fryer Cooking**:
   - **Temperature**: Set the air fryer to 190–200°C (375–400°F) for crispy slices.
   - **Time**: 15 minutes is reasonable, but check and shake the basket halfway through to ensure even cooking. Thicker slices may need 18–20 minutes.
   - **Tips**: Avoid overcrowding the air fryer basket to ensure crispiness. Cook in batches if needed.
