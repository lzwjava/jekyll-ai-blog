...
title: Web Design Exam Practice Questions
translated: false
type: note
---
...
1. Multiple-choice: The protocol responsible for secure web page transmission is called _______.
...
4. Short answer: List the four main parts that must be included in a complete website proposal (网站策划书).

5. Multiple-choice: The most commonly used navigation structure for medium-to-large websites is:
   - A. Linear   B. Hierarchical   C. Full mesh   D. Star

6. Essay: Why is it important to conduct target audience analysis before designing a website? (6 points)

7. Short answer: What are the three core principles of visual design in web pages? (color, layout, typography)

### Chapter 3: HTML Fundamentals

8. Multiple-choice: Which HTML5 semantic tag should be used to represent the main navigation area of a page?
...
12. Multiple-choice: Which property is used to make a flex container arrange items in a row on large screens and column on small screens?
    - A. flex-direction   B. flex-wrap   C. media query   D. grid-template

13. Short answer: Write a media query that applies styles only when the screen width is 768px or smaller.

14. Multiple-choice: In the CSS box model, which property defines the space between the border and the content?
    - A. margin   B. padding   C. border   D. outline

15. Practical (theory): Write CSS code using Flexbox to center a div both horizontally and vertically on the page.

### Chapter 5: Multimedia and Interactive Elements

16. Short answer: Why must every <img> tag have an alt attribute? Explain its role in accessibility.

17. Multiple-choice: Which JavaScript event is triggered when a user clicks a button?
    - A. onmouseover   B. onchange   C. onclick   D. onsubmit

18. Short answer: Write a simple JavaScript form validation that checks whether the input box is empty when the form is submitted.

### Chapter 6: Website Construction and Tools

19. Multiple-choice: In Adobe Dreamweaver, the panel used to manage files and folders of the entire site is called _______.
    - A. Properties   B. Files   C. Insert   D. CSS Designer

20. Short answer: List three advantages of using templates (.dwt) in Dreamweaver when building multi-page websites.

21. Essay: Describe the complete workflow of creating a website using Dreamweaver from site definition to final upload (8–10 points).

### Chapter 7: Testing, Deployment, and Maintenance

22. Multiple-choice: The most common tool/protocol for uploading website files to a server is:
    - A. HTTP   B. FTP   C. SSH   D. SMTP

23. Short answer: Name four common items that must be checked during website compatibility testing.

24. Short answer: Explain what an SSL certificate is and why HTTPS is mandatory for modern commercial websites.

25. Multiple-choice: Which Google tool is most commonly used to test page loading speed?
    - A. Analytics   B. Search Console   C. PageSpeed Insights   D. Lighthouse

### Chapter 8: Advanced Topics and Case Studies

26. Short answer: What are the three core features of a Progressive Web App (PWA)?

27. Essay: Taking JD.com or Taobao as an example, analyze how responsive design is implemented on desktop and mobile (8 points).

28. Multiple-choice: Which of the following meta tags is most important for mobile responsiveness?
