...
title: Travel Tips for Shenzhen's Dapeng Peninsula
translated: false
type: note
---
...
- **Getting to Yangmeikeng first** (from Shenzhen city):
  ...
  - Self-driving: Navigate to Yangmeikeng parking lot (hourly fees). Note: Private cars cannot enter the road to Luzui Villa unless you're staying overnight there—park at Yangmeikeng.
- **From Yangmeikeng to Luzui Villa** (5 km coastal path):
  - Recommended: Sightseeing shuttle (13.8-16 CNY, scenic and easy).
  - Walk: Free, 1 hour along a paved coastal road with amazing views—great for photos, but hot in summer; bring water and sunscreen.
  - Boat/speedboat: More expensive (~50 CNY), but thrilling; currently available but check on-site.
  - Avoid: Cycling or private driving into the restricted area.
- **At Luzui Villa**:
  - Famous as the filming location for Stephen Chow's movie *The Mermaid* (人鱼洞/Mermaid Cave).
  - Highlights: Cliff views, beaches, sunrise (one of Shenzhen's best spots), hiking, and romantic seaside vibes.
  - Entry: Free (open resort area).
  - Activities: Beach play, photo spots, cliff restaurant (sea views, but pricey).
- **General Dapeng Peninsula tips**:
  - Combine spots: Visit nearby Dapeng Ancient Fortress (free, historic), Jiaochangwei (cute guesthouses and beach), Judiaosha or Xichong beaches for more sand/sea.
  - Food: Fresh seafood in Nan'ao market—affordable and delicious. Avoid overpriced tourist spots.
  - Essentials: Sunscreen, hat, water, comfortable shoes. Bring cash/WeChat Pay—some areas have limited signal.
  - Crowds/parking: Weekends busy; arrive early. Self-drive vehicles from outside need advance reservation via Shenzhen traffic police WeChat for Dapeng area.
  - Stay: If overnight, Luzui Villa has sea-view options (tents, rooms); otherwise, guesthouses in Jiaochangwei or Nan'ao.
  - Eco-friendly: Area is pristine—take trash with you.
