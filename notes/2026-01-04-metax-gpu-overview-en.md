...
title: Overview of MetaX High-Performance GPUs
translated: false
type: note
---
...
- **MXMACA**: A complete heterogeneous computing software stack/platform compatible with mainstream GPU ecosystems (e.g., CUDA-like compatibility), enabling full hardware-software integration.
- **Other Offerings**: GPU accelerator cards, servers, supernodes, and industry-specific solutions (e.g., finance, healthcare, energy, education, transportation).
