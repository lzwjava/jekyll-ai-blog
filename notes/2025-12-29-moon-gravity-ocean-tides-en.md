...
title: Moon's Gravity Creates Ocean Tides
translated: false
type: note
---
...
- **Far side (opposite the Moon)** — The solid Earth is pulled toward the Moon more than the distant ocean water, so the water is "left behind," creating another bulge (high tide).
- **Sides perpendicular** — Gravity pulls slightly inward, creating low tides.

This results in **two high-tide bulges** on opposite sides of Earth, aligned with the Moon.
...
Feynman clarifies that the Moon's pull is balanced at Earth's center, but stronger on the near side and weaker on the far side, stretching Earth slightly into an ellipsoid with two bulges.
