...
- **Discovery** = uncovering something that already exists (e.g., gravity, electricity)
- **Invention** = creating something new based on that discovered truth (e.g., electric motors, airplanes)
...
- [Invention Versus Discovery — Springer Nature](https://link.springer.com/rwe/10.1007/978-1-4614-3858-8_402)
- [The Empirical Quest for Truth — Philosophy Institute](https://philosophy.institute/philosophy-of-science-and-cosmology/science-approach-to-reality/)
- [Scientific Method: Overview & Development — Study.com](https://study.com/learn/lesson/scientific-method-development-overview-who-invented-the-scientific-method.html)
- [Empiricism — Wikipedia](https://en.wikipedia.org/wiki/Empiricism)
- [The Scientific Method: A Need for Something Better? — PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC7965632/)
