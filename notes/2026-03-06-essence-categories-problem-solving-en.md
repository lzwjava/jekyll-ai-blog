...
lang: en
layout: post
title: Essence and Categories Solve Problems
translated: false
type: note
---
...
- **Focused categorization method**:
  1. Isolate one error family (e.g., only javax → jakarta namespace changes).
  2. Provide targeted examples (8–40) for just that category.
  3. Instruct AI strictly: Modify only that family, ignore others.
  4. Apply fixes, recompile, feed new same-family errors back iteratively.
  5. Repeat per category separately.
