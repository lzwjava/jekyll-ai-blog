...
2. 🔐 **Use HTTPS** – look for the padlock in the browser.
3. 📵 **Avoid sensitive tasks** – like online banking or private work.
4. 🛑 **Turn off sharing** – file/printer sharing, AirDrop, etc.
5. 🚫 **Forget the network after use** – to avoid auto-reconnect.
6. 📲 **Use mobile data/hotspot instead** – more secure for sensitive stuff.
