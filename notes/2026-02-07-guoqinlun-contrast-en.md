...
title: Contrast in Guo Qin Lun
translated: false
type: note
---

The question is about the **main argumentation method** used in **"Guo Qin Lun" (《过秦论》)** by Jia Yi (贾谊).
...
2. **Contrast between Qin and Chen She (陈涉):**
   - Qin, with its vast resources, strong military, and strategic advantages, was defeated by Chen She, a commoner with minimal resources and support.
   - This contrast underscores the idea that Qin's downfall was not due to external forces but its own misgovernance and loss of the people's support.

3. **Contrast between Qin's policies and its outcomes:**
   - Qin's harsh laws, heavy taxation, and oppressive rule initially helped it conquer the six states but ultimately led to widespread resentment and rebellion.
