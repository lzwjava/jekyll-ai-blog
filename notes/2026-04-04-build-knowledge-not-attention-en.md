...
lang: en
layout: post
title: Build Knowledge, Not Attention
translated: false
type: note
---

Question: Is it true that people who pursue attention or money online often fail, while those who pursue genuine knowledge, learn from the best, and dig deep tend to create long-term value — and ultimately earn money and live better lives? Using Yin Wang (yinwang.org) as an example.
...
- Content becomes clickbait or empty entertainment
- Audience trust erodes over time
- The platform algorithm moves on to the next trend
- The creator has no deep skill or reputation to fall back on
...
- He studied at top institutions (Indiana University, Cornell, MIT) and worked at Google and other elite companies
- His blog consistently challenges mainstream programming dogmas — for example, arguing that OOP brought more confusion and harm than benefits, going against the industry consensus
- He has been teaching online computer science lessons and publishing long-form technical memos on Substack, covering topics from programming language research to AI cognition
- His writing style reflects a philosophy of intellectual independence: he argues that first-rate thinkers *propose* original ideas, while second-rate ones merely prove or validate others' ideas
...
- [Yin Wang's Blog (yinwang.org via lofter)](http://yinwang.lofter.com/)
