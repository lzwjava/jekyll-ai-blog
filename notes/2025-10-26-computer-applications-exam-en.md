...
title: Computer Application Technology Practical Exam Overview
translated: false
type: note
---
...
- 高级语言程序设计(一) (Advanced Language Programming I – typically C language)
- 计算机应用技术 (Computer Application Technology)
- 微型计算机及接口技术 (Microcomputer and Interface Technology)
...
- Database and Its Application (experiment portion): 1 credit
