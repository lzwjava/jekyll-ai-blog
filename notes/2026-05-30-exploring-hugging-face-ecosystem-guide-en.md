...
lang: en
layout: post
title: Exploring Hugging Face Ecosystem Guide
translated: false
type: note
---

Question: What should I explore on Hugging Face, and which accounts are worth following on [https://huggingface.co](https://huggingface.co)?
...
* You’ll quickly see what the community is actually using, not just what is announced.
...
* `meta-llama`
* `mistralai`
* `deepseek-ai` (very strong coding and reasoning models)
* `Qwen` / `QwenLM` (Alibaba ecosystem, strong multilingual + coding)
* `stabilityai`
...
* Big independent researchers who publish:
