...
lang: en
layout: post
title: How to Access ByteDance Seedance
translated: false
type: note
---

**Question:** How do I officially use ByteDance's Seedance models? Do I have to use Doubao or Dreamina (即梦)?

**Answer:**

## Official Ways to Access ByteDance Seedance (as of April 2026)

There are multiple official ByteDance portals — not just Doubao. Here's a breakdown by audience:
...
### ⚠️ Important Caveats (Current Status)

- Due to copyright disputes with major Hollywood studios, ByteDance paused the global rollout of Seedance 2.0 as of March 15, 2026. The overseas API is currently unavailable through official channels.
- The official API remains paused since March 15 due to copyright disputes with major Hollywood studios, but every consumer access path (Dreamina, CapCut Pro, Chinese apps) is confirmed still working.
- Face/real-human generation features have also been suspended as an anti-deepfake measure.
...
| **Jimeng** (jimeng.jianying.com) | China | ✅ Yes | 2.0 (full) |
| **Doubao (豆包)** | China | ✅ Yes | 2.0 |
| **Xiaoyunque (小云雀)** | China | ✅ Yes | 2.0 (1 free/day) |
| **Volcengine** | China Enterprise | ✅ Yes | 2.0 API beta |

**Bottom line:** If you're outside China, **Dreamina** (dreamina.capcut.com) or **CapCut Pro** are your best official options. If you're in China, **Jimeng** gives the most complete experience. Doubao works too, but Jimeng is the primary video creation portal.

**References:**

- [LaoZhang AI - Complete Seedance 2.0 Access Guide (April 2026)](https://blog.laozhang.ai/en/posts/seedance-2-how-to-use)
- [GamsGo - How to Use Seedance 2.0 (Verified Methods)](https://www.gamsgo.com/blog/how-to-use-seedance)
- [CyberLink - How to Use Seedance 2.0 in the US](https://www.cyberlink.com/blog/trending-topics/5241/seedance-2-guide)
- [Dreamina official platform](https://dreamina.capcut.com)
- [BytePlus Playground](https://console.byteplus.com)
- [Jimeng AI (China)](https://jimeng.jianying.com)
