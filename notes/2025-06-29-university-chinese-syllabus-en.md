...
4. **Writing Ability**: Requires writing argumentative, expository, or narrative essays with clear viewpoints, logical structure, and fluent language.
...
- **Sample Articles**:
  ...
  - *Ten Proposals to Emperor Taizong* (Wei Zheng)
  - *On Coalition Government* (Mao Zedong)
  - *On Reading* (Francis Bacon, UK)
  - *On Beauty* (Zhu Guangqian)
...
- **Sample Articles**:
  ...
  - *On Time* (Liang Shiqiu)
  - *On Scientific Management* (Fei Xiaotong)
...
- **Sample Articles**:
  ...
  - *My Father’s Back* (Zhu Ziqing)
  - *The Lotus Pond* (Excerpts, Sun Li)
  - *Hometown* (Lu Xun)
...
- **Sample Articles**:
  ...
  - *The Old Man and the Sea* (Excerpt, Ernest Hemingway, USA)
  - *To a Skylark* (Percy Bysshe Shelley, UK)
...
- **Unit Structure**:
  ...
  - **Exercises**: Each unit includes review questions and exercises on vocabulary, content analysis, and writing practice.
- **Genre Distribution**:
  - Argumentative essays: ~30%, emphasizing logic and thought.
  - Expository essays: ~20%, emphasizing knowledge and clarity.
  - Narrative essays: ~30%, emphasizing storytelling and emotion.
...
*Citation Note*: The information is compiled from publicly available online resources and does not directly cite specific content from the search results, as they were not relevant to the *University Chinese (2018 Edition)* article directory.

*Today’s date and time*: 08:12 PM CST, Sunday, June 29, 2025.
