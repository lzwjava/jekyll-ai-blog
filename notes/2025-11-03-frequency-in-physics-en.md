...
- **Key Formula**: Frequency \\( f \\) is the reciprocal of the period \\( T \\) (the time for one complete cycle):
  ...
  f = \frac{1}{T}
  \\]
  For example, if a wave completes 5 cycles in 1 second, \\( f = 5 \\) Hz.
...
If this isn't the context you meant (e.g., a specific app, brand, or technical term), provide more details for a tailored explanation!
