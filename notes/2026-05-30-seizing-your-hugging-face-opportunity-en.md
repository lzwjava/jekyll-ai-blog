...
lang: en
layout: post
title: Seizing Your Hugging Face Opportunity
translated: false
type: note
---
...
1. **Training/fine-tuning templates** — nanoGPT-scale training scripts, LoRA notebooks, DPO recipes (you've done this, show it)
2. **CLI agents & automation tools** — your `ww`, `iclaw`, `zz` tools as runnable models/Spaces
3. **Model cards for your notes** — curated knowledge as searchable model repos
4. **Inference endpoints** — any models you've trained or fine-tuned
5. **Datasets** — even cleaned subsets of your training data
6. **Spaces** — interactive demos of agent workflows
