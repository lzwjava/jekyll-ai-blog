...
title: Baking Soda Uses and Benefits Guide
translated: false
type: note
---
...
- **Baking and cooking**: Acts as a leavening agent. When mixed with an acid (e.g., buttermilk, vinegar, yogurt) and moisture, it releases carbon dioxide gas, causing dough or batter to rise for fluffy cakes, cookies, pancakes, and breads. It's 3-4 times more potent than baking powder, so recipes call for smaller amounts.
- **Cleaning**: A mild abrasive and deodorizer. Scrub surfaces, pots, ovens, or grout; sprinkle in trash cans or shoes to neutralize odors; make a paste for silver polishing or stain removal on fabrics/carpets.
- **Personal care**: Relieves heartburn/indigestion (½ tsp in water as antacid); soothes insect bites, sunburn, or itchy skin; exfoliates in toothpaste alternative (mix with water); unclogs drains when combined with vinegar for a fizzing reaction.
- **Laundry and freshening**: Boosts detergent for whiter clothes; softens fabrics; removes odors from gym bags or refrigerators.
- **Other**: Extinguishes small grease fires (smothers flames); freshens carpets before vacuuming; controls garden fungi (diluted spray on plants).
