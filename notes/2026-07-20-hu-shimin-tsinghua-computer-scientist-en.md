...
lang: en
layout: post
title: "Hu Shimin: Tsinghua Computer Scientist"
translated: false
type: note
---

Question: Who is Professor Hu Shimin (胡事民) from Tsinghua?
...
- Joined Tsinghua faculty in 1998, full professor since 2002
...
- Elected as IEEE Fellow for contributions to computer vision media and geometric processing

**Notable lab output relevant to you as an AI builder:** the Jittor ("计图") deep learning framework came out of his lab — Jittor is Tsinghua's homegrown DL framework (JIT-compiled, meta-operator based), somewhat analogous in spirit to PyTorch but with a different compilation model. Worth a look if you're comparing training frameworks beyond the usual PyTorch/JAX/Megatron stack.
