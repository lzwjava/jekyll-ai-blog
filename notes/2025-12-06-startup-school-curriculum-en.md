...
title: Startup School Curriculum Overview
translated: false
type: note
---
...
- **Idea Generation and Evaluation**: How to find and validate incredible startup ideas, including assessing market fit and avoiding common pitfalls.
- **Co-Founder Dynamics**: Strategies for finding, vetting, and partnering with the right co-founder to build a strong team.
- **User Research and Validation**: Techniques for talking to users, gathering feedback, and iterating based on real needs (e.g., "Make something people want").
- **Product Development**: Building a minimum viable product (MVP), launching it quickly, and refining based on user data.
- **Growth and Metrics**: Understanding key numbers, scaling the business, and driving sustainable growth.
- **Operations and Mindset**: Before-the-startup preparation, overcoming imposter syndrome, maintaining focus (e.g., healthy habits), and networking.
- **Fundraising and YC Application**: Pitching to investors, securing funding, and tips for applying successfully to accelerators like Y Combinator.
