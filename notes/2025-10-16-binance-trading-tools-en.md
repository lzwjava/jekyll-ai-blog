...
- **Options Trading**: Buy/sell call/put options on BTC, ETH, etc., for hedging or speculation. Features vanilla European-style options with customizable strikes and expiries.
...
- **Dual Investment**: A structured product combining options and fixed yields. You subscribe with a crypto, choose a target price, and get either the asset at maturity or a fixed yield (typically 5-20% APY). It's "dual" because it offers two potential outcomes: higher yield if price hits target, or principal back. Subscriptions last 7-90 days.
- **Other Earn Options**:
  - **Savings**: High-yield accounts for stablecoins like USDT (up to 5% APY).
  - **Launchpool**: Stake BNB or other tokens to farm new project tokens for free.
  - **Liquidity Farming/Pools**: Provide liquidity on DEX for rewards, with impermanent loss protection tools.

These tools are accessible via the Binance app or website, with risk warnings for leveraged products. Always check eligibility by region.

[Binance Products Overview](https://www.binance.com/en/products)
