...
title: FDM Core Principles Explained
translated: false
type: note
---
...
**Justification:**
The question completely describes the working principle of FDM: divide bandwidth in frequency domain → multiple sub-channels → modulate with different carriers → simultaneously transmit multiple signals
