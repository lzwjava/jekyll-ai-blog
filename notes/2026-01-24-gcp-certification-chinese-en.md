...
title: Google Cloud Certification for Chinese Citizens
translated: false
type: note
---
...
6. Search for the exam, choose the delivery method:
   ...
   - **Onsite** (at a physical testing center — available in many cities in China via Kryterion's network).
7. Select your preferred date, time, and (for onsite) location.
8. Pay the exam fee (typically $100–$200 USD depending on the certification; paid by credit card).
...
- **VPN**: Not needed for registration or taking the exam (unlike accessing some Google services in China).
- Eligibility: Anyone 18+ years old can take the exams; no nationality-based bans (restricted only for residents of sanctioned countries like Cuba, Iran, North Korea, Russia, etc.).
