...
- 1 tsp soy sauce or tamari (optional, for umami flavor)
...
2. **Season the Mushrooms**:
   - In a mixing bowl, toss mushrooms with olive oil, garlic powder, soy sauce, salt, and pepper. Ensure even coating.
   - Add optional herbs or spices for extra flavor (e.g., a pinch of smoked paprika for a smoky kick).

3. **Preheat the Air Fryer**:
   - Set your air fryer to 360–400°F (180–200°C). Preheating (3–5 minutes) ensures even cooking, but some models don’t require this.

4. **Cook the Mushrooms**:
   - Place mushrooms in the air fryer basket in a single layer. Avoid overcrowding to ensure crispiness.
   - Cook at 360°F (180°C) for 8–12 minutes, shaking the basket or tossing with tongs halfway through to promote even cooking.
   - Check for doneness: mushrooms should be golden, slightly crispy on the outside, and tender inside. If needed, cook an additional 2–3 minutes.

5. **Serve**:
   - Remove mushrooms and taste for seasoning, adding more salt or pepper if desired.
...
This method is based on common air fryer techniques shared across web sources like Inspired Taste, Love and Lemons, and The Kitchn, ensuring a reliable approach. Enjoy your crispy, flavorful mushrooms!
