...
lang: en
layout: post
title: WeChat QR Codes for Offline Growth
translated: false
type: note
---
...
1. **Use a Video Account QR code**, not your personal WeChat QR — this keeps the relationship professional and one-directional.
2. **Print it clearly** on a small card, poster, or table display — A6 or A5 size works well for stall/counter use.
3. **Add a short call-to-action** like "扫码看视频" (Scan to watch my videos) so people immediately understand what they're signing up for.
4. Offering a small incentive upon scanning, such as a voucher or gift, can significantly increase follow rates.
5. The most engaging content on WeChat Channels tends to be 15–60 seconds long, so keep that in mind when producing content for followers you gain this way.
...
- [WeChat Marketing Guide](https://wechatadvertising.com/blog/wechat-marketing-guide)
- [WeChat Channels Features Guide](https://wechatadvertising.com/blog/wechat-channels-features)
- [Creating and Promoting Content on WeChat – CACTUS](https://cactusglobal.com/media-center/creating-and-promoting-relevant-and-powerful-content-on-wechat-a-comprehensive-guide-for-research-publishers-and-societies-trying-to-build-a-presence-in-china/)
- [What Is WeChat Marketing – Elite Asia](https://www.eliteasia.co/what-is-wechat-marketing/)
- [We Chat, They Watch – Citizen Lab](https://citizenlab.ca/research/we-chat-they-watch/)
- [What's Wrong with WeChat – Social Science Space](https://www.socialsciencespace.com/2020/09/whats-wrong-with-wechat-the-problem-with-social-media-censorship/)
