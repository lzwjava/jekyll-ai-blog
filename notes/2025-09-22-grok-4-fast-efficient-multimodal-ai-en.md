...
- **Reasoning Modes**: Available in two flavors—non-reasoning for quick responses and reasoning mode for deeper problem-solving, which can be toggled via API parameters.[3]
