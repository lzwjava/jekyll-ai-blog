...
title: Guangdong 02141 Exam Analysis Guide
translated: false
type: note
---

**Question: Analyze the National Higher Education Self-study Examination course 02141 Computer Networks, including an analysis of past years' exam questions in Guangdong.**
...
4. Data link layer (framing, error control, flow control, protocols like HDLC, PPP, MAC sublayer, Ethernet basics).
5. Network layer (IP addressing, subnetting, routing algorithms, ICMP, ARP).
6. Transport layer (TCP and UDP, reliable transmission, congestion control, ports).
7. Application layer (DNS, HTTP, FTP, SMTP, common protocols and services).
8. Network devices (hubs, switches, routers, VLAN basics).
9. Network security basics and wireless networks (in some versions).
...
- **Calculation/application questions**: Subnet mask calculation, IP address classification, binary-hex conversion, CRC check, etc.
- **Comprehensive / essay questions**: 1-2 larger questions on protocol working process or network design.
...
- **High-frequency topics** (repeated almost every year):
  ...
  - TCP three-way handshake, four-way teardown, reliable transmission mechanisms.
  - Ethernet frame structure, CSMA/CD.
  - Common protocols: HTTP port 80, DNS, ARP request/reply.
- **Calculation questions**: Subnet division (find network ID, broadcast, usable hosts), often 8-12 points.
- **Error control**: Hamming code or CRC (occasional).
- **Changes over time**: Early papers (2000s) focused more on basics and older technologies; recent papers (2020+) include more on VLAN, wireless basics, and modern TCP/IP applications, but core remains stable.
- **Stability**: Questions often recycle concepts with slight rephrasing. Mastering 5-10 years of papers covers 80-90% of new exam content.
...
- [Guangdong Self-Exam Computer Networks Section](http://www.gdszkw.com/jsjwljs)
