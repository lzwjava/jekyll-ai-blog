...
- **The team is no longer your audience** — you need to find or create external users
- **Adoption IS the product** — if no one uses it, the work has no value regardless of quality
- **Communication becomes marketing** — you have to actively propagate the work, not wait for it to be discovered
