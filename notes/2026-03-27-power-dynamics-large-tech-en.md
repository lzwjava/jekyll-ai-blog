...
lang: en
layout: post
title: Dynamics of Power in Large Tech
translated: false
type: note
---
...
- **Hard power** — title, budget, headcount, formal authority (managers, directors, VPs)
- **Soft power** — technical reputation, cross-team respect, being the "go-to" person, influencing decisions without formal authority
...
- Attract stronger teammates who want to work with them
...
- **Deep technical specialists** — solve hard, niche problems nobody else can
- **Tech leads / staff engineers** — coordinate across teams, reduce architectural risk
- **Engineering managers** — grow people, remove blockers, manage delivery
- **Principal/Distinguished engineers** — set multi-year technical direction, mentor entire org
- **Product-oriented engineers** — bridge technical and business goals
...
- **Timing is everything** — same project, different company priority cycle = completely different outcome
