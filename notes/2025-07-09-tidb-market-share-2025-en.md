...
**Notable Users:**
The database has some significant enterprise users, including companies like Meituan-Dianping (which serves 290 million monthly users), indicating it's handling real-world scale in production environments.

While TiDB isn't competing with giants like Oracle, MySQL, or PostgreSQL in terms of raw market share, it's carved out a solid position in the distributed SQL database niche. It's particularly popular among companies that need horizontal scaling capabilities and real-time analytics - areas where traditional databases struggle. So while it's not mainstream, it's far from having "very few users" and continues to grow in its specialized market segment.
