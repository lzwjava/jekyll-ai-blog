...
lang: en
layout: post
title: Converting Chinese Self-Study Associate Degree to HK Bachelor’s
translated: false
type: note
---
...
1. **IELTS 6.5** — acceptable but some programs want 6.5 with no band below 6.0. Check individual requirements.
2. **The self-study exam timing** — you still have 5 written + 2 practical pending. That's probably 1.5–2 more years at your current pace (exams only 2–3x/year).
3. **Shue Yan** has a CS/Computing program. **Hang Seng** has Information Systems and Computing. Both are workable.
4. **OUHK** is worth checking — more flexible on entry requirements and you might even do it part-time while working in HK.
