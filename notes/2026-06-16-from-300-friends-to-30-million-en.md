...
lang: en
layout: post
title: From 300 Friends to 30 Million
translated: false
type: note
---

**Question:** How does 肖逸群 (厂长) run so many WeChat accounts, and why do so many people trust him?
...
- **Free content → paid courses** (typical knowledge economy funnel)
- **Live events** (his "强人设IP私域大课" workshops, 3-day intensive programs in cities like Shenzhen)
- People who attend describe "no wasted content, fully actionable" methodologies on public domain traffic acquisition, private domain operations, and personal IP building — the reviews create FOMO that drives the next cohort
- **Books** published by 人民日报出版社 (People's Daily Press) — a state-backed publisher, which in China adds a layer of institutional legitimacy
