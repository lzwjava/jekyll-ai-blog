...
lang: en
layout: post
title: Check Attendance Compliance Weekly
translated: false
type: note
---
...
1. **Weekly threshold** — every week, punch days ≥ 60% of that week's working days (rounded up)
2. **Monthly threshold** — by end of month, total punch days ≥ 60% of the month's working days (rounded up)
