...
lang: en
layout: post
title: Wang Xiaochuan's Baichuan Loses Last Co-founder
translated: false
type: note
---
...
> Wang Xiaochuan had one of the strongest starting positions in China's LLM race, but his strategic choices may have caused Baichuan to fall behind competitors. ([AITNT News][1])

The article says the final major co-founder, Ru Liyun, reportedly left Baichuan, meaning the original Sogou-era founding team around Wang Xiaochuan has largely departed. ([AITNT News][1])
...
At that time, Baichuan was considered one of China's strongest foundation-model startups. ([AITNT News][1])
...
The article argues that 2024-2026's biggest AI commercialization wave came from coding agents and developer tools, where companies like Anthropic and OpenAI pushed strongly. ([AITNT News][1])
...
The article itself notes Wang Xiaochuan believes healthcare is a long-term direction, not a short-term bet. ([AI TNT News][2])
...
That is what the article is debating. ([AITNT News][1])
