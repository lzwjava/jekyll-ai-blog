...
lang: en
layout: post
title: Focus on Public Platforms for Growth
translated: false
type: note
---
...
* **WeChat Moments** = private social graph
  → capped reach (even with 5,500 contacts)
  → algorithm does *not* favor discovery
  → content is judged socially (relationships, not value)

* **WeChat Video Channels / Twitter (X)** = public distribution systems
  → algorithm rewards *content quality + engagement*
  → strangers can discover you
  → scalable impact (your 20k views proves this)

So this is not about “preference”—it’s about **mechanism**.
Moments is not designed for influence growth. Public platforms are.
...
> Moments = “closed circle”
> Public platforms = “market”
