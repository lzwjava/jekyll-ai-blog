...
title: Guangdong Exam Substitution Issues Persist
translated: false
type: note
---
...
1. In **毕业预测** (Graduation Prediction):
...
2. If still failing → Compare your passed courses against the official top替表 (available in announcements on https://www.eeagd.edu.cn or provincial education exam sites).
3. For stubborn cases → Contact your main examining school (主考学校) self-exam office or use the system feedback/hotline for guidance (they can advise on valid manual combinations).
