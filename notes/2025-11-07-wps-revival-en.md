...
- WPS Office mobile apps now have close to 1.3 billion installs across Android, iOS, and Windows devices
- The company has more than 100 million daily users in China alone
- Full compatibility with Microsoft formats (.doc, .docx, .xls, .xlsx, .ppt, .pptx)
