...
- **Core Computer Science Subjects**: Courses like *Introduction to Computer Science and Programming*, *Fundamentals of Programming*, *Computer Systems Engineering*, *Algorithms*, and *Artificial Intelligence*.
- **Mathematics Requirements**: Calculus, Linear Algebra, Probability, and Statistics.
- **Science Requirements**: Physics and other foundational sciences.
- **Restricted Electives**: Advanced computer science topics such as machine learning, databases, or software engineering.
- **HASS Requirements**: Students must take 8 courses in humanities, arts, and social sciences, which can include subjects like history, literature, or political science, but these are chosen from a broad list and are not specifically mandated courses like those you listed.
- **General Institute Requirements (GIRs)**: These include science, humanities, and communication requirements, but none align with the specific courses you mentioned.
