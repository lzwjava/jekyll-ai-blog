...
lang: en
layout: post
title: Fix Washing Machine Leaks Step by Step
translated: false
type: note
---
...
1. **Unplug the Machine:** Safety first—disconnect power before inspecting.
2. **Remove the Back Panel:** Use a screwdriver to open the back (or front, depending on the model).
3. **Inspect Hoses and Connections:** Look for leaks, cracks, or loose clamps.
4. **Check the Pump:** Locate the pump (usually at the bottom) and clear any debris.
5. **Test the Door Seal:** For front-loaders, run a cycle with an empty machine and watch for leaks around the door.
