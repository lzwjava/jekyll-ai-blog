...
1. **Alec Radford**
   ...
   - **Path**: He gained recognition through direct contributions to cutting-edge AI projects, leveraging self-directed learning and collaboration with top researchers.[](https://80000hours.org/podcast/episodes/chris-olah-unconventional-career-path/)
...
- **Seek Mentorship**: Connect with researchers or join organizations where you can learn from experienced practitioners, as Olah did with Michael Nielsen.
[](https://80000hours.org/podcast/episodes/chris-olah-unconventional-career-path/)
- **Publish and Communicate**: Share your findings through blogs, Twitter threads, or preprints to build credibility, as Olah did with Distill.
