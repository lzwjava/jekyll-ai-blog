...
title: Power Corrupts Through Emperor’s Favoritism
translated: false
type: note
---

This question tests the deep meaning of a line from Bai Juyi's poem "Song of Everlasting Sorrow" (《长恨歌》).
...
- **C. Satirizing worldly sycophancy and opportunism** (Your answer)
  - This is only the **surface meaning**
  - It does indeed satirize people's opportunistic mentality
  - But this is not the author's **main target of criticism**

- **D. Implicitly criticizing Emperor Xuanzong for indulging in pleasure and neglecting state affairs** (Correct answer)
  - This is the **deeper meaning** and **root cause**
  - Why were people opportunistic? **The root lies in Xuanzong's infatuation with Yang Guifei and neglect of governance**
  - "汉皇重色思倾国" (The Han emperor valued beauty and sought one to topple kingdoms), "从此君王不早朝" (From then on the emperor stopped attending morning court) — It was precisely Xuanzong's indulgence that led to the Yang family's overwhelming power, which in turn corrupted social values
