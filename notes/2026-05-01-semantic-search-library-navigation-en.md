...
lang: en
layout: post
title: Semantic Search Enhances Library Navigation
translated: false
type: note
---

Question:
Is it reasonable that libraries should introduce large language models to directly query books (instead of traditional title/author indexing), and even guide users physically to shelves?
...
➡️ They optimize for librarians, not for user intent.
