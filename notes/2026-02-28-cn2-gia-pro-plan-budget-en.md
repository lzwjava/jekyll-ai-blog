...
lang: en
layout: post
title: Best Budget CN2 GIA Pro Plan
translated: false
type: note
---
...
- **Premium/Pro series** (LAX.AN5.Pro / LAX.Pro) — CN2 GIA + premium transit, optimized for China (your main interest).
  ...
  - Higher Pro plans (Pocket, Starter, Mini, etc.) start at ~$14.90–$29.90/month.
- **Other/cheaper series** (non-Premium, worse China routing):
  - **LAX.EB** (Eyeball/Enterprise Basic) or **LAX.T1** (Tier-1/International) — These are budget-oriented with CMIN2 hybrid or standard routes (not full CN2 GIA for all carriers).
    - Examples: LAX.EB INTRO or similar entry plans at **$29.9/year** (~$2.49/mo annualized) — 1 vCPU, 1 GB RAM, 20 GB SSD, lower bandwidth/traffic (e.g., 400–600 GB/month).
    - Other entry-level like LAX.EB.TINY or LAX.T1 Basic: Starting ~$36.9/year (~$3/mo annualized).
  - These are **significantly cheaper** but sacrifice the premium China-optimized routing (higher latency/spikes from Guangzhou during peaks).
