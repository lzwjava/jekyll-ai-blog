...
title: Debunking the No-Stars Space Photo Claim
translated: false
type: note
---
...
#### 2. **The Proposed Experiment Is Flawed—Here's Why and How to Test It Properly**
   ...
   - **Real Experiment You Can Do (5 Minutes, Any DSLR/Smartphone):**
     1. Go outside at dusk: Shoot a foreground object (e.g., a tree or car) lit by streetlights (mimics "bright Earth/ISS") against a starry sky.
     2. **Manual mode**: Set ISO 100, aperture f/8, shutter 1/100s (exposes for the lit object—shadows visible, details sharp).
        - Result: Tree/car shows 3D depth/shadows; stars invisible (overpowered by foreground light scatter).
     3. Now crank shutter to 30s (for stars): Tree/car overexposes to white; stars streak in.
     4. **Fix it like NASA**: Take two shots, blend in software (e.g., Photoshop/Lightroom HDR). Boom—composite with lit foreground + starry sky.
