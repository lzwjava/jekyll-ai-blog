...
- **Mandatory Provident Fund (MPF)**: This is the core retirement savings scheme, introduced in 2000. It's a privately managed, defined-contribution system where both employees and employers contribute 5% of relevant income (capped at HKD 30,000 monthly, so max HKD 1,500 each per month). Applies to employees aged 18-64 earning over HKD 7,100/month. Self-employed also contribute 5%. Funds are invested in approved schemes, and withdrawals are allowed at retirement (age 65) or earlier in specific cases (e.g., emigration). It's mandatory by law—failure to enroll or contribute can result in fines up to HKD 100,000 and imprisonment.

- **Employees' Compensation Insurance**: Employers must provide this for work-related injuries or illnesses, covering medical costs and lost wages. It's mandatory under the Employees' Compensation Ordinance, with premiums based on risk (typically 0.5-2% of payroll).

- **Healthcare**: No mandatory social medical insurance. Public hospitals offer heavily subsidized care (e.g., HKD 75/day for inpatients), funded by general taxes. Many buy private health insurance voluntarily for better access.

- **Unemployment and Other Welfare**: No unemployment insurance fund. Instead, means-tested **Comprehensive Social Security Assistance (CSSA)** provides cash aid for low-income/unemployed (e.g., HKD 4,000+ monthly for singles). There's also **Old Age Living Allowance** (up to HKD 4,200/month for elderly) and disability allowances. These are government-funded, not contributory.

- **Maternity/Paternity**: 14 weeks paid maternity leave (employer-funded, 80% salary) and 5 days paternity. No dedicated maternity insurance fund.
