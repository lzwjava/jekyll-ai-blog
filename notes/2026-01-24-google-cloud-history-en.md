...
title: History of Google Cloud Platform
translated: false
type: note
---
...
- **2008 – Official entry into cloud computing**
  ...
  App Engine is widely regarded as the true starting point of what became Google Cloud Platform.

- **2010 – First IaaS building blocks**
  In **May 2010**, Google launched:
  - **Google Cloud Storage** — object storage service (direct competitor to Amazon S3)
