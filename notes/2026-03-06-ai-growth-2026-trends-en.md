...
lang: en
layout: post
title: AI Grows Up in 2026 Trends
translated: false
type: note
---
...
- **Multi-Modal and Physical AI Advances** — True multi-modal foundation models handle text, images, audio, and video natively. Physical AI is emerging with **humanoid robots** entering real manufacturing (e.g., Boston Dynamics' Atlas in Hyundai facilities) and autonomous driving rollouts (e.g., XPENG's VLA 2.0).
- **Quantum Computing Progress** — Companies like IBM and Microsoft predict **quantum advantage** in 2026, where quantum systems outperform classical computers on specific problems, unlocking potential in drug discovery, materials science, and optimization.
- **AI in Scientific Discovery** — AI is transitioning from summarizing research to actively participating in breakthroughs in physics, chemistry, and biology through agentic research tools.
