...
lang: en
layout: post
title: Unlock Twitter Follow Limits
translated: false
type: note
---
...
If the block is temporary (not a permanent ratio issue):
A typical restriction lasts **24 hours**. However, multiple violations — like aggressive follow/unfollow cycles or using automated tools — can extend the limit to **48–72 hours**.
