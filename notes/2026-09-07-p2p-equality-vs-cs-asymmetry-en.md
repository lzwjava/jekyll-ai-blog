...
lang: en
layout: post
title: P2P Equality vs C/S Asymmetry
translated: false
type: note
---

Question: What if we say P2P means "equal/symmetric" peers — does that change how we compare it to C/S?

Answer:

Yes, framing P2P through the lens of **对等 (equality/symmetry)** actually sharpens the contrast and makes the distinction cleaner.

**The Core Insight of 对等**

"对等" emphasizes that every node has **equal standing, equal capability, and equal responsibility**. No node is privileged. This is the philosophical heart of P2P — and it is precisely what C/S *rejects*.
...
| Communication direction | Always client → server | Any node → any node |

**Why This Makes P2P *Not* a Special C/S**
...
> C/S is like a restaurant: customers (clients) order, chefs (servers) cook — roles never swap.
>
> 对等 P2P is like a potluck dinner: everyone brings food *and* eats — no fixed roles.
