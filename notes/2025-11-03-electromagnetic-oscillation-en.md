...
#### 4. **What's the Limit for EM Waves?**
   ...
   - **Practical spectrum limits** (from low to high frequency):
     ...
     | Microwave | 300 MHz–300 GHz | Wi-Fi, radar, 5G |
     | Infrared | 300 GHz–400 THz | Heat, remote controls |
     | Visible Light | 400–700 THz | Colors we see |
     | Ultraviolet (UV) | 700 THz–30 PHz | Sunburns, blacklights |
     | X-rays | 30 PHz–30 EHz | Medical imaging |
     | Gamma Rays | >30 EHz (up to ~10²⁴ Hz) | Cosmic rays, nuclear reactions |
