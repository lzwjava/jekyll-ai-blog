...
lang: en
layout: post
title: AI Evolution Across the Computing Stack
translated: false
type: note
---

Question:
Can ChatGPT replace websites, Claude Code replace IDEs and simple software, and OpenClaw replace parts of operating systems?
...
* Google search → open 10 websites → read → summarize
  Now:
...
AI is **moving downward in the stack** — from text → code → system → infrastructure.
