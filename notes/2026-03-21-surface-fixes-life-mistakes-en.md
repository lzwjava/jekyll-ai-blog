...
lang: en
layout: post
title: Surface Fixes and Repeating Life Mistakes
translated: false
type: note
---
...
- People stay in toxic relationships without asking *why* they keep choosing the same type of person.
- People overspend month after month without examining *why* they can't save.
- People have the same arguments with family members without reflecting on the deeper dynamic.
...
- **Ask "Why?" five times** — The first "why" gets you the immediate cause. The second gets you the cause of the cause. Keep going until you reach the root of the problem. This system was developed by Sakichi Toyoda and is widely credited for the success of the Toyota production system.

- **Document and share findings** — Treat RCA documentation as part of the fix, not an optional task. Write for someone who wasn't there — be clear and detailed. Include timelines, evidence used, and action items.

- **Build a learning culture** — Applied diligently over the long term, a root cause analysis process doesn't only fill gaps — it grows and matures the engineering organization by encouraging continuous self-examination.
...
- [Root Cause Analysis: A Strategic Guide for Engineers – Site24x7](https://www.site24x7.com/learn/root-cause-analysis-guide.html)
- [Root Cause Analysis in Quality Engineering – Percona](https://www.percona.com/blog/root-cause-analysis-in-quality-engineering/)
- [Fix Systems, Not Symptoms – EM Tools](https://www.em-tools.io/frameworks/root-cause-analysis)
- [How to use RCA to Improve Engineering – Keboola](https://www.keboola.com/blog/root-cause-analysis)
- [Applying Lessons Learned – PMI](https://www.pmi.org/learning/library/lessons-learned-project-implementation-7062)
- [The Future of RCA in Software Engineering – Resolve AI](https://resolve.ai/glossary/what-is-root-cause-analysis)
- [How to Solve Engineering Problems with RCA – Interesting Engineering](https://interestingengineering.com/culture/how-to-solve-engineering-problems-with-root-cause-analysis)