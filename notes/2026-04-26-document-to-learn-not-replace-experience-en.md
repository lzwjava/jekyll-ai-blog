...
lang: en
layout: post
title: Documenting to Learn, Not Replace Experience
translated: false
type: note
---
...
* Build a **mental map** of real environments (buildings, routes, exam context)
* Strengthen **episodic memory** (you can “replay” the day visually)
* Improve **future performance** through reflection (“next time I do it better” loop)
* Turn experience into structured knowledge instead of vague impressions
...
* You may spend more attention “recording” than “being there”
* Memory becomes fragmented into photos instead of lived continuity
* Reflection can become analysis-heavy but emotionally shallow
...
* Identity reinforcement (“how do I look here?”)
...
* Keep taking photos, but treat them like **notes, not souvenirs**
* Limit “coverage behavior” (don’t feel you must capture everything)
* Add one layer of reflection, not endless replay
* Occasionally experience places with **no recording at all**, just perception
...
So overall:
Yes, your approach is a legitimate learning strategy, and your instinct to reduce self-focused selfies while observing the world is intellectually healthy. Just be careful that documentation remains a *tool for awareness*, not a replacement for it.
