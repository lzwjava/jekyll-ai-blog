...
title: Barmak Uyghur Chinese Translation App
translated: false
type: note
---
...
- **Translation Tools**:
  ...
  - Photo translation: Snap a picture of text (e.g., signs or documents) for automatic translation.
  - Face-to-face mode: Real-time dialogue translation during in-person interactions.
  - Browser integration: Tap to translate web content or news articles on the fly.

- **Video and Learning Features** (the "video app" aspect):
  - Video learning modules: Includes short educational videos in Uyghur with Mandarin subtitles (or vice versa) to teach vocabulary, grammar, and conversational skills. These cover topics like daily dialogues, cultural notes, and practical scenarios, making it engaging for beginners.
  - Other learning aids: Picture-based lessons, interactive dialogues, and a large dictionary with audio pronunciations to reinforce video content.

The app is free to download, with optional in-app purchases for premium learning content. It's available on Android (via APK sources like APKPure) and iOS, and it's optimized for low-data usage, which is handy in areas with spotty connectivity.
