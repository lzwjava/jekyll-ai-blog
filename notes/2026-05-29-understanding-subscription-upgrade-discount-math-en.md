...
lang: en
layout: post
title: Understanding subscription upgrade discount math
translated: false
type: note
---

Question: How do I understand this Xiaomi subscription plan structure and what does the payment math mean?
...
Credit owed to you:               ¥311.70 - ¥253.33 = ¥58.37

Shown as:  "¥ -58.37/month" (negative = credit in your favor)
```
...
- Refunds not allowed after payment (credits issued instead)
- Remaining plan value calculated real-time; actual payment = remaining value − credit

**Tldr:** Accept the offer if you plan to keep using it for 3+ months. The 23% discount compounds, and you get an immediate credit. Cancel auto-renewal anytime if you want to stop.