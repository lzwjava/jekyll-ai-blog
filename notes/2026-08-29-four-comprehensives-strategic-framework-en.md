...
lang: en
layout: post
title: Four Comprehensives Strategic Framework
translated: false
type: note
---

**Question:** What are the "Four Comprehensives" (四个全面战略布局) and what do they mean?

---

**Answer:**

The **四个全面 (Four Comprehensives)** is a core strategic framework of Xi Jinping's governance — think of it as the **action plan** of the New Era, while the Four Confidences were the **mindset**.
...
> **Note:** #1 was updated at the 20th Party Congress (2022) — it used to say "全面建成小康社会" (build a moderately prosperous society), but since that goal was declared achieved, it was upgraded to building a **modern socialist country**.
...
> - **Driver** = the disciplined Party leadership (#4)

All four must work together — a great destination means nothing without a reliable driver, engine, and road.
...
The most commonly tested relationship is:

> **#1 is the goal (引领), #2 #3 #4 are the three pillars that support reaching it.**

Examiners often ask: *"What is the relationship among the Four Comprehensives?"* — always answer that the first one is the **leading objective (战略目标)** and the other three are **strategic measures (战略举措)**.
