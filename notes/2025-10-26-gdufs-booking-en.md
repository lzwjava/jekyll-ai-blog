...
- **Current Status (as of October 26, 2025)**: The 2025 second-half exam is scheduled for **November 1-2, 2025**. Registration closed in June 2025. If you registered, query your assigned seat today (see Step 6 below). For the next opportunity (2026 first half), registration opens in December 2025—check the official site for exact dates.
...
2. **Prepare Documents**:
   - Guangdong STHEE candidate ID and password (register at [www.eeagd.edu.cn/selfec/](https://www.eeagd.edu.cn/selfec/) if new).
   - Proof of passed courses (download transcript from the STHEE system).
   - Scanned ID photo and other proofs if required (e.g., for exemptions like NCRE Level 1 certificate for basics).

3. **Access the Registration System**:
   - During the open period (e.g., ~June 10-23 for second half; ~December 10-23 for first half), log in at the GDUFS site.
   - Click the link to "实践考核报考系统" (Practical Assessment Registration System). Use your STHEE login credentials.

4. **Fill Out the Form**:
   - Enter personal details (name, ID, contact info—must match STHEE records).
   - Upload/add proof of at least 2 passed theory courses.
   - Select your major (610201 Computer Application Technology) and course (11325).
   - Review and confirm—no changes after submission.

5. **Pay the Fee**:
   - Pay 150 RMB online via WeChat/Alipay/bank card (usually within 1-2 days of registration window).
   - Keep the payment receipt.

6. **Confirm Assignment and Exam Details**:
   - ~1 week before exam (e.g., October 26 for November exam), check the site for "考场座位号通知" (Seat Number Notice).
   - Download the attachment or query by candidate ID in the system to get your lab/room, seat, and session time (e.g., morning/afternoon on Nov 1).
