...
title: Web Design and Production Exam Questions
translated: false
type: note
---
...
2. What is the primary purpose of the <meta charset="UTF-8"> tag in HTML5?  
...
4. To open a link in a new browser tab, which attribute and value should be used with the <a> tag?  
   A) target="_self"  
   B) target="_blank"  
   C) href="_new"  
   D) open="new"
