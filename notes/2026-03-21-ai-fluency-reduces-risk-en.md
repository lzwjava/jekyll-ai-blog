...
lang: en
layout: post
title: AI Fluency Reduces Engineering Risk
translated: false
type: note
---
...
- AI users who start with AI start ahead, and stay ahead. By embedding AI tools into training and ramp-up materials, organizations can help new hires adopt these practices early and establish them as a core part of how work gets done.

- Teams that succeed with AI are those that retool everything, not just their IDE plugin. The firms that win treat AI as a platform change: update reviews, automate checks, retrain onboarding, and measure outcomes.

- The number of job postings for employees with agentic AI skills spiked 985% between 2023 and 2024, signaling that "how well you use AI" is itself becoming a scarce and valuable organizational skill.
...
- [How AI facilitates knowledge transfer from retiring engineers – Glean](https://www.glean.com/perspectives/how-ai-facilitates-knowledge-transfer-from-retiring-engineers)
- [AI-assisted engineering Q4 impact report 2025 – DX](https://getdx.com/blog/ai-assisted-engineering-q4-impact-report-2025/)
- [Gen AI boosts productivity but can't turn novices into experts – HBS](https://www.library.hbs.edu/working-knowledge/gen-ai-boosts-productivity-but-cant-turn-novices-into-experts)
...
- [AI helped cut costs in 2025 but may hurt future leadership pipelines – eMarketer](https://www.emarketer.com/content/ai-helped-cut-costs-2025-may-hurt-future-leadership-pipelines-increase-workloads)
