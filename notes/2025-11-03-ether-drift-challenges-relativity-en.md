...
- [Héctor A. Múnera on ResearchGate](https://www.researchgate.net/scientific-contributions/Hector-A-Munera-2122924504) (profiles his ether-drift papers, e.g., "Search for Annual and Daily Anisotropies in the Speed of Light" from 2006).
- [Michelson-Morley Experiment Overview](https://en.wikipedia.org/wiki/Michelson%E2%80%93Morley_experiment) (historical context).
- [Cosmic Microwave Background Dipole](https://en.wikipedia.org/wiki/CMB_cold_spot#Our_motion_relative_to_the_CMB) (explains the ~370 km/s velocity benchmark).
