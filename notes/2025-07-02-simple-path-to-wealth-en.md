...
* **Simpler life**
* **Easier for heirs**
* **Most powerful way to achieve financial independence**
...
## Navigating J.L. Collins' Resources: Blog vs. Book
...
* Makes investing as **complex as possible**.
* Promotes a "siren song" that encourages individuals to believe they can **outperform the market** by picking stocks or paying for active management.
...
## Other Popular and Controversial Blog Posts
...
* **"How I failed my daughter"**: One of his earliest posts, which encapsulates the entire content of his blog and book.
* **"Why you need F-you money"**: This post is also highly popular, with Collins referencing a famous, "not suitable for work" YouTube clip from the movie "The Gambler" starring John Goodman, which inspired his own video on the topic.

---

## Navigating Investment Options in 2018 and Beyond
...
* **Buckets:** These are account types like **401(k)s, IRAs, or TSP plans**. They are containers for your investments.
* **Investments:** These are the actual assets held within the buckets, such as **mutual funds, stocks, and bonds.**
...
* **Financial Advisors:** He believes they can be useful for various financial subjects **other than investment choices** if one embraces his simple indexing approach. He states that if you follow his advice, you can do what an advisor does in "a handful of clicks." He refers to his blog post "Why I don't like investment advisors" and summarizes his investment advice as: "**Buy VTSAX, buy as much as you can, buy it whenever you can, and hold it forever.**"
* **Systemic Risk of Indexing:** He is "not concerned" about this hypothetical scenario. Indexing currently accounts for only 20-25% of the market. He believes that if indexing continues to grow, the opportunity for active managers to outperform will increase, leading to a natural rebalancing as some active managers post success stories. Furthermore, he points out that the **"counter-intuitive" power of indexing** and human nature's desire to "outperform" will likely prevent it from ever "taking over the world."
