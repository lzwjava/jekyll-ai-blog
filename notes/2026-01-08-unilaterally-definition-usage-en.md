...
title: Definition and Usage of Unilaterally
translated: false
type: note
---
...
The word comes from "unilateral," which combines "uni-" (one) + "lateral" (side).

Opposite terms include **bilaterally** (involving two sides) or **multilaterally** (involving multiple sides).
