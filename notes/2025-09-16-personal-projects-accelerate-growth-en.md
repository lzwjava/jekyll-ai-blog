...
- Compounding advantage: Each project begets tools, audience, and intuition. PG: small, real projects stack over time into big capabilities.
- Proof beats promises: A portfolio signals ability better than any resume. YC’s “make something people want” starts with making something at all.
- Freedom to explore hard problems: You can chase narrow or “weird” interests (the “bus-ticket” kind of obsession) where advantage is built.
- Anti-boredom, anti-credential: Your project defines the “top idea in your mind,” keeping you engaged even if your day job is routine.
...
- Instrument and reflect: track users, downloads, build time, and your own energy; keep a changelog.
