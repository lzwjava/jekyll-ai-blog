...
lang: en
layout: post
title: Anthropic Internal Strategy Revealed in Lawsuit
translated: false
type: note
---
...
1. **Court-unsealed internal planning documents** (sometimes miscalled “emails”)
2. **Statements in the judge’s order** describing Anthropic’s internal goals
3. Later reporting about **“Project Panama”** and “scan all books” strategy
...
The lawsuit claimed Anthropic built a **central library of millions of books** to train models. The court filings describe the internal goal as creating **“all the books in the world”** corpus. ([Copyright Alliance][1])
...
* used subsets to train Claude models ([Loeb & Loeb LLP][2])

The judge summarized the plan as:

> amass a central library of “all the books in the world” to retain “forever” ([Copyright Alliance][1])
...
* internal note: they did **not want it known publicly** ([Wikipedia][3])
...
1. build centralized book library
2. train LLMs from subsets

Training itself was considered **transformative**, but **pirated library creation was not**. ([PatentNext][4])
...
That’s why the lawsuit happened and eventually led to a **$1.5B settlement**. ([Legal Blogs][5])

---

# TL;DR

There wasn’t a single “leaked email.”
The “leak” refers to **court-unsealed internal documents** showing:
