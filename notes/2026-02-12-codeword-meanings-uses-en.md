...
title: Codeword Meanings and Common Uses
translated: false
type: note
---
...
|----------------------|--------------------------------------|-----------------------------|
| Everyday / security  | Secret password / recognition signal | "The codeword is 'eagle'"   |
| Spying / military    | Authentication or trigger phrase     | Challenge-response pair     |
| Internet / politics  | Dog-whistle / subtle group signal    | Using "globalist" as code   |
| Technical (coding)   | Valid sequence in a code             | 7-bit Hamming codeword      |
