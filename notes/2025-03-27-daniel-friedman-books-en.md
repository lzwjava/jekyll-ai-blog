...
2. **"The Seasoned Schemer"** (with Matthias Felleisen)
   A sequel to *The Little Schemer*, diving deeper into higher-order functions, continuations, and meta-programming.

3. **"Essentials of Programming Languages"** (EOPL, with Mitchell Wand and others)
