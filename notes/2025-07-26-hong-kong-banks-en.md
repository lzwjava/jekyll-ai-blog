...
- **Steps to Apply**:
  1. **Prepare Documents**: Mainland ID card, valid Exit-Entry Permit (your "pass ticket"), proof of address (e.g., Guangzhou residence proof), and for credit cards: income proof (e.g., bank statements or salary slips showing stable income).
  2. **Visit Hong Kong**: You must be physically in Hong Kong for most applications (same as your HSBC experience). Use your entry permit to travel from Guangzhou – it's a short trip via high-speed rail or ferry.
  3. **Choose a Bank and Apply**:
  ...
  4. **Submit Application**: In-branch is safest; provide documents and explain your needs (e.g., for international use). Some banks allow pre-application online but require in-person ID verification.
  5. **Activation and Use**: Once approved, the card is mailed to your provided address (can be mainland) or picked up. Use it for global payments, but note currency conversion fees.
