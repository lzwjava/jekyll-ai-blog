...
lang: en
layout: post
title: Foreign Language Learning and Source Correction
translated: false
type: note
---
...
1. **Voluntarily perform badly** — in front of others, repeatedly
2. **Resist the rescue mechanism** (your native language is always available)
3. **Trust that imperfect first attempts now** lead to correct first attempts later
4. **Never patch** — always re-attempt in the target language
