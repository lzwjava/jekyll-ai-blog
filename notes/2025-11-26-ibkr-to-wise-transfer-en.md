...
title: Transferring Funds from IBKR to Wise
translated: false
type: note
---
...
1. **Link Accounts**: In IBKR Client Portal > "Transfer & Pay" > "Deposit Funds" > Select "Wise" > Authenticate via Wise (one-time setup).
2. **Initiate Withdrawal**: Go to "Transfer & Pay" > "Withdraw Funds" > Choose "Bank Wire" or "Transfer to Wise Balance" > Enter amount/currency > Select your linked Wise account details (routing/account from Wise's USD/EUR balance).
3. **Confirm & Track**: Preview fees/rates > Submit. IBKR sends a confirmation; track in both apps. Wise notifies on arrival.
4. **From Wise to Local Bank**: Convert if needed, then transfer out (Wise fee ~0.4–0.6% + local bank fee).
...
- [IBKR Wise Integration Guide](https://www.ibkrguides.com/brokerportal/transferandpay/wise-transfer.htm)
- [Wise x IBKR Partnership](https://wise.com/us/blog/wise-platform-and-interactive-brokers-team-up)
- [Reddit: Withdrawal Experiences](https://www.reddit.com/r/interactivebrokers/comments/hroeeh/withdrawing_funds_from_ibkr_to_transferwise/)
- [No Money Lah Withdrawal Guide](https://nomoneylah.com/2025/07/22/ibkr-wise-withdrawal-guide/)
