...
lang: en
layout: post
title: Adapting to Change as New Normal
translated: false
type: note
---

Question: You're saying that after failing to adapt to a vertical mouse several times, you suddenly got used to it while building your AI studio. You're wondering whether this reflects a general human ability to adapt—even to much harder situations like entrepreneurship, debt, or war.
...
* new motor programs form,
* eventually the vertical mouse becomes automatic.
...
* Entrepreneurs eventually normalize uncertainty.
* People carrying debt often develop routines around it.
* Soldiers adapt to environments that initially seem unimaginable.
* Parents adapt to waking up multiple times every night.
...
* **Adaptation** doesn't mean something is optimal.
* If a vertical mouse genuinely reduces wrist strain for you, then adapting is worthwhile.
* If it causes persistent pain even after weeks, it's probably the wrong device rather than a failure to adapt.
