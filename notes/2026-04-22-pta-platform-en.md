...
lang: en
layout: post
title: PTA Programming Teaching Assistant Platform
translated: false
type: note
---
...
**PTA** (short for *Programming Teaching Assistant*, also known as "拼题A" in Chinese) is a Chinese online programming education and practice platform hosted at [pintia.cn](https://pintia.cn). It is developed and operated by **Hangzhou Baoteng Education** (杭州·百腾教育) and is widely used across Chinese universities.
...
- Course-specific problem sets assigned by university professors
...
- **University students** in China taking programming courses (C, C++, Java, Python, Data Structures, etc.)
- **Competitive programmers** preparing for PAT certification exams
- **Professors and teachers** who assign and grade homework via the platform
- **Self-learners** looking to improve algorithmic thinking
...
- [pintia.cn — Official Platform](https://pintia.cn)
- [Multi-Collaborative C++ Teaching Reformation Based on PTA (ACM)](https://dl.acm.org/doi/abs/10.1145/3549843.3549846)
- [ARCS approach to PTA-based programming (Springer)](https://link.springer.com/article/10.1007/s10639-023-11740-6)
- [VS Code PTA Extension (GitHub)](https://github.com/jinzcdev/vscode-pintia)
- [What is PTA? — Zhihu community discussion](https://www.zhihu.com/question/417749669)
