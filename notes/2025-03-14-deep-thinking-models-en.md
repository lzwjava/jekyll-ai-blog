...
- **Gemini models** from Google, such as Gemini Flash Thinking Experimental, optimized for a wide range of reasoning tasks.
- **Claude** from Anthropic, with models like Claude 3.7 Sonnet, known for hybrid reasoning capabilities.
- **QwQ-32B** from Alibaba, a compact reasoning model performing comparably to larger models like DeepSeek R1.
...
### Survey Note: Comprehensive Analysis of Deep Thinking Reasoner Models and Their APIs
...
|--------------------|---------------|-------------------------------------------------------|
| Grok               | xAI           | General-purpose AI with reasoning for diverse tasks   |
| ChatGPT o1         | OpenAI        | PhD-level reasoning in math, science, and coding      |
| DeepSeek R1        | DeepSeek      | Open-source, matches ChatGPT o1 in math and coding    |
| Gemini Flash Thinking Experimental | Google | Optimized for wide-range reasoning, including legal   |
| Claude 3.7 Sonnet  | Anthropic     | Hybrid reasoning, strong in coding and math           |
| QwQ-32B            | Alibaba       | Compact, excels in math and coding, open-source       |

These models were identified through various sources, including techcrunch.com (['Reasoning' AI models have become a trend, for better or worse](https://techcrunch.com/2024/12/14/reasoning-ai-models-have-become-a-trend-for-better-or-worse/)), which notes the trend following OpenAI's o1 release, and bigdatawire.com ([What Are Reasoning Models and Why You Should Care](https://www.bigdatawire.com/2025/02/04/what-are-reasoning-models-and-why-you-should-care/)), emphasizing DeepSeek R-1's rise. Additionally, yourstory.com ([Top AI tools in 2025: What they do and how to use them](https://yourstory.com/2024/09/top-10-ai-models-2025)) lists OpenAI o3-mini, reinforcing the inclusion of OpenAI's models.
...
- **Gemini models (Google):** Google's Gemini, particularly Gemini Flash Thinking Experimental, is optimized for reasoning, with API details on [Google AI Gemini API](https://ai.google.dev/gemini_api_overview). However, a Reddit post ([r/GoogleGeminiAI on Reddit: Google removed their reasoning output from API response. Absolutely ridiculous.](https://www.reddit.com/r/GoogleGeminiAI/comments/1ifdifl/google_removed_their_reasoning_output_from_api/)) indicates that reasoning output was removed from API responses, suggesting users may need to prompt for reasoning steps, a shift from previous functionality.
- **Claude (Anthropic):** Anthropic's Claude, especially Claude 3.7 Sonnet, is a hybrid reasoning model, with API access detailed on [Anthropic API](https://www.anthropic.com/api), offering extended thinking mode visible to users, as per thurrott.com ([Anthropic's First Reasoning AI Model is Now Available](https://www.thurrott.com/a-i/anthropic/317672/anthropics-first-reasoning-ai-model-is-now-available)).
...
|--------------------|----------------------|----------------------------------------------|
| Grok               | Yes, via xAI API     | Likely, supports structured outputs          |
| ChatGPT o1         | Yes, via OpenAI API  | Yes, includes reasoning steps in responses   |
| DeepSeek R1        | Yes, via DeepSeek API| Yes, supports chain-of-thought reasoning     |
| Gemini models      | Yes, via Google API  | May require prompting, reasoning output removed recently |
| Claude             | Yes, via Anthropic API| Yes, extended thinking mode visible          |
| QwQ-32B            | Yes, via DashScope API| Yes, reasoning included in responses         |
...
- [Google AI Gemini API Overview](https://ai.google.dev/gemini_api_overview)
- [Anthropic API for Building with Claude](https://www.anthropic.com/api)
- [Qwen Team Blog on QwQ-32B Model](https://qwenlm.github.io/blog/qwq-32b/)
- [Top 6 AI Reasoning Models to Explore in 2025](https://www.analyticsvidhya.com/blog/2025/03/ai-reasoning-model/)
- [Breaking New Ground: Evaluating the Top AI Reasoning Models of 2025](https://e-discoveryteam.com/2025/02/12/breaking-new-ground-evaluating-the-top-ai-reasoning-models-of-2025/)
...
- [What Are Reasoning Models and Why You Should Care](https://www.bigdatawire.com/2025/02/04/what-are-reasoning-models-and-why-you-should-care/)
- [OpenAI O1 API Tutorial: How to Connect to OpenAI's API](https://www.datacamp.com/tutorial/openai-o1-api)
- [DeepSeek-R1 free API. How to use DeepSeek-R1 for free using…](https://medium.com/data-science-in-your-pocket/deepseek-r1-free-api-58b47e849f1c)
- [Anthropic's First Reasoning AI Model is Now Available](https://www.thurrott.com/a-i/anthropic/317672/anthropics-first-reasoning-ai-model-is-now-available)
...
- [Microsoft introduces Phi-4, an AI model for advanced reasoning tasks](https://www.computerworld.com/article/3624280/microsoft-introduces-phi-4-an-ai-model-for-advanced-reasoning-tasks.html)
- [Top AI tools in 2025: What they do and how to use them](https://yourstory.com/2024/09/top-10-ai-models-2025)
