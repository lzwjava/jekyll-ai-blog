...
- Protocols/IO: The engine drives HTTP (REST/SOAP/GraphQL), WebSocket, and UI (via Karate’s driver). It can also start a mock server to stub dependencies.
- External systems: Real services or mocked ones respond.
- Reporting: Assertions produce reports (HTML, JUnit XML, JSON), which your CI/CD can publish.

If you want the diagram tailored to a specific slice (e.g., only API testing, or emphasizing mocks or UI), tell me and I’ll adjust the nodes/edges.
