...
title: From Idealism to Corporate Reality
translated: false
type: note
---
...
1. **Vagueness** - What counts as "evil" is subjective and changes with context
2. **Growing pains** - As Google became massive, some decisions (data collection practices, working with governments, ad policies) led critics to argue they'd abandoned the principle
3. **Official change** - In 2015, when Google restructured under Alphabet, the official code of conduct shifted to "Do the right thing," though "Don't be evil" still appears in it
