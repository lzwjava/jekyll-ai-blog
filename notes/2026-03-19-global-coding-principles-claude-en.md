...
lang: en
layout: post
title: Global Coding Principles for CLAUDE.md
translated: false
type: note
---

Question: How can I simplify the programming rules from the document into a concise CLAUDE.md file for global use across projects?
