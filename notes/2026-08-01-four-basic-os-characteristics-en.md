...
lang: en
layout: post
title: Four Basic OS Characteristics
translated: false
type: note
---
...
3. **Virtuality (虚拟性):** The technique of mapping a physical entity into logical equivalents (such as Virtual Memory or Virtual CPUs) to provide users with an optimized and isolated operating environment.
4. **Asynchrony (异步性):** In a multi-tasking environment, processes execute in an asynchronous manner—progressing, pausing, and completing at unpredictable times and speeds due to resource competition.
