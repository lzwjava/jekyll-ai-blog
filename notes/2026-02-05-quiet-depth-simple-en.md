...
title: Quiet Depth in Simple Words
translated: false
type: note
---

This question is about the writing style of "A Brief Account of My Late Mother" (《先妣事略》) by Qing Dynasty writer Gui Youguang (归有光). You correctly chose **D**.

## The Language Style

The essay's style is characterized by **simplicity and conciseness** (简洁省净).
...
- **A** (passionate and surging) - The essay is restrained, not passionate
- **B** (humorous and witty) - This is a solemn memorial piece
- **C** (elegant and weighty) - While respectful, it's more plain than formally elegant

This "plain yet profound" style (平淡而深刻) is actually Gui Youguang's signature approach and is considered a major achievement in classical Chinese prose.
