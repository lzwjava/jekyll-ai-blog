...
title: McKinsey’s Structured Problem Solving Approach
translated: false
type: note
---
...
2. **Structure the problem** — Break it down into logical components (using issue trees).
3. **Prioritize issues** — Focus on the highest-impact areas (often applying the 80/20 rule).
4. **Develop workplan and analysis** — Plan which analyses to perform.
5. **Conduct analysis** — Gather and interpret data/facts.
6. **Synthesize findings** — Draw insights and test the hypothesis.
7. **Develop recommendations & communicate** — Create a compelling story and present solutions persuasively.
