...
lang: en
layout: post
title: Liang Qichao on Perseverance and Success
translated: false
type: note
---
...
1. **First paragraph (main argument and analysis)**
...
2. **Second paragraph (analogies and conclusion)**
   - Uses three classical analogies to reinforce the point:
     ...
     c. **Mencius – Digging a well** (掘井譬喻): Digging nine fathoms without reaching water is the same as abandoning the well.
   - Ends by saying success or failure ultimately depends on whether one has perseverance.
