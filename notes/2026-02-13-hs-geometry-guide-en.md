...
title: Essential High School Geometry Guide
translated: false
type: note
---
...
- **Angle relationships with transversal**:
  - Corresponding angles: congruent (if parallel)
  - Alternate interior angles: congruent (if parallel)
  - Alternate exterior angles: congruent (if parallel)
  - Consecutive (same-side) interior angles: supplementary (if parallel)
...
- **Postulates/Theorems**:
  ...
  - ASA (Angle-Side-Angle, included side)
...
- **Criteria**:
  - AA (Angle-Angle)
  - SSS Similarity (sides proportional)
...
- **45-45-90** (isosceles right triangle):
  ...
  - Ratios: 1 : 1 : √2
- **30-60-90**:
  - Sides opposite: 30° (shortest), 60°, 90° (hypotenuse)
...
- **Types**:
  ...
  - Rectangle: Parallelogram with four right angles; diagonals congruent.
  - Rhombus: Parallelogram with four congruent sides; diagonals perpendicular and bisect angles.
  - Square: Rectangle + rhombus (all properties).
  - Trapezoid: Exactly one pair of parallel sides (bases); isosceles trapezoid has congruent legs and base angles.
...
- **Properties**:
  ...
  - Diameter subtends 90° at circumference (semicircle).
  - Central angle = measure of arc; inscribed angle = ½ arc measure.
...
- [Common Core High School Geometry Standards](https://www.thecorestandards.org/Math/Content/HSG/)
- [Various Geometry Cheat Sheets and Formula References](https://reymath.weebly.com/uploads/1/9/0/4/19049463/geometry_cheat_sheet_all.pdf)
