...
- **Processing Time**: Typically 4 weeks for initial applications.
- **Quota**: No overall cap, but Category C has an annual limit of 10,000 spots (first-come, first-served).
- **Exclusions**: Not available to nationals of Afghanistan, Cuba, Laos, North Korea, Nepal, or Vietnam.
- **Success Stats**: As of late 2024, over 116,000 applications were received, with nearly 92,000 approvals, including over 75,000 talents and families arriving in Hong Kong.
...
4. **For Mainland Applicants**: Secure an Exit-Entry Permit (EEP) and exit endorsement from Mainland authorities first; present e-Visa QR code at Hong Kong entry.
5. **Decision & Entry**: Expect approval in 4 weeks. Successful applicants receive an e-Visa; enter Hong Kong and get a landing slip.
6. **Extensions/Renewals**: Apply up to 3 months before expiry (updated 2025 from 4 weeks). Must show employment/business proof; further extensions possible if criteria met.

Applications are straightforward with minimal paperwork compared to other schemes like the Admission Scheme for Mainland Talents and Professionals (ASMTP), which requires a job offer.
...
- [Hong Kong SAR: Key Updates for Top Talent Pass Scheme - Fragomen](https://www.fragomen.com/insights/hong-kong-sar-key-updates-for-top-talent-pass-scheme-and-quality-migrant-scheme-introduced.html)
