...
lang: en
layout: post
title: NVIDIA H200 Price Increase Debunked
translated: false
type: note
---
...
* This range has been relatively **stable**, not +80万 jump. ([NVIDIA H200][1])
...
* Full server (CPU, memory, network) often **$300k–$320k**
  → That's roughly **¥210万–¥230万 RMB** total. ([ThePricer][2])
