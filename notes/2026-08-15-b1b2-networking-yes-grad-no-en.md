...
lang: en
layout: post
title: "B1/B2: Networking Yes, Grad No"
translated: false
type: note
---

Question: On a B-1/B-2 visitor visa, staying months in the US — can you network, hit conferences, and enroll in a Master's program?
...
**Given your actual profile (not a beginner grad-school case):**

Skip the "go get a Master's" route — you're 12 years in, running a company, trained a 760M model on MI300X. A degree adds nothing to your resume that your GitHub/products don't already prove. The paths that actually fit:

1. **O-1A (extraordinary ability)** — you have a legit shot here: published work, a company you built with real revenue, notable technical achievements (GPT-2 760M training, agent tooling). Needs a US petitioner/agent to file, but doesn't need a job offer from a single employer the way H-1B does.
2. **E-2 treaty investor** — if China had an E-2 treaty with the US it'd fit your "own AI company" profile, but China does not have an E-2 treaty. Doesn't apply.
3. **EB-1A green card** (self-petition, no employer needed) — same evidence bucket as O-1A, worth building in parallel since it's a longer-term play toward not needing status renewals at all.
