...
lang: en
layout: post
title: OpenClaw Not Built for Hacking Tasks
translated: false
type: note
---

**Question:** Is OpenClaw very good at hacking, such as finding vulnerabilities in websites, scanning ports, breaking passwords, and performing other hacking tasks? OpenClaw is the AI agent that I let control the computer.

**Answer:**

No, OpenClaw is **not** very good at hacking tasks like finding website vulnerabilities, scanning ports, cracking passwords, or any form of unauthorized hacking.
...
- There are known security issues with OpenClaw itself (such as prompt injection risks and past remote code execution vulnerabilities), which could make your own system less secure if you run it.

**Important warning:** Using any AI agent, including OpenClaw, for unauthorized hacking (scanning other people's ports, breaking into websites, cracking passwords, etc.) is **illegal** in most countries and can result in serious legal consequences. I strongly advise against it. OpenClaw is meant for helpful, personal automation—not offensive security or criminal activity.
