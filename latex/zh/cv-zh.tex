...
\title{李智维}
\author{中国广州 · \href{mailto:lzwjava@gmail.com}{lzwjava@gmail.com} · \href{https://github.com/lzwjava}{GitHub} · \href{https://lzwjava.com}{作品集}}
\date{}
\maketitle
...
高级后端/全栈工程师，拥有 12 年以上专业经验（9 年企业任职，3 年自由职业）。擅长后端系统、云原生服务、性能工程和实际机器学习项目。在构建生产系统（Java、Spring、Python）、移动应用（iOS/Android）、开发者自动化和技术写作方面拥有卓越的记录。此前通过外包合作担任汇丰银行 (HSBC) 银行系统的后端工程师，目前正在寻找新的工作机会。
