  ...
  \cventry
    ...
    {2025年2月 - 至今} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {加入汇丰内部 AI 社区，并凭借高关注度项目 AIPlayer 获得贡献奖；业余时间持续探索 AI，在 H200 和 RTX 4070 GPU 上使用 nanoGPT 训练小模型，使用 OpenRouter 和 Claude Code 开发个人项目（过去一年使用约 10 亿 token），并熟悉 Codex、llama.cpp、Transformers 和推理技术。}
