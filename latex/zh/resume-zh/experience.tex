  ...
  \cventry
    ...
    {2025年2月 - 至今} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {作为TEKsystems外包至汇丰银行的后端工程师，为汇丰企业技术部财务转型平台的一个模块开发和优化后端系统。}
        ...
        \item {将自己打造成为一个自主的人形AI代理，通过脚本、日志、文档和分享，尽可能地实现自动化。通过LLM输出的缓存和验证，为20个定制代理提供专用提示和上下文，并在整个技术栈中使用了400个可重用的Copilot编写的脚本和1100份Copilot编写的指南，在大型银行里的工程体验开始变得良好。并且在内部以 premium requests 指标衡量的 Copilot 使用量中排名前 6\%。}
        \item {熟悉Java、Spring、IBM Db2、Maven、Nexus、Angular和Python等技术，以及Windows、Control-M、IBM WebSphere Liberty Profile和Copilot等工具。}
        \item {加入汇丰内部 AI 社区；获得汇丰内部重点项目 AIPlayer 的贡献奖；业余时间持续关注 AI 进展；使用 Andrej Karpathy 的 nanoGPT 训练小模型；在个人项目中使用 OpenRouter 和 Claude Code 进行大规模编码；过去一年消耗约 10 亿 token；学习了 MCP、LangChain、Codex、vLLM、多模态技术、推理等。}
        \item {正在使用 OpenClaw 构建多机集群控制的自主 AI 工程工作流，在 H200 GPU 上训练领域专用模型，并基于 Claude Code 搭建自托管开源系统，以端到端独立交付软件项目。}
      \end{cvitems}
    }
%---------------------------------------------------------
  \cventry
