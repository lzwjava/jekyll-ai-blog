...
\author{
  Zhiwei Li\thanks{Independent Researcher. Email: lzwjava@gmail.com.} \and
...
\subsection{Prompt 6: Auditor's Report (PCAOB Standards)}

\textbf{Input:} A company address transitioning to an independent auditor's report on internal control over financial reporting.
...
sheet of America. These consolidated financial statements
are the responsibility of the Company's management. Our
responsibility is to express an opinion on these
consolidated financial statements and are a public
accounting firm registered with the local accounting
firm. We are a public accounting firm registered with
...
\textbf{Observations:}
\begin{itemize}
    \item Seamless transition from company address to auditor's report format
    \item Correct PCAOB language and regulatory references (PCAOB, SEC, U.S. federal securities laws)
    \item Proper auditor opinion structure: responsibility statement, standards compliance, critical audit matters
    \item Hallucinated ``America'' as company name (likely from ``Bank of America'' training data)
    \item Grammatically perfect and follows real auditor report conventions closely
    \item One of the highest-quality generations observed
\end{itemize}

\subsection{Prompt 7: Legal Proceedings (Item 3)}

\textbf{Input:} Standard legal proceedings disclosure opening (``From time to time, we are involved in various legal proceedings...'').

\textbf{Generated continuation (first 600 tokens):}

\begin{Verbatim}[fontsize=\small]
We may not be able to sustain the infringing intellectual
property rights that are adequately held by others;

we may not have the resources to develop, manufacture,
and distribute products or changes in the enforcement
or misappropriation of our intellectual property;

We may have additional intellectual property rights;

If we are unable to establish and maintain a favorable
resolution of our business strategy and plans, we may
not be able to obtain or maintain a positive effect on
the part of such litigation;

The financial resources and results of our current
management team or our inability to obtain necessary
governmental and regulatory approvals to conduct our
operations;

The success of our products may depend on our ability
to develop, manufacture, supply, and distribute new
products;

Our inability to protect our intellectual property;

Our ability to obtain and maintain key management's
time, and in-license agreements with third parties
for our business, or to develop and commercialize
products could result in delays in our product
development efforts, including the loss of one or more
of our revenue, and the loss of key employees;
\end{Verbatim}

\textbf{Observations:}
\begin{itemize}
    \item Maintained bullet-point format with proper legal disclosure structure
    \item Content stayed on-topic: intellectual property, regulatory compliance, management risks
    \item Mixes ``we'' and ``We'' inconsistently (common in real filings too)
    \item Some grammatical awkwardness but overall plausible legal language
    \item Good variety of risk factors rather than pure repetition
    \item Model correctly identified this as a risk disclosure section
\end{itemize}
\subsection{Prompt 8: HSBC Business Description}
...
\subsection{Prompt 9: DBS Group MD\&A}
...
to a reduction in volume of interest-bearing
liabilities.

Interest income, net was 42.1% in the prior year due
to a reduction in average interest rates.

Interest expense, net was 45.2% in the prior year due
to a reduction in average interest rates. The current
year's average interest rate was 3.7% in the prior
year period.
\end{Verbatim}
