...
\begin{itemize}
    ...
    \item Li, Zhiwei. (2023). \textit{Experimental Verification of the Natural Vision Restoration Method}. \url{https://lzwjava.com/vision-restoration-en}.
    \item Li, Zhiwei. (2023). \textit{Astigmatism in Reversing Myopia}. \url{https://lzwjava.com/astigmatism-en}.
    \item Li, Zhiwei. (2024). \textit{Natural Vision Restoration: The Principle of 'Just Barely Clear'}. \url{https://lzwjava.com/barely-clear-en}.
\end{itemize}

\section*{Citation}
Li, Zhiwei. (Nov 2024). \textit{Natural Vision Restoration: Experimental Verification, Astigmatism Reduction, and the 'Just Barely Clear' Principle}. Zhiwei's Blog. \url{https://lzwjava.com/natural-vision-restoration-en}

Or in BibTeX:
\begin{verbatim}
@article{li2024naturalvisionrestoration,
