  ...
  \cventry
    ...
    {Feb 2025 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Joined HSBC's internal AI community and earned a Contribution Award for the high-profile AIPlayer project; continuously explored AI after work by training small models (nanoGPT) on H200 and RTX 4070 GPUs, building personal projects with OpenRouter and Claude Code (\textasciitilde1B tokens used in the past year), and gaining familiarity with Codex, llama.cpp, Transformers, and reasoning techniques.}
      \end{cvitems}
    }
