  ...
  \cventry
    ...
    {Feb 2025 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Continuously explored AI after work by training small models (nanoGPT, GPT-2 760M, SEC-EDGAR-GPT 124M) and fine-tuning models on personal knowledge base text (\textasciitilde5M tokens) across H200, RTX 4070, and AMD MI300X GPUs; running inference with Qwen-27B; building personal projects using OpenRouter and Claude Code (\textasciitilde3B tokens consumed in the past year); and gaining hands-on familiarity with PyTorch, ROCm, FlashAttention, Codex, llama.cpp, Transformers, and reasoning techniques. Joined the NVIDIA Accelerated Computing Developer Tech Exchange and learned techniques from industry experts.}
      \end{cvitems}
    }
