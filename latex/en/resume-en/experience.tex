...
%---------------------------------------------------------
  \cventry
    ...
    {Meitai Technology Service (Shanghai) Co., Ltd. Guangzhou Branch} % Organization
    ...
    {Feb 2025 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Worked with technologies such as Java, Spring, IBM Db2, Maven, Nexus, Angular, and Python, along with tools including Windows, Control-M, IBM WebSphere Application Server, and Copilot.}
        \item {Joined the internal HSBC AI Community; stayed updated on AI progress after work; trained small models using Andrej Karpathy's nanoGPT; utilized OpenRouter and Claude Code for extensive coding in personal projects; consumed approximately 320 million tokens over the past year; learned MCP, LangChain, Codex, vLLM, multi-model techniques, reasoning, and more.}
      \end{cvitems}
    }
