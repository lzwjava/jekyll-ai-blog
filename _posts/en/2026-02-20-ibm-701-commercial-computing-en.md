...
lang: en
layout: post
title: IBM 701 Pioneering Commercial Computing
translated: false
type: note
---

### **Comprehensive Introduction to the IBM 701: The Dawn of Commercial Computing**
...
| **Feature**               | **Details**                                                                 |
|---------------------------|-----------------------------------------------------------------------------|
| **Architecture**          | Stored-program, von Neumann architecture                                  |
| **Components**            | Vacuum tubes (4,000+), magnetic drum memory, electrostatic storage tubes |
| **Memory**                | 2,048 words (36 bits per word)                                             |
| **Speed**                 | ~2,200 additions/subtractions per second                                  |
| **Input/Output**          | Punched cards, magnetic tape, electric typewriter                         |
| **Size**                  | Large—occupied a room (~3m x 3m or more)                                  |
| **Power Consumption**     | ~22 kW (required dedicated cooling)                                       |
...
The IBM 701 was a turning point in computing history, bridging the gap between experimental machines and practical, commercial systems. Its legacy lives on in modern supercomputers and data centers, which still rely on principles of stored-program architecture and high-speed processing.

Would you like to dive deeper into any specific aspect, such as its programming, hardware, or historical anecdotes?