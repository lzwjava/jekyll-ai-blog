...
title: Focused Thinking Yields Fast Results
translated: false
type: note
---
...
- Immersing deeply in **one problem for a long time** (without constant context switching) often produces faster real progress than doing many shallow things.
- The mind keeps working in the "background" even when you appear idle — similar to Liu Weipeng's (刘未鹏) famous concept of **"dark time"** (黑暗时间 / 暗时间): the highly valuable mental processing that happens when you're walking, showering, lying in bed, taking a slow walk, etc., as long as the problem is being held continuously in attention.
- The analogy of the mind as a **single-threaded CPU** that runs most efficiently when given one important task for a sustained period (instead of constant task switching) is a very common mental model among people influenced by both Yin Wang and Liu Weipeng.
