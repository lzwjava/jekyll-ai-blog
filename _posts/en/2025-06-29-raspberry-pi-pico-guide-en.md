...
1. **Core Electronics - Raspberry Pi Pico Workshop**
   ...
   - **Link**: Check the Core Electronics YouTube channel for their “Raspberry Pi Pico Workshop” playlist.[](https://raspberrytips.com/best-raspberry-pi-courses/)
...
2. **Kevin McAleer (KevsRobots) - Raspberry Pi Pico Tutorials**
   ...
   - **Link**: Search for “Raspberry Pi Pico for Robotics” on Kevin McAleer’s YouTube channel or visit kevsrobots.com for additional resources.[](https://www.classcentral.com/course/youtube-raspberry-pi-pico-for-robotics-130133)[](https://www.kevsrobots.com/learn/learning_pathways/pico.html)
   - **Level**: Beginner to Intermediate
   - **Note**: His content is free, with additional resources like GitHub code and 3D-printable designs for hands-on learners.

3. **Hunter Adams - Cornell University’s Digital Systems Design Course**
   ...
   - **Link**: Search for “Digital Systems Design Using Microcontrollers” on Hunter Adams’ YouTube channel or Cornell’s course website.[](https://www.raspberrypi.com/news/cornell-universitys-digital-systems-design-course-is-taught-on-rp2040/)
   - **Level**: Intermediate to Advanced
   - **Note**: This course is not beginner-friendly and assumes prior microcontroller knowledge. It’s perfect for diving deep into Pico’s capabilities, but you may need to brush up on prerequisites like C programming or embedded systems basics.[](https://www.reddit.com/r/raspberry_pi/comments/wkh1d8/cornell_course_on_raspberry_pi_pico/)
...
4. **Random Nerd Tutorials**
   ...
   - **Link**: Visit the Random Nerd Tutorials YouTube channel or their website for Pico-specific videos and written guides.[](https://www.classcentral.com/report/best-raspberry-pi-courses/)
   - **Level**: Beginner to Intermediate
...
- **Explore IoT and Robotics**: Courses covering IoT (e.g., ThingSpeak, Adafruit IO) and robotics (e.g., servo control, motorised buggies) are excellent for real-world applications. Random Nerd Tutorials and Kevin McAleer’s content are strong in these areas.[](https://www.classcentral.com/report/best-raspberry-pi-courses/)[](https://www.udemy.com/course/learn-iot-using-micropython-and-raspberry-pi-pico/)
