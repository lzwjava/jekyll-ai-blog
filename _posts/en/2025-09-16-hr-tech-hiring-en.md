...
3) Is “20 engineers per year” hard?
It can be moderate to hard, depending on context:
...
- If 25% of sourced leads take a screen, you need ~1,000 targeted outreaches (plus inbound and referrals)
Actual ratios vary by market and role seniority.
...
- salary bands
- timeline
I can sketch a customized hiring plan and pipeline math for “20 engineers in a year,” plus which channels to prioritize in Guangzhou vs Silicon Valley (or elsewhere).
