...
lang: en
layout: post
title: Infoseek Pioneering 1990s Search Innovations
translated: false
type: note
---

Question: What is an introduction to Infoseek Corporation in the 1990s?

Answer:

## Infoseek Corporation — Overview
...
- **Search Technology:** Its web search service utilized the INQUERY retrieval engine developed by the Center for Intelligent Information Retrieval at the University of Massachusetts, which supported natural language processing — allowing users to submit queries in everyday phrasing rather than strict Boolean syntax.

- **Advertising Pioneer:** Infoseek was the first search engine to sell advertising on a CPM (Cost Per Thousand Impressions) basis.

- **Behavioral Targeting:** In cooperation with Aptex Software, Infoseek was the first search engine company to develop and launch behavioral targeting, via its UltraMatch targeting algorithms. The developmental partnership was announced in 1996 and the technology was released the following year.

- **Real-time Indexing:** Infoseek was one of the first search engines to offer real-time search results for indexed web pages, meaning changes made to a page were instantly reflected in the search results — a huge leap forward from the batch update approach used by many peers.

- **Advanced Search:** Infoseek provided users with an array of advanced search options, including relevance ranking, local indexing, proximity searches, and Boolean search capabilities.
