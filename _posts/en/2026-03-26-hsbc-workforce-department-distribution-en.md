...
lang: en
layout: post
title: HSBC Workforce Composition and Department Distribution
translated: false
type: note
---
...
HSBC is one of the largest global banking and financial services organisations, with around **211 000 employees worldwide** as of the end of 2025. ([StockAnalysis][1])
...
* HSBC openly highlights **technology and engineering careers** as key to its digital transformation, emphasising digital banking platforms, systems engineering, and innovative solutions. ([HSBC][2])
* A Reuters‑linked industry article mentions that HSBC is providing **AI coding assistants to about 31 000 engineers**, which suggests the bank has a **large engineering population relative to some corporate functions**, though that likely includes a broad definition of “engineers” (IT, software, systems, cybersecurity, automation, etc.). ([WatersTechnology.com][3])
* HSBC also **hired 1 800 technology specialists** in a recent year, indicating ongoing expansion of tech talent. ([eFinancialCareers][4])
...
HSBC has been undertaking restructuring and cost‑cutting measures, including potential **job reductions tied to technology and automation**, especially in back‑office roles that can be automated. Some analyses suggest up to **20 000 jobs could be cut as part of AI‑driven transformation**, focusing on middle‑ and back‑office functions. ([LinkedIn][5])
