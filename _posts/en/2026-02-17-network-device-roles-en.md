...
lang: en
layout: post
title: Network Device Roles Explained
translated: false
type: note
---

Question: Based on the different logical positions of devices in a computer network, network devices can be categorized into _______ and intermediate devices. (Answer: End systems/Terminal devices)
...
* [Cisco Networking Academy: End Devices and Intermediary Devices](https://www.google.com/search?q=https://www.netacad.com/)
* [Network Fundamentals: Roles of Host and Intermediate Devices](https://en.wikipedia.org/wiki/End_system)
