...
| `vae/diffusion_pytorch_model` | 160 MB | ✅ |
| **`flux1-schnell.safetensors`** | **~20+ GB** | **⏳ Still downloading** |

Still running fine in tmux. 2.9T available — plenty of space.
