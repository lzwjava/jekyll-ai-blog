...
title: Taking the TOEFL in Guangzhou
translated: false
type: note
---

### How to Take the TOEFL Exam in Guangzhou, China
...
1. **Create an Account and Register Online**:
   ...
   - Log in and select "Register for a Test" (报名). Choose Guangzhou as your city, then pick an available date and test center.
   - Pay the fee online (approximately 2,100 CNY as of recent reports; exact amount shown during registration). Payment is via Chinese bank card, Alipay, or WeChat Pay. International cards may not work—use a local method or contact NEEA support.
   - Registration opens about 3-4 months in advance, and tests are offered over 50 times a year (more than 170 globally, with frequent slots in Guangzhou). Book early as popular dates fill up.
...
3. **Prepare Required Documents and What to Expect**:
   - **ID**: Bring your passport (original, not copy) on test day—it's mandatory for check-in.
   - **Arrival**: Arrive 30-60 minutes early. Centers enforce strict security (no phones, bags, or food inside).
   - **Test Day**: The iBT lasts about 3 hours (Reading, Listening, Speaking, Writing). It's fully computer-based with headphones for audio sections. Breaks are included.
   - **COVID/Health Rules**: As of 2025, masks may be optional, but check for any updates on health codes or vaccinations via the site.
   - Scores are available online in 4-8 days and sent to up to 4 institutions for free.

4. **Additional Tips**:
   - **Cost**: ~2,100 CNY (includes score reports). Late registration adds fees; rescheduling costs extra.
   - **Practice**: Free resources on [ETS.org/toefl](https://www.ets.org/toefl) or NEEA site. Official prep books are available at local bookstores in Guangzhou.
   - **Support**: For issues, contact NEEA helpline (010-82345674) or email via the site. ETS China office in Guangzhou: +86-20-3881-0456 (for inquiries).
   - **Visa/Travel**: No special visa needed for locals; international students should confirm center policies.
...
- [GlobalExam Guide to TOEFL in China](https://global-exam.com/blog/en/where-to-take-the-toefl-in-china/) – Fees and province lists.
