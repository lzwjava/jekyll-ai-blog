...
title: Overlooked Web Design Exam Topics
translated: false
type: note
---

Question: What are unpopular or overlooked exam topics and questions for the 13167 Web Design and Production course in China's National Higher Education Self-Study Examination?

Answer:

The 13167 Web Design and Production course (网页设计与制作) in China's National Higher Education Self-Study Examination (自考) focuses on core web development skills, including HTML/CSS basics, tools like Dreamweaver and Photoshop, image processing, and introductory dynamic web elements. While popular exam topics cover fundamentals like HTML tags, basic page layouts, and simple CSS styling, "unpopular" or overlooked content often includes niche technical details, advanced tool features, or conceptual aspects that appear infrequently in past papers but can catch candidates off guard. These are typically low-yield for rote memorization but test deeper understanding.
...
- **Web Application Modes**: Suitability of site types (e.g., info-publishing vs. interactive), including edge cases like music/literature downloads.
  *Example Question*: "一般来说，适合使用信息发布式网站模式的题材有（  ）。 A. 软件下载 B. 新闻发布 C. 个人简介 D. 音乐下载 E. 文学作品大全"
...
- **Dreamweaver Behaviors and Libraries**: Template/library pitfalls or "WYSIWYG" tool weaknesses (e.g., compatibility issues).
  *Example Question (Short Answer)*: "“所见即所得”型网页制作工具的致命弱点是什么？"
...
- **Multimedia Handling**: Flash animation limits or image optimization for web (e.g., GIF vs. PNG trade-offs).
  *Example Question*: "使用图像处理工具可对图像怎样的处理？（列举3–5种）"
