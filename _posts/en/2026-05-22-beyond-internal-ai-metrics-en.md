...
lang: en
layout: post
title: Beyond Internal AI Metrics
translated: false
type: note
---
...
1. **Ship AI that 10M+ customers feel in their daily banking** — not just internal ops
2. **Open source something** or publish research — show the world your AI muscle
3. **Let AI make real decisions** — not just "assist" a human who overrides it anyway
4. **Build network effects from AI** — your AI improves because more customers use it (Ant Financial's credit model is the gold standard here)
5. **Get the developer community talking** — if ML engineers at other companies are discussing your model architecture, you've crossed the threshold
