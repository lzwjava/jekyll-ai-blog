...
### 1. **TeaVM: Compiling Java to WebAssembly and JavaScript**
   ...
   - **Where to Find It**: [TeaVM on GitHub](https://github.com/konsoletyper/teavm)[](https://www.infoworld.com/article/2338408/7-awesome-java-projects-you-should-know-about.html)
...
### 2. **MicroStream: High-Performance Object Persistence**
   ...
   - **Where to Find It**: [MicroStream on GitHub](https://github.com/microstream-one/microstream)[](https://www.infoworld.com/article/2338408/7-awesome-java-projects-you-should-know-about.html)
...
### 3. **NASA World Wind: 3D Virtual Globe**
   ...
   - **Where to Find It**: [NASA World Wind on GitHub](https://github.com/NASAWorldWind/WorldWindJava)[](https://intexsoft.com/blog/8-best-popular-projects-on-java/)
...
### 4. **OpenLatextStudio: Collaborative LaTeX Editor**
   ...
   - **Where to Find It**: Check GitHub or open-source communities for similar projects, as OpenLatextStudio is referenced in Java open-source lists[](https://dev.to/surajondev/20-trending-and-popular-java-open-source-project-2igi)
...
### 5. **LanguageTool: Multilingual Grammar and Style Checker**
   ...
   - **Where to Find It**: [LanguageTool on GitHub](https://github.com/languagetool-org/languagetool)[](https://dev.to/surajondev/20-trending-and-popular-java-open-source-project-2igi)
...
### 6. **Flappy Bird Clone with Java Swing**
   ...
   - **Where to Find It**: Search GitHub for “Java Flappy Bird” or check tutorials like those on Medium[](https://medium.com/javarevisited/20-amazing-java-project-ideas-that-will-boost-your-programming-career-75c4276f6f5)
...
### 7. **Minecraft Pathfinder Bot**
   ...
   - **Where to Find It**: Look for Minecraft bot projects on GitHub[](https://dev.to/surajondev/20-trending-and-popular-java-open-source-project-2igi)
...
### 8. **Color Hunt: A Mind Game**
   ...
   - **Where to Find It**: Referenced in Java project idea lists like DataFlair[](https://data-flair.training/blogs/java-project-ideas/)
