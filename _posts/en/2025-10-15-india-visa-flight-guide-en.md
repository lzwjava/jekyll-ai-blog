...
- **Requirements**: Passport valid for at least 6 months from arrival, two blank pages, recent photo, and proof of onward travel. Fee is around $25-80 USD depending on validity.
- **Alternative**: If e-visa isn't suitable, apply for a paper tourist visa (3 months single entry) through BLS International Services in China (centers in Beijing, etc.), but e-visa is recommended for speed.
Since you're in Guangzhou, check the Consulate General of India there for any local guidance.
...
| CAN → DEL → GOI | Air India / IndiGo | 1 | 13-18 hrs | ~$250-350 |

- **Best Booking Sites**: Use Skyscanner, Trip.com, or MakeMyTrip for comparisons. Search for flexible dates to save 20-30%.
- **Airlines to Consider**: IndiGo (budget, good for India leg), China Southern (from Guangzhou), or Cathay Pacific (reliable connections).
...
- **Total Cost Estimate**: Flights $400-600 round-trip + visa $50 + internal Goa transport $50-100.
