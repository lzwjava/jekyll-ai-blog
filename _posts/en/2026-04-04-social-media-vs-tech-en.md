...
lang: en
layout: post
title: Social Media Doesn't Replace Technical Interviews
translated: false
type: note
---

**Question:** Even with 10K or 100K followers on WeChat, Weibo, or Twitter, does social media following still count as just one small factor when companies interview you — judged by their own standards? And are these two separate things, though having social impact is still beneficial, especially in technical fields like software engineering?
...
- Passing coding rounds (LeetCode-style problems)
...
**a) It can get you noticed before the interview even happens.**
92% of employers now use social media to find talent, and 82% of organizations use it to recruit passive candidates — people who aren't actively job hunting. So a strong technical presence can open doors.

**b) It can validate your credibility.**
Employers notice positives like professional accomplishments, community involvement, and communication skills that highlight a candidate's strengths.

**c) It signals passion and engagement.**
Recruiters often look for candidates who demonstrate initiative and interest in their profession, not just those who submit an application.
...
- **Social media following = soft amplifier.** It can make recruiters notice you, lend you credibility, and expand your network. In technical communities (software engineering, AI, security, etc.), a well-respected technical voice carries real weight.
- **Interview performance = hard gate.** You still must pass it regardless of your follower count.
- **10K or 100K followers** may help you get the interview or make an interviewer slightly more curious about you — but it will not help you pass the system design round.
...
- [Why Social Media Is a Powerful Tool for Software Developers – MESCIUS](https://developer.mescius.com/blogs/why-social-media-is-a-powerful-tool-for-software-developers)
- [47 Surprising Social Media Recruiting Statistics (2026) – Apollo Technical](https://www.apollotechnical.com/social-media-recruiting-statistics/)
- [How Social Media Could Affect Your Job Search – Business News Daily](https://www.businessnewsdaily.com/2377-social-media-hiring.html)
- [How social media helped my career as a software engineer](https://cctplus.dev/work-in-public/)
