...
title: Better Photography With Any Camera
translated: false
type: note
---
...
- **Light is everything**
  Best light: the “golden hours” (first hour after sunrise, last hour before sunset).
  Second best: bright overcast days (soft, even light, no harsh shadows).
  Avoid: direct midday sun (ugly shadows under eyes/nose) and mixed lighting (half face yellow, half blue).

- **Get the exposure right**
  Phone: tap the brightest part of the screen and swipe down to darken, or up to brighten.
  Camera: use exposure compensation (±EV) instead of auto all the time.

- **Focus correctly**
  Phone: tap the subject (especially eyes for portraits).
  Camera: use single-point AF and put the focus point on the eyes.

- **Straighten your damn horizon**
  Turn on the grid overlay (most phones/cameras have it) and keep horizontal lines horizontal.

### 2. Composition Rules That Actually Work

- **Rule of thirds** (turn on the 3×3 grid)
  Put eyes, horizon, main subject on the lines or intersections — never dead center (except when you intentionally want symmetry).

- **Lead the eye**
  Use leading lines (roads, fences, arms, shorelines) to pull the viewer into the frame.

- **Frame within a frame**
  Doorways, windows, tree branches = instant depth.

- **Negative space**
  Sometimes leaving a lot of empty space around your subject makes it stronger (especially portraits).

- **Change your perspective**
  Shoot from very low, very high, or through things. 99% of bad photos are taken from eye level while standing.
...
- Edit every photo (even 10 seconds):
  Straighten → raise shadows a bit → lower highlights → increase contrast/clarity → slight vibrance. Done.
