...
lang: en
layout: post
title: Math Olympiad Champion's Path to AI Research
translated: false
type: note
---

Question: What does the Z Tech article about Mingyang Deng (邓明扬) — an MIT PhD student advised by Kaiming He — say? What are his key views, talks, and shared insights?

Answer:

## Overview of the Article

The article profiled by Z Tech (and widely covered in Chinese tech media) introduces **Mingyang Deng (邓明扬)**, nicknamed "乖神" ("Guai Shen" / "Good God") in competitive circles — a prodigious young researcher who transitioned from being a legendary olympiad competitor to becoming an MIT PhD student in generative AI research under the supervision of **Kaiming He (何恺明)**, one of the world's most cited computer scientists (famous for ResNet).
...
In the year he competed at IOI (2021), the Chinese team made history by having a single country's students sweep all top four places — Deng came first with the only perfect score in the entire competition.
...
Deng's current research focus is machine learning, particularly understanding and advancing **generative foundation models**, including diffusion models and large language models.

He collaborated with Kaiming He's group on a notable paper proposing a new image generation method: the paper proposed a new approach to image generation that uses a diffusion process to model the probability distribution of each token, thereby avoiding the use of discrete tokenizers and enabling autoregressive models to operate in continuous value spaces.
...
He advises young competitors: do not study competitive math or informatics merely for the purpose of college admission. You should pursue it because you find it genuinely interesting and feel you can keep learning it. Even if the final results are not ideal, at least the process will be meaningful and enjoyable.
...
| ICPC | MIT team champion (2022), runner-up (2024) |
| MIT Admission | Only mainland Chinese regular admit his year |
| PhD Advisor | Kaiming He (ResNet inventor) |
| Research Area | Generative models: diffusion models & LLMs |
| Philosophy | Interest-driven learning; "fun" over pressure |
