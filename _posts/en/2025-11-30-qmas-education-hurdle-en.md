...
title: "QMAS Suitability Analysis: Education Hurdle"
translated: false
type: note
---
...
- **Action Plan**:
  ...
  2. **Boost Score**: Add spouse/child docs; highlight Talent List fit in personal statement. Get recommendation letters from HSBC/DBS emphasizing seniority.
  3. **Prepare App (6-12 months total)**: Submit online (no fee initial; HKD 230 visa). Include portfolio/GitHub links, blog analytics, paper abstracts. Budget HKD 5k-10k for translations/notarizations.
  4. **Alternatives if QMAS Fails**: Consider Top Talent Pass Scheme (TTPS)—if your income >HKD 2.5M/year or you finish a recognized degree from a top-198 uni list (check if Beijing Forestry qualifies retroactively). Or Admission Scheme for Mainland Talents (ASMTP) with a HK job offer (easier for Chinese).
  5. **Resources**: Use ImmD's self-assessment tool; consult a HK immigration firm (e.g., Fragomen) for ~HKD 10k review.
...
- [Hong Kong QMAS Visa 2025 Guide](https://www.worldoverseasimmigration.com/hong-kong-qmas-visa-2025/)
- [Your Portfolio Summary](https://lzwjava.github.io/portfolio-en)
