...
- Education: Completed one year of study at [Beijing Forestry University](https://www.bjfu.edu.cn) before pursuing an associate degree at [Guangdong University of Foreign Studies](https://www.gdufs.edu.cn) through self-directed learning, successfully completing thirteen courses.
- Professional Experience:
  - [TEKsystems](https://www.teksystems.com) (outsourced to [HSBC Bank](https://www.hsbc.com)): Serving as a backend engineer, leveraging Copilot and building customized agents to develop backend systems within HSBC’s Enterprise Technology Department.
...
- AI: Trained GPT-2-124M (nanoGPT) over 5 days on an RTX 4070, and experimented with H200 GPUs. Built personal AI projects using OpenRouter and Claude Code, consuming approximately 1 billion tokens over the past year.
...
- Writing: Authored approximately [431 original blog posts](https://lzwjava.github.io) on topics including programming, software development, and startups, attracting around 75,000 page views per month. Utilized large language models to translate content into 9 languages, provide text-to-speech audio, support PDF and EPUB formats, integrate with GitHub workflows, and use LaTeX for writing papers and creating a resume.
