...
lang: en
layout: post
title: "Vijaye Raji: Statsig Founder and OpenAI CTO"
translated: false
type: note
---
...
* Focus: experimentation platforms, developer infrastructure, product analytics ([Wikipedia][1])
...
* Created **Small Basic**, a beginner-friendly programming language (side project)
  This stage built his **developer tooling + platform engineering** background. ([Wikipedia][1])
...
This gave him **experience running experiments at scale** (billions of users). ([Business Standard][2])
...
**Statsig** is a **product experimentation platform** for software teams.
It provides:
...
It helps teams **ship features safely and measure impact**. ([GeekWire][3])
...
Statsig tried to combine all into **one system**. ([GeekWire][3])
...
* Customers: OpenAI, Eventbrite, SoundCloud (reported) ([Wikipedia][1])
...
* He now leads engineering for:
  ...
  * product experimentation systems ([OpenAI][4])

This signals something important:

OpenAI wants to **experiment rapidly with product features**
...
> best products come from rapid experimentation and feedback loops ([OpenAI][4])
