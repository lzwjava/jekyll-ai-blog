...
title: Strategies for Sustained Deep Focus
translated: false
type: note
---
...
- **Change state every 25–40 min (Pomodoro + movement)**
  After ~30 min: stand up, walk 2–3 min, drink water, look outside — then start next round. Physical reset dramatically improves next-session focus.

- **Make the problem smaller & more visual**
  Bad: “learn Google Cloud”
  Good examples:
  - Draw a diagram: “request → Cloud Load Balancing → Cloud Run → Firestore”
