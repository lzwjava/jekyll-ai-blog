...
- **Remote Access**: Log in with a Mercury account for on-the-go viewing and control through the companion mobile app (available on iOS and Android), ensuring seamless surveillance from anywhere.
- **Compatibility**: Built for Windows PCs as the primary client (latest version: 4.0.5.46), with mobile versions offering similar core functions. It supports H.265 encoding for efficient video compression and high-resolution feeds up to 4K.
