...
lang: en
layout: post
title: Identifying Energetic People
translated: false
type: note
---

**Question:** How do you identify whether someone is an energetic person?
...
- Recovery is fast — setbacks don't flatline them for long

**The clearest signal:** what they do with unstructured time. Low-energy people default to passive consumption. High-energy people default to *making something* — a script, a post, a system, a plan.

For engineers specifically: look at their GitHub commit history, their notes, their blog frequency. Karpathy tweets at midnight about softmax. That's the signal.
