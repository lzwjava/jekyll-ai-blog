...
- **Reframe failure**: Instead of "I can't afford to fail," try "What's the worst that happens? I learn what doesn't work and try again." You've improvised through Law and still passed— that's resilience.
- **Visualize the bare minimum win**: Aim for 60, not perfection. Picture handing in a paper knowing you hit the basics, then celebrate with something small (coffee, a walk).
- **Address the resistance head-on**: When your mind says "not today," set a 5-minute rule: Just open the book or notes for 5 mins. Often, that's enough to break the inertia. If it doesn't, no guilt—log why (tired? Overloaded?) and try tomorrow.
...
- **Total study time**: 1-1.5 hours/day, 5 days/week. Split: 30-45 mins focused prep + 15-20 mins review/flashcards. Weekends: 2 hours max, one "deep dive" day.
- **Daily flow**:
  - Morning (pre-work): 20 mins light review (e.g., flashcards for Linear Algebra matrices).
  - Evening (post-work): 40 mins active practice (past exams for Networks).
  - Integrate AI/tech: If it's related (e.g., coding in Networks), overlap—study Ethernet while tinkering with a simple Python sim.
- **Pomodoro twist**: 25 mins study + 5 mins break. Use a timer app. Reward: Scroll X guilt-free for 5 mins.
...
- **Tools for efficiency**: Free past papers from your uni site or self-exam forums. Anki for spaced repetition (flashcards on phone, 10 mins commute). Track progress in a simple journal: "Did X questions? Felt Y."
- **Time audit**: Log one week—what's *really* eating hours? Cut 30 mins social media to reclaim study slots.
