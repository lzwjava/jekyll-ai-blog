...
- **Accidental process discovery** — You weren't trying to improve the mango; circumstances (your trip to Zhuhai) forced a different storage method, just as ancient people likely stumbled upon fermentation by accident.
- **A change in storage conditions transforms the food** — Cold storage doesn't just preserve the mango; it actively changes its texture and flavor profile in a desirable way, just as fermentation doesn't merely preserve soybeans — it creates an entirely new food.
- **The "wrong" method turned out better** — Conventional wisdom says keep mangoes at room temperature. You accidentally violated that rule at the right moment (post-ripening) and found a superior eating experience.
