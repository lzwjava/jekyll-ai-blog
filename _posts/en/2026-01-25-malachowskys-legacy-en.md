...
title: NVIDIA CoFounder Chris Malachowskys Legacy
translated: false
type: note
---

**Question:** Provide a comprehensive introduction to Chris A. Malachowsky at NVIDIA.

**Answer:**

**Chris A. Malachowsky** is an American electrical engineer, inventor, and entrepreneur best known as one of the three co-founders of **NVIDIA Corporation**, alongside Jensen Huang (CEO) and Curtis Priem.

He co-founded NVIDIA in April 1993, and the famous founding story involves the initial idea being sketched out on a napkin (or placemat) during a breakfast meeting at a Denny's restaurant.
...
- Currently holds the title of **Senior Technology Executive** and is recognized as an **NVIDIA Fellow**
- Has been instrumental in defining, managing, and driving NVIDIA's core technologies for over 30 years (now more than 40 years of total industry experience as of recent profiles)

He is widely regarded as the **chief architect** of the modern **GPU** (Graphics Processing Unit). His technical leadership helped transform GPUs from specialized graphics accelerators into massively parallel programmable processors that power gaming, professional visualization, AI, deep learning, scientific computing, autonomous vehicles, and more.
