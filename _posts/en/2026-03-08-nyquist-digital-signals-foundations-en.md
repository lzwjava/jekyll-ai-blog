...
lang: en
layout: post
title: Nyquist Foundations of Digital Signals
translated: false
type: note
---

**Question:** Who is Harry Nyquist, and what were his major contributions to engineering and communication theory?
...
- **Nyquist Rate** — the minimum sampling rate required (twice the highest signal frequency) to faithfully reconstruct a signal.
- **Nyquist Frequency** — half the sampling rate; signal frequencies below this value are unambiguously represented.
