...
lang: en
layout: post
title: Credit Transfer Articulation Program
translated: false
type: note
---

**Question:** What is the Chinese higher education program called "转学分衔接本科," and how does it work?
...
- **Full-time only** — HK universities (HKU, CUHK, PolyU, CityU etc.) require full-time enrollment for Advanced Standing entrants. Working full-time alongside is structurally very difficult, sometimes contractually prohibited by visa conditions.
- **Academic integrity** — HK universities follow strict policies (plagiarism, AI-generated work). Using LLMs to write assignments wholesale is a real risk. Tools like Turnitin + AI detectors are widely deployed.
