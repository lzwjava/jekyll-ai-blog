...
title: GDUFS 2025 Practical Assessment Registration Notice
translated: false
type: note
---
...
- **Important warnings**:
  ...
  - All registration must be done through the official GDUFS system only.
...
- **Fees**:
  - Normal practical courses: 150 RMB per course
  - Graduation thesis/design thesis: 270 RMB per person (includes one guidance lecture + final review)
  - Optional thesis writing training: additional 400 RMB (voluntary, limited places)

- **Required documents for exam day**:
  - Original valid ID card + printed “Candidate Information Form” (must print yourself from the Guangdong Self-Examination System in advance; electronic versions not accepted)

- **Newly opened programs in 2025 lower half** (first-time practical exams):
  - 050306T Network and New Media
  - 080902 Software Engineering
  - 120204 Financial Management
  - 130309 Broadcasting and Hosting Arts

- **Phasing-out / stopped programs** (last chance for practical assessment is October 2025):
  - Engineering Management (120103), Tourism Management (120901K) — GDUFS no longer the main examination school
  - Six stopped majors: Secretary Studies (050107T), Network Engineering (080903), Procurement Management (120603T), etc.
