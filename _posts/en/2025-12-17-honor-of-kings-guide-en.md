...
title: Beginner's Guide to Honor of Kings
translated: false
type: note
---
...
- **Mage**: Ranged AoE/CC for mid (e.g., Daji).
- **Marksman**: Long-range DPS for farm lane (e.g., Luban No.7).
- **Support**: Heals/buffs/protects (e.g., Angela).
...
4. **Late Game**: Teamfight around towers/Crystal; marksmen carry damage.
5. **Skills/Items**: Level damage skills first. Buy adaptive gear (e.g., magic resist vs. mages). Use Recall to base for full heal.
...
- Ward river/jungle for vision.
- Communicate via pings.
- After basics, watch in-game tutorials (e.g., Arthur, Angela).
...
|---------------|---------------|----------------------------------------|---------------|
| **Clash**    | Arthur       | Tanky sustain, easy ult knockup/gap-close. | 54.2%        |
| **Clash**    | Biron        | Self-heal, simple combos.             | ~53%         |
| **Mid**      | Daji         | Easy burst charm, poke.               | 54.7%        |
| **Farm**     | Luban No.7   | Auto-scatter shots, knockback/slow.   | 53-55%       |
| **Farm**     | Hou Yi       | Long-range suppress, safe farm.       | High         |
| **Roam/Support** | Angela  | Global ult heal/shield, attach to ally. | 53.3%      |
| **Roam**     | Yaria        | Buffs/heals, easy peel.               | 53.8%        |
| **Jungle**   | Zilong/Liu Bei | Basic clears/ganks (avoid assassins). | Good         |

Ban S-tier threats like Augran/Lam if possible. Adapt builds to enemy team.
