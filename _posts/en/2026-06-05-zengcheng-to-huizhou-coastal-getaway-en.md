...
lang: en
layout: post
title: Zengcheng to Huizhou Coastal Getaway
translated: false
type: note
---

**Transportation: Zengcheng (增城) → Huizhou (惠州)**
...
- Food: CNY 100-200/day
- **Total: ~CNY 2,500-3,500 for 3-4 days**
...
- 13:00 - Lunch, rest
- 15:00 - **Xunliao Bay (寻梦湾)** - beach walk, check out Mozishi Park
- 18:00 - Sunset at bay, dinner
- 20:00 - Sleep
...
- 15:00 - **Lion Island (狮子岛)** optional hike if energy allows
- 17:00 - Return to Huidong, pack
- 19:00 - Dinner
- 20:30 - Sleep
...
## **4-Day Trip Itinerary** (Relaxed)

Add one more day to Day 2-3 split:

**Day 1:** Same as above

**Day 2:** Yanzhou Island full day

**Day 3:** Shuangyue Bay + Lion Island hiking + relax

**Day 4:** **Huizhou West Lake (惠州西湖)** in city center - half-day walk, then return home. Or stay another beach day and do Heidajiao (黑石滩) coastline photography.
...
1. **Train Booking:** Book at railway.12306.cn or use Anji Travel app (安吉出行)
2. **In Huidong:** Rent electric scooter (CNY 50-100/day) or hire local taxis (CNY 80-150/day for driver service)
3. **Beach Season:** Oct-May best (water cold but swimmable). Jun-Sep hot + typhoon risk
4. **Hotel Recommendation:** Stay in Huidong near Xunliao Bay; closer to islands and Shuangyue Bay
5. **Food:** Seafood-heavy; try oysters (生蚝), sea urchin (海胆), fish hotpot (鱼火锅)
6. **Skip Huizhou City:** Unless interested in West Lake or museum culture. Coastal Huidong is the draw.
...
This gives you coastal + city in one trip.

---

**References:**

- Guangzhou–Shanwei high-speed railway - Wikipedia
- Trip.com - Huizhou Coastal Guide
