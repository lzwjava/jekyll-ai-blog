...
lang: en
layout: post
title: Real Alternatives Beat Fake Calm
translated: false
type: note
---

Question: When negotiating salary or contracts, should the attitude be calm and detached — "it's fine if this doesn't work out, I have other options" — because looking eager makes you lose leverage? Is having (or pretending to have) alternatives the key?
...
- Slow response times on offers (not games — just genuinely not anxious).
- "Let me think about it" instead of instant yes.
- Anchoring high and going quiet. Silence after a number is the most underused move — whoever talks first after the anchor usually loses.
