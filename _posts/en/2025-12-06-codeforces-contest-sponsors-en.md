...
title: Codeforces Contest Sponsors
translated: false
type: note
---
...
- **Hudson River Trading (HRT)**: Event sponsor for CodeFest and similar gatherings.
- **Landeed**: Partner for programming festivals like CodeFest.
- **QuantInsti**: Sponsor for India-based contests like CodeFest.
- **Neapolis University Pafos**: Supports educational rounds (e.g., Educational Codeforces Round 185).
- **eolymp**: Provides technical support as an online judge partner for contests like OCPC.
- **Mathos**: Venue and logistics partner for camps like OCPC.
- **BigBag**: Technical partner for scoreboards in events like OCPC camps.
