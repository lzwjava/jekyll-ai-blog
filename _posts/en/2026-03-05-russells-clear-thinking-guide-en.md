...
lang: en
layout: post
title: Russells Guide to Clear Thinking
translated: false
type: note
---
...
The essay provides straightforward advice on avoiding dogmatic or foolish beliefs. In the 大学语文 textbook (and 自考 materials), it is typically presented in an abridged or selected form, focusing on key methods Russell suggests for overcoming bias, emotional reactions to opposing views, and overconfidence.

Here is the standard **English version** of the full short essay "How to Avoid Foolish Opinions" by Bertrand Russell (based on the commonly referenced and anthologized text):
...
(continues with examples of national and class biases)
...
The textbook version in 大学语文 (04729) usually highlights these main points:

- Observe directly when possible (avoid assuming knowledge).
- Notice anger at opposing views as a sign of weak grounds.
- Seek out diverse opinions from different social circles, nations, or classes.
- Imagine debating someone with opposite views or putting yourself in their position.
- Guard against self-centered pride and overconfidence in unprovable matters.
...
- [如何避免愚蠢的见识 (Chinese full text version)](https://hellowac.github.io/read/howtoavoid)
- Bertrand Russell's essays collections (e.g., *Mortals and Others* or public domain anthologies containing "How to Avoid Foolish Opinions")