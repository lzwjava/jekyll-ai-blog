...
lang: en
layout: post
title: Car-Office Summer Temperature Challenges
translated: false
type: note
---
...
1. **Phone with carrier that has basement coverage** — China Mobile often works better underground than China Unicom
2. **Move to the ramp area** (between ground and basement) — often has signal + some coolness
3. **Use WiFi calling** — but that needs… internet, so circular problem
4. **External antenna** — impractical for most
