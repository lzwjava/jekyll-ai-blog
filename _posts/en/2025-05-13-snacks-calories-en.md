...
- **Fiber**: Provides negligible calories (0–2 calories per gram, as it’s largely indigestible).
- **Water**: Provides 0 calories, reducing caloric density in foods like fruits.
...
- **Common snacks**:
  ...
  - **Chocolate chip cookies**: ~4.8–5.0 calories per gram (e.g., Chips Ahoy: 140 calories per 28g = 5.0 cal/g). Contains sugar, flour, and fat.
  - **Candy (hard candy)**: ~3.9–4.0 calories per gram (e.g., Jolly Rancher: 70 calories per 18g = 3.9 cal/g). Mostly sugar, similar to pure sugar.
  - **Nuts (e.g., almonds)**: ~5.7–6.0 calories per gram (e.g., 170 calories per 28g = 6.1 cal/g). High in healthy fats.
  - **Fresh fruit (e.g., apple)**: ~0.5 calories per gram (e.g., 95 calories per 182g = 0.52 cal/g). High water and fiber content lowers caloric density.
  - **Granola bars**: ~4.0–4.5 calories per gram (e.g., Nature Valley: 190 calories per 42g = 4.5 cal/g). Contains oats, sugar, and sometimes fat.
  - **Popcorn (air-popped)**: ~3.8 calories per gram (e.g., 31 calories per 8g = 3.9 cal/g). Lower if unbuttered; higher with oil or butter.
...
- **Snack servings**:
  ...
  - **Chocolate chip cookie (15g, 1 small cookie)**: ~70–80 calories. Higher due to fat and flour.
  - **Hard candy (18g, 3–4 pieces)**: ~70 calories. Comparable to sugar gram-for-gram but consumed in larger amounts.
  - **Almonds (28g, 1 oz)**: ~160–170 calories. High due to fat content.
  - **Apple (182g, 1 medium)**: ~95 calories. More calories due to larger serving, but less calorie-dense.
  - **Granola bar (21g, half a bar)**: ~90–100 calories. Higher due to mixed ingredients.
  - **Popcorn (8g, 1 cup air-popped)**: ~31 calories. Slightly higher than 5g sugar but less dense.
...
- **Snacks**:
  ...
  - **Nutrient-dense snacks** (e.g., nuts, fruit, yogurt): Provide healthy fats, protein, fiber, or vitamins, making them more beneficial despite higher calories.
  - **Low-calorie snacks** (e.g., air-popped popcorn, veggies): Offer fiber and nutrients with fewer calories than sugar in larger servings.
...
- **Scenario 2: Midday snack**:
  - 5g sugar (in a small piece of candy): 20 calories.
  - 1 oz potato chips (28g): 160 calories. Chips have ~8x more calories due to fat and larger serving.
- **Scenario 3: Healthy option**:
  - 5g sugar (from half an apple, ~50g): 20 calories (apple has ~10g sugar total).
