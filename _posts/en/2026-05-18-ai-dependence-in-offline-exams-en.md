...
lang: en
layout: post
title: AI Dependence in Offline Exams
translated: false
type: note
---

Question: For students born in 2012 who are now in middle school and heavily using AI (like Kimi, DeepSeek, Doubao in China; ChatGPT and Gemini globally) for homework — will they struggle in offline exams like the high school entrance exam (中考 in China)?
...
- **Practice "AI-free zones"** deliberately — timed writing, mental math, offline mock exams.
- **Use AI to check, not to generate** — draft first, then verify with AI.
- **Understand AI outputs** — don't copy; reconstruct in your own words.
- **Spaced repetition and active recall** — techniques that build the memory needed for closed-book exams.
- **Schools should redesign assessment** — move away from homework-only grades toward in-class, observable work.
...
- [RAND: Student Use of AI for Homework Rises](https://www.rand.org/news/press/2026/03/student-use-of-ai-for-homework-rises-as-concerns-grow.html)
- [SCMP: Chatbots for Children in China](https://www.scmp.com/news/china/science/article/3299860/chatbots-children-china-grapples-how-teach-use-and-ethics-ai-schools)
- [Gizmodo: China Shuts Off AI During Exams](https://gizmodo.com/china-takes-on-student-cheating-by-shutting-off-ai-nationwide-during-exams-2000613172)
- [Cryptopolitan: China Temporarily Shuts Down AI Tools](https://www.cryptopolitan.com/china-temporarily-shuts-down-ai-tools/)
- [LSE Impact: AI Competence or Dependence?](https://blogs.lse.ac.uk/impactofsocialsciences/2025/10/17/are-we-teaching-students-ai-competence-or-dependence/)
- [Frontiers in Education: Homework in the AI Era](https://www.frontiersin.org/journals/education/articles/10.3389/feduc.2025.1609518/full)
- [HEPI: Student Generative AI Survey 2026](https://www.hepi.ac.uk/reports/student-generative-ai-survey-2026/)
