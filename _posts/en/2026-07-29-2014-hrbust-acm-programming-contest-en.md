...
lang: en
layout: post
title: 2014 HRBUST ACM Programming Contest
translated: false
type: note
---
...
The event was organized by the university's teaching administration and the School of Computer Science and Technology. The contest took place on **March 29–30, 2014**. ([HRBUST Computer Science College][1])
...
([HRBUST Computer Science College][1])

The contest was also connected with the broader ACM culture: after the competition, a student from Beihang University, Dong Shi (董适), gave a contest summary and solution explanation. ([HRBUST Computer Science College][1])
...
The problem setters being from Beijing University of Aeronautics and Astronautics (Beihang) is significant. Beihang had one of China's strongest ACM teams. ([HRBUST Computer Science College][1])
...
* ([HRBUST Computer Science College][1])
* ([HRBUST Computer Science College][2])
