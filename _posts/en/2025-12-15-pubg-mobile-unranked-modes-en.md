...
title: PUBG Mobile Unranked Modes List
translated: false
type: note
---

**Question: How many modes are there in unranked in PUBG? What are they?**
...
- **Rage Gear Mode**: High-mobility, aggressive gear-focused mode.  
- **Payload Mode**: Objective-based mode with payloads to capture/defend (very popular in casual play).  
- **Team Deathmatch (TDM)**: Fast-paced 4v4 or squad deathmatches on maps like Warehouse, Hangar, Ruins (available in Unranked Arena tab).  
- **Infection Mode**: Zombie survival where players turn into infected.  
- **War Mode**: Conquest/domination-style with control points (e.g., Town map).  
- **Metro Royale**: Extraction shooter with looting and escaping (separate economy).  
...
- [Reddit Discussion on Modes](https://www.reddit.com/r/PUBGMobile/comments/14dcqbx/what_mode_do_you_play_the_most_excluding_basic/)