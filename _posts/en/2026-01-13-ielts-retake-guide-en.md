...
title: IELTS One Skill Retake Guide
translated: false
type: note
---
...
- **Process**:
  1. Take the full computer-based IELTS and receive your results.
  2. Log in to your test taker portal (on the British Council, IDP, or IELTS official site).
  3. If eligible, you will see an option to book One Skill Retake.
  4. Choose the one skill you want to retake, select a date within the 60-day window, pay the fee (usually lower than a full test; exact amount varies by country/center), and confirm.
  5. Take the retake (same format, timing, and difficulty level as the original section).
  6. Receive results in about 3–5 days.
