...
title: No 2 MOP Daily Plan Available
translated: false
type: note
---
...
China Telecom Macau (also known as CTM Macau in some contexts, but specifically the China Telecom branch) offers prepaid "Easy SIM" cards with daily unlimited local data plans charged automatically when data is used.

- *903# activates the **3 MOP/day** unlimited data plan.
- *1505# activates the **5 MOP/day** unlimited data plan (often with higher speed or fair usage policy differences).
...
- Contacting customer service by dialing 1000.

Plans can change over time, so the 2 MOP option may have been discontinued.
