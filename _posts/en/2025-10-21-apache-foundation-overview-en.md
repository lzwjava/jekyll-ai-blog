...
title: Apache Software Foundation Overview
translated: false
type: note
---
...
- Other highlights: Apache Arrow (in-memory data interchange), Apache ZooKeeper (coordination service), Apache Commons (reusable Java components), and Apache NetBeans (integrated development environment).
