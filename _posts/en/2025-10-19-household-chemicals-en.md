...
- **Ammonia (NH₃)**: A basic compound in glass cleaners and floor polishes; it cuts through grease and leaves streak-free shines. (Avoid mixing with bleach, as it produces toxic gas.)

- **Ethanol (C₂H₅OH, Alcohol)**: In hand sanitizers, mouthwashes, and alcoholic beverages; it acts as a solvent, antiseptic, and flavor enhancer.

- **Hydrochloric Acid (HCl, Muriatic Acid)**: Diluted in toilet bowl cleaners to dissolve mineral deposits and rust; it's a strong acid but handled carefully in low concentrations.

- **Acetone (C₃H₆O)**: The active solvent in nail polish remover; it dissolves resins and is also used in some paints and adhesives.

- **Phosphoric Acid (H₃PO₄)**: Added to sodas for tangy flavor and as a preservative; in cleaners, it tackles rust and lime scale.
