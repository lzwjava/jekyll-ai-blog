...
lang: en
layout: post
title: QuickTransfer Button Sequence for DJI Mini 3
translated: false
type: note
---

Question: How do I open QuickTransfer on the DJI Mini 3, and what is the specific button sequence to separate it from the normal power-on process?

Answer: To use QuickTransfer on the DJI Mini 3, you must use a specific sequence of button presses on the aircraft. Unlike the standard power-on procedure, entering this mode requires multiple quick taps.
...
It is easy to mix these up because they all use the same power button. Here is the breakdown:

| Action | Button Sequence | Indicator |
| :--- | :--- | :--- |
| **Power On / Off** | Press once, then press and hold (2s) | Green battery LEDs / Startup tone |
| **QuickTransfer Mode** | **Quickly press three times** (while on) | **Blinking Blue** status LEDs |
| **First-Time Linking** | Press and hold for 2 seconds (while on) | Beeping sound / Linking status |
