...
lang: en
layout: post
title: Definition of Network Throughput
translated: false
type: note
---

Question: What is the term for the amount of data passing through a network (or channel/interface) per unit time?

Answer: The answer is **吞吐量 (Throughput)**.
