...
lang: en
layout: post
title: Synthesized Picture and Next Moves
translated: false
type: note
---

Good — I've read all 12 notes you published today/yesterday. Here's the synthesized picture and the concrete next moves.
...
- Go to <https://scjgj.gz.gov.cn/ywt/> and do **名称自主申报** (name self-declaration)
- Prepare 3-5 backup names, pre-check them on the platform
- The 30-day lock gives you breathing room while bank exit formalities finish
- Key update from your research: single-natural-person entity no longer needs a supervisor (2024 Company Law) — wife-as-监事 dependency is gone
- Set registered capital at 100-200K CNY (not higher — actual pay-in required within 5 years now)
...
- Book bank account now (1-month lead time, banks picky with virtual addresses)
...
- **Pick and vet a TCSP-licensed agent** — verify their licence on the Companies Registry public search. Ask for year-2 pricing in writing before paying. Your notes flag that ¥4,380 is barely above cost — they make margin on annual renewal + audit.
- **Prepare your KYC narrative** for bank account (Airwallex/Statrys/ZA Bank first, traditional bank later with revenue history). Your 12-year GitHub + blog + App Store history is the credential — no degree needed, per your own research.
- **Budget:** ~8,600 CNY for first 2 years (setup + dormant audit), but once revenue flows expect ¥5,000-10,000/yr ongoing.
