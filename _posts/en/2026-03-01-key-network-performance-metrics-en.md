...
lang: en
layout: post
title: Key Network Performance Metrics
translated: false
type: note
---
...
When studying or working with computer networks, the most fundamental way to judge whether a network is "good" or "bad" is through a systematic set of **performance indicators** (性能指标体系).
