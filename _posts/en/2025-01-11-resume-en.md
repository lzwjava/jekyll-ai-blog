...
- **[lzwjava.github.io](https://github.com/lzwjava/lzwjava.github.io)** — Personal blog and knowledge base with ~400 original posts and ~8,000 AI answer notes built from daily LLM-assisted research; ~70,000 page views in the past month (Cloudflare Analytics), 38.9K visits, 930ms median load time, 82% good LCP. Content spans machine learning, system design, deep learning internals, GPU compute, Linux kernel, career philosophy, and startup lessons. Tech stack: **Jekyll, Markdown, GitHub Pages, Cloudflare Analytics, RSS, MathJax, night mode CSS**.
