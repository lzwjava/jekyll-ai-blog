...
lang: en
layout: post
title: Lian Po Tank Guide Essentials
translated: false
type: note
---
...
| Core 3 | Axe of Torment / Siege Breaker | True damage, anti-heal. |
| Late | Overlord’s Platemail / Frigid Charge | Armor stack, slow on hit. |
| Flex | Succubus Cloak / Red Lotus Cape | Magic resist or burn DoT. |

**Arcana (Runes)**: 10x Fate (HP/AD), 10x Harmony (HP/CDR), 10x Vacuity (HP/energy). For Clash Lane damage: Mutation/Eagle Eye/Hidden.
...
- Weak vs.: Burst assassins if no items; position carefully pre-stacks.
