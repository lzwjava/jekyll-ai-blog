...
title: Zhang Wensong China Open Source Pioneer
translated: false
type: note
---

Question: Provide a comprehensive introduction to 章文嵩, an open source advocate in China.
...
- ~2009–2016: Joined Alibaba Group → became Senior Researcher, responsible for core infrastructure of Taobao/Alibaba; later Vice President and **CTO of Alibaba Cloud**.
  - Played key roles in building Alibaba's massive distributed systems, CDN, TFS (Taobao File System), and performance optimizations that supported events like Singles' Day (Double 11).
- 2016–~2021: Joined DiDi Chuxing (Didi) as Senior Vice President, responsible for basic platform, intelligent transportation, DiDi Cloud, and chaired the DiDi Technical Committee.
- After DiDi: Served as Operating Partner at Hillhouse Capital (高瓴资本); involved in cloud-native startup incubation and investment.
...
- Key leadership roles in the China Computer Federation (**CCF**):
  - CCF Fellow (CCF会士)
  - Major initiator of CCF Open Source Development Committee
  - Chair/Past Chair of CCF Technical Frontier (TF) Committee
- Awards:
  - First CCF Outstanding Engineer Award (杰出工程师奖)
  - CCF Outstanding Contribution to Open Source Award
  - China Open Source Leader
  - CCF Outstanding Service Award (2025)
- Has continuously promoted open source culture in Chinese tech companies, from individual contributions in the 1990s–2000s to corporate-led open source after 2010 (especially at Alibaba).
