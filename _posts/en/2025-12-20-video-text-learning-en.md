...
title: Balancing Video and Text Learning
translated: false
type: note
---
...
- **Videos (e.g., YouTube animations, lectures):**
  ...
  - Easier to grasp abstract or sequential concepts the first time.
  - Engaging and helps maintain attention for difficult topics.

- **Text (articles, books, AI chatbot explanations, documentation):**
  - More precise and detailed.
  - Easy to pause, highlight, re-read specific parts, and search within the content.
  - Closer to real exam formats (most certification exams are text-based).
  - Better for deep reference, comparing options, and building precise mental models.
