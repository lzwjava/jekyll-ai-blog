...
- **Where to buy**: Through insurers like PICC, Ping An, or via apps like those from Alipay/WeChat. Premiums are based on your car model, driving history, and city—expect 500–2,000 RMB/year for basic third-party, scaling up with higher limits.
...
- **1 Million RMB**:
  - Pros: Cheaper premium (maybe 20–50% less than higher levels). Covers most everyday accidents (e.g., minor fender-benders or mid-range cars).
  - Cons: In a big city, it's risky. If you hit a luxury SUV (e.g., a Range Rover worth 1.5M+), you'll still owe a lot. Average car prices in cities like Shanghai are rising, and claims for high-end vehicles often top 1M quickly (tires, paint, sensors add up).
  - Best for: Rural areas or budget drivers with low exposure to luxury traffic.

- **2 Million RMB**:
  - Pros: Good middle ground—covers most urban accidents, including many luxury cars. Premium is reasonable (often just 100–300 RMB more than 1M).
  - Cons: Still might not fully protect against top-tier collisions (e.g., a Porsche or Tesla Model X). In dense city traffic, the risk of hitting something pricey is higher.
  - Best for: Medium-sized cities or if you're on a moderate budget.

- **3 Million RMB** (or even 5M, which is common now)**:
  - Pros: Excellent peace of mind in big cities. It would cover damages to most vehicles on the road, including exotics. Chinese insurers often offer this level, and it's becoming standard for urban drivers. Your father is right—compensation claims in places like Beijing can hit 2–3M easily for repairs, medical bills, or totaled cars. Higher limits also sometimes give discounts on premiums or faster claims processing.
  - Cons: Slightly higher cost (maybe 20–50% more than 1M, depending on your insurer). But the premium difference is tiny compared to potential out-of-pocket costs.
...
- **Legal note**: Always carry proof of insurance. In China, traffic police check this strictly.
- **Consult pros**: This isn't financial advice—talk to an insurance agent or use online calculators. Rules can vary by province (e.g., stricter in Beijing).

If you share more details like your city, car type, or budget, I can refine this further. Safe driving!
