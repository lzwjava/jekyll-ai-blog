...
title: Understanding IEPL Dedicated Network Services
translated: false
type: note
---
...
- **Scalable speeds** — Typically from 2 Mbps up to 10 Gbps or more.
- **Transparent Ethernet** — Operates at Layer 2, allowing direct Ethernet framing without router conversion (unlike older technologies).
