...
title: Famous ESTP Entrepreneurs and Engineers
translated: false
type: note
---

Question: Who are some famous entrepreneurs and engineers with the ESTP personality type (Myers-Briggs)?

Answer:

ESTPs (Extraverted, Sensing, Thinking, Perceiving) are often called “The Entrepreneur” or “The Dynamo” in MBTI typology. They tend to be action-oriented, pragmatic, bold risk-takers, excellent in crises, and natural salespeople or deal-makers, which explains why the type is heavily represented among successful entrepreneurs and some hands-on engineers/inventors.
...
- **James Dyson** – Inventor and founder of Dyson (vacuum cleaners, fans, etc.; typed ESTP)
- **Tony Robbins** – Peak-performance coach and entrepreneur (self-identified ESTP in some sources)
- **Kevin O’Leary** (“Mr. Wonderful” on Shark Tank) – Strongly typed ESTP
- **Daymond John** (FUBU founder, Shark Tank) – Frequently typed ESTP
