...
lang: en
layout: post
title: Pragmatic AI Business Path
translated: false
type: note
---
...
1. Start an AI consulting or AI software outsourcing business.
2. Offer services such as:

   * LLM deployment
   * Model training/fine-tuning
   * Agent development
   * AI integration for companies
3. Register a company and work with partners.
4. Look for projects in the Guangdong–Hong Kong–Macao Greater Bay Area.
5. Spend time in Hong Kong and network with higher-end clients and founders.
6. Build relationships first, then see what opportunities appear.
7. Eventually transition from a service company into a product company if you discover a real market need.
