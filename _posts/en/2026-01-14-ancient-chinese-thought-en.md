...
title: Foundations of Ancient Chinese Thought
translated: false
type: note
---
...
- **Ren** (仁, benevolence/humaneness): The highest virtue, involving empathy, kindness, and treating others as one wishes to be treated (the "Golden Rule" appears in forms like "Do not impose on others what you do not desire").
- **Li** (礼, ritual propriety): Proper conduct, rites, and social roles that maintain order.
- **Xiao** (孝, filial piety): Respect for parents and elders as the root of morality.
- The **junzi** (君子, exemplary person/gentleman): One who cultivates virtue through learning and moral example, not birth.
...
- Compassion (leading to benevolence/*ren*),
- Shame (leading to righteousness/*yi*),
- Deference (leading to propriety/*li*),
- Approval/disapproval (leading to wisdom/*zhi*).
...
- The butterfly dream (questioning reality vs. illusion),
- The "useless" gnarled tree (surviving by lacking utility),
- Debates with logicians like Hui Shi on relativism.
...
- Basic Annals (imperial reigns),
- Tables (chronologies),
- Treatises (institutions like rites, astronomy),
- Hereditary Houses (feudal states),
- Biographies (exemplary individuals).
