...
lang: en
layout: post
title: Haier Mite Removal Wash Explained
translated: false
type: note
---
...
- **Method**:
  ...
  - Some models use steam (蒸汽除螨) for deeper penetration into fibers without excessive water.
  - Special water flow patterns (e.g., strong agitation or pulsing) to dislodge mites and their waste from deep in fabrics.
  - Extra rinses to flush out dead mites, allergens, and residues.
- **Effectiveness**: Haier often claims high removal rates (e.g., 98–99.9% mite removal in tested models), certified in some cases for dust mite allergens.
- **Cycle Time**: Longer than standard washes (often 1–2 hours) due to heating and extended soak/wash phases.
- **Suitable For**:
  - Bedding (sheets, pillowcases, duvets)
  - Towels, bathrobes
  - Baby clothes, plush toys (if machine-washable)
  - Underwear, socks
  - Items used by allergy sufferers
...
- Run **筒清洁** (drum clean) regularly to keep the machine hygienic.
- In wash-dryer combos, some have steam mite removal during dry phase.

If your model has **蒸汽除螨** (steam mite removal) as a variant or add-on, it's even gentler (uses steam for refresh without full hot wash) and great for quick allergen reduction on lightly soiled items.
