...
- **If No Devices Are Connected**: The Personal Hotspot will automatically turn off after about 90 seconds of no connections. This is a battery-saving feature to prevent unnecessary data and power usage when nothing is using the hotspot.[3][4]
...
- **Set Auto-Lock to "Never"**: Go to Settings > Display & Brightness > Auto-Lock > Never. This keeps the iPhone "awake" longer, helping the hotspot stay active even during low activity periods (though it drains battery faster—plug in if possible).[2][7]
