...
title: CMB Cross-Border Banking Services
translated: false
type: note
---

### Cross-Border Services: CMB Wing Lung Bank (HK) to China Merchants Bank (Mainland China)
...
- **Two-way Integration**: Easy HKD/USD transfers via CMB Wing Lung's link to parent CMB.
- **Limits**: Daily up to HKD 500,000 equivalent; higher for Premier/Private Banking.
- **Alternatives**: Alipay/WeChat for P2P (free/fast, but trust recipient); avoid if corporate.
...
- [CMB Group Overview](https://english.cmbchina.com/)
