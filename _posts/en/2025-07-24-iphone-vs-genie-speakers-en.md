...
1. **Pair via Bluetooth**
   *On the Tmall Genie*: 长按顶部按钮 → 蓝牙配对模式
   *On the iPhone*: Settings › Bluetooth › select “TMall Genie‑XXXX.”
2. **Set levels**
...
* **Angle it upward** using a small stand so tweeters fire toward your ears.
* **Use the iOS EQ**: Settings › Music › EQ › “Late Night” to tame the loudest peaks at low volume.
* **Lower brightness & activate Focus** so the phone doesn’t light up or buzz while you relax.
...
* **Everyday background listening** → pair the iPhone to the Tmall Genie; let the speaker sit across the room.
* **Critical listening or a podcast before sleep** → keep it on the iPhone at low volume with EQ tweaks.
* If you often notice muddiness or lack of bass from the Genie and you care about sound, consider a small dedicated speaker like a HomePod mini or Sonos Era 100 down the road.
