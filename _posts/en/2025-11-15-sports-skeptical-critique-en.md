...
title: "Sports: A Skeptical Personal Critique"
translated: false
type: note
---
...
- **Sports as Manipulation and Harm**: The author views organized sports not as benign recreation but as a system of control, akin to ideology or religion. Institutions like FIFA (soccer's governing body) or the ITTF (table tennis) are portrayed as puppeteers, using emotional appeals (e.g., patriotism, heroism) to encourage overexertion. This leads to injuries and burnout, which the author knows firsthand. It's a critique of how sports commodify the body, turning play into a high-stakes battleground.

- **Historical Drift Toward Toxicity**: Modern sports, per the author, have "devolved" from simple fun into obsessive pursuits fueled by ego. Terms like "noble sports" (e.g., tennis or golf as status symbols) are called out as vanity traps, fostering rivalry over well-being. This echoes broader cultural critiques, like those in sociology (e.g., how capitalism turns leisure into competition).

- **A Liberated Mindset**: The proposed antidote is radical detachment—treat sports like casual games, stripped of ties to identity, achievement, or nationalism. The closing line flips the script on elitism: True "nobility" isn't excelling at sports but transcending them entirely, observing the fray from a place of indifference. It's almost aristocratic in its disdain for the masses' fervor, but rooted in anti-authoritarianism and self-preservation.
...
For context, this seems to originate from a Weibo post: [Original Weibo Post](https://weibo.com/6347862377/QbZpybAaD).
