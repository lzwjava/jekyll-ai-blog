...
lang: en
layout: post
title: Success Over Users Kills Startups
translated: false
type: note
---
...
1. **Start with user research**: Conduct interviews, surveys, and observation to deeply understand user needs before building.
2. **Adopt a "problem-first" approach**: Validate that a meaningful problem exists before designing a solution.
3. **Measure what matters**: Track leading indicators of value delivery (e.g., Net Promoter Score, retention, task completion rate) over vanity metrics.
4. **Build feedback loops**: Integrate continuous user testing and iteration into your development cycle.
5. **Align team incentives**: Ensure OKRs and rewards are tied to user outcomes, not just growth or funding milestones.
6. **Practice humble leadership**: Regularly ask, "Are we serving users, or are we serving our ego?"
...
- [Paul Graham: Startups = Growth](http://www.paulgraham.com/growth.html)
- [Harvard Business Review: Why Startups Fail](https://hbr.org/2020/09/why-startups-fail)
