...
- **How to set it up**:
  ...
  4. Set the time (e.g., 10 minutes from now if you want a "countdown" feel), choose a sound/vibration, and label it if you want (like "Break Reminder").
  5. Hit **Save**. It'll chime discreetly without taking over your screen.
...
- **Third-Party Apps** (if you want more customization):
  - **Focus Booster** or **Brain Focus**: These are Pomodoro-style apps that run timers in-app only, without spilling over to the status bar. They're great for productivity without distractions.
  - **Alarm Clock for Me** or **Sleep Cycle**: These handle alarms and gentle wake-ups without aggressive on-screen displays.
  - Search the App Store for "non-intrusive timer" to find options that respect your screen space.

If you're on iOS 17 or later, the Dynamic Island makes the timer even more prominent, so switching to alarms is probably your best bet for a calmer experience. If this doesn't quite solve it or you have more details (like what you're timing), let me know—I can suggest more tailored tweaks!
