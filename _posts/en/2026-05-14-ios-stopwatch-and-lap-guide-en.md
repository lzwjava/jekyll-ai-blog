...
lang: en
layout: post
title: iOS Stopwatch and Lap Guide
translated: false
type: note
---
...
1. **Via the Clock app** — Open the **Clock** app from your Home Screen, then tap the **Stopwatch** tab at the bottom.
2. **Via Control Center** — You can add a Stopwatch shortcut to Control Center by going to **Settings → Control Center** and adding the Stopwatch button. This lets you access it quickly with a swipe from any screen.
...
- [Apple Support – Track time with the stopwatch](https://support.apple.com/guide/iphone/use-the-stopwatch-iph96b1e460/ios)
- [iMore – How to use the Stopwatch on iPhone and iPad](https://www.imore.com/how-use-stopwatch-iphone-and-ipad)
- [iPhone Life – How to Use the iPhone's Stopwatch](https://www.iphonelife.com/content/how-to-use-iphones-stopwatch)
- [Apple Support – Stopwatch on Apple Watch](https://support.apple.com/guide/watch/stopwatch-apd0d5883fca/watchos)
