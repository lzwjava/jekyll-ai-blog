...
- **Commodore 16 and Plus/4 (1984)**: Aimed at the low-end market, these models were less successful due to limited software compatibility and competition from the C64.
- **Amiga Series (1985–1990s)**: Acquired through Commodore’s purchase of Amiga Corporation in 1984, the Amiga line (starting with the Amiga 1000) was revolutionary for its advanced graphics, multitasking operating system, and multimedia capabilities. Popular in video production, gaming, and creative industries, the Amiga 500 (1987) became a commercial hit, especially in Europe. However, mismanagement and lack of marketing hindered its competition against PCs and Apple’s Macintosh.
- **Commodore 128 (1985)**: A more advanced successor to the C64, it offered backward compatibility and improved specifications but didn’t replicate the C64’s success.
...
- **1954**: Founded by Jack Tramiel as a typewriter repair business.
- **1962**: Goes public as Commodore Business Machines, Inc.
- **1976**: Acquires MOS Technology, gaining the 6502 microprocessor.
- **1977**: Launches the PET, one of the first personal computers.
- **1981**: Releases the VIC-20, the first computer to sell over a million units.
- **1982**: Introduces the Commodore 64, the best-selling personal computer ever.
- **1984**: Acquires Amiga Corporation; Tramiel leaves the company.
- **1985**: Launches the Amiga 1000, a multimedia powerhouse.
- **1994**: Files for bankruptcy, ending operations.
