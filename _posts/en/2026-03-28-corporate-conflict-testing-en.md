...
lang: en
layout: post
title: Resolving Corporate Conflict Through Evidence-Based Testing
translated: false
type: note
---

Question:
Is one effective way to resolve conflicts in large corporations to let both sides try each other's approaches (A vs. B), so that after implementation the differences become clear and arguments decrease?
