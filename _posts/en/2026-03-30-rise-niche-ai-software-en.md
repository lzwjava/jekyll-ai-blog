...
lang: en
layout: post
title: The Rise of Niche AI Software
translated: false
type: note
---
...
1. **Software monoculture ends** — instead of everyone using the same 5 tools, people use hundreds of specialized ones
2. **The creator is also the primary user** — highest possible product-market fit
3. **Maintenance becomes sustainable** — AI helps one person maintain what used to need a team
4. **New economy emerges** — "indie software" like indie music, with small dedicated audiences
5. **Enterprise software gets disrupted** — why use Salesforce when your sales team can have a CRM built exactly for them in a week?
