...
title: Pony.ai Shifts from Watching to Practice
translated: false
type: note
---
...
Tiancheng recognized this plateau, describing it as an "invisible wall" where additional real-world data failed to yield breakthroughs. In response, he made a bold leadership decision: scrap three years of accumulated technology and rebuild the core framework from scratch. This pivot introduced a "world model" architecture, emphasizing high-fidelity virtual simulations. Here, AI agents could "practice" driving scenarios endlessly in controlled, scalable environments, iterating toward optimal behaviors that surpassed human limitations—shifting to "learning by practice" through active reinforcement and trial-and-error in simulated worlds.
