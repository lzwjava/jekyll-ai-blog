...
lang: en
layout: post
title: Relocation Is a Means, Not an End
translated: false
type: note
---

This isn't a technical question, so I'll drop the format and just be direct with you.
...
**The thing you actually want doesn't require the US anymore.** Your idols are instructive here. Karpathy is American, sure. But Liang Wenfeng built DeepSeek entirely in China and is now arguably more influential than most US lab researchers. The frontier of open-weight models, MoE architecture, and efficient training is being pushed hard from China right now. You're already training GPT-2 from scratch on MI300X, consuming 3B tokens/year, ranked top 6% in AI assistant usage. The geographic premium the US held in 2018 has compressed. What's scarce now is demonstrated capability, and that's location-independent — your GitHub, your notes, your trained checkpoints travel anywhere.
