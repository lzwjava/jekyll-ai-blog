...
title: Guangzhou IELTS Test Registration Guide
translated: false
type: note
---
...
2. **Register Online**:
   - **Via British Council/NEEA (traditional route)**: Create an account on the official China IELTS website at [www.chinaielts.org](http://www.chinaielts.org). You'll need a valid ID (passport or Chinese ID card). Select Guangzhou as your test city.
   - **Via IDP (new option since November 2024)**: Register directly on [ielts.idpchina.cn](https://ielts.idpchina.cn/) or the global IDP site. This offers easier payment and one free reschedule.
   - Registration opens about 2-3 months in advance. Check real-time availability for dates.

3. **Pay the Fee**: The standard fee is RMB 2,170 (about USD 300) for both paper and computer formats. Pay online via credit card, Alipay, or WeChat Pay at least 7 days before the test. Fees are non-refundable but transferable in some cases.

4. **Select Test Center and Date**: Choose from available centers in Guangzhou. Book early as seats fill quickly. You'll receive a confirmation email with details.

5. **Prepare Documents**: Bring your original ID (passport recommended for internationals) on test day. No tourist visa is needed if you're a resident; tourists can apply freely.
...
- **Visa/Eligibility**: Open to all; no residency required. For UKVI, specify during registration.
...
- [IELTS Test Centers in Guangzhou](https://www.bestmytest.com/ielts/test-centre/china/guangzhou)
- [Global Exam Guide for China](https://global-exam.com/blog/en/where-to-take-the-ielts-in-china/)
