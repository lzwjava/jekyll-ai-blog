...
title: Fotile In-Sink Dishwasher Features
translated: false
type: note
---
...
- **3-in-1 or 2-in-1 In-Sink Dishwasher**: Combines dishwashing, fruit/vegetable cleaning, and sterilization in one unit. Uses HydroJet technology for high-pressure water jets (up to 167°F for sanitization), eliminating 99.99% of bacteria. Features include:
  ...
  - Hot air drying and up to 96-hour storage to keep items fresh.
  - Quiet operation and compact design for apartments or condos.
- Models like SD1F-S1 (top-load, 4-place settings) or BD2B-G2-Y (with moonshadow grey finish).
