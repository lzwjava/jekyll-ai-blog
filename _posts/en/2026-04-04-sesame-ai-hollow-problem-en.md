...
lang: en
layout: post
title: Sesame AI Popularity and Hollow Problem
translated: false
type: note
---

Question: How is Sesame AI doing? Do a lot of people use it?
...
- **Sessions are only 15 minutes long** per interaction
- No persistent cross-session memory unless accessed from the same browser (tracked via cookies, not login)
- No internet access or real-world tool integration yet
- English-only (multilingual support in progress)
...
- [Sequoia Capital — Partnering with Sesame](https://sequoiacap.com/article/partnering-with-sesame-a-new-era-for-voice/)
- [TechCrunch — Sesame raises $250M, launches beta](https://techcrunch.com/2025/10/21/sesame-the-conversational-ai-startup-from-oculus-founders-raises-250m-and-launches-beta/)
- [ZDNET — Talking with Sesame is amazing and creepy](https://www.zdnet.com/article/talking-with-sesames-ai-voice-companion-is-amazing-and-creepy-see-for-yourself/)
- [Sesame Research — Crossing the Uncanny Valley](https://www.sesame.com/research/crossing_the_uncanny_valley_of_voice)
- [AiSuperSmart — 3 Hours with Sesame AI](https://www.aisupersmart.com/i-talked-to-sesame-ai-for-3-hours-heres-how-to-use-the-scary-real-voice-tool/)
