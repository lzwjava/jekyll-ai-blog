...
lang: en
layout: post
title: Deposit Refund Scam for Lockers
translated: false
type: note
---

Based on user complaints on consumer platforms, the "算界智电" WeChat miniprogram is used to operate shared storage lockers. The overall user feedback is very poor, with the primary issues being the refusal to refund deposits and hidden fees.

Here is a summary of what it does and the main problems users are reporting:
...
- **Poor customer service**: Users state that when they try to call the customer service number to resolve the deposit issue, no one answers the phone .

**Summary:** The "算界智电" miniprogram is for renting shared lockers, but it has a very poor reputation due to widespread reports of stolen deposits, hidden fees, and unresponsive customer support.
