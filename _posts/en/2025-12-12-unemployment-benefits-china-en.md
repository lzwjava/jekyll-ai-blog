...
title: Claiming Unemployment Benefits in China
translated: false
type: note
---
...
- Not receive other social benefits like retirement pensions.
...
3. **Submit Application and Documents**:
   - ID card or passport (for foreigners).
   - Termination proof.
   - Social insurance payment records (check via app or website).
   - Bank account details for direct deposits.
   - Photos (sometimes required).

4. **Approval and Job-Seeking**: Expect review in 1–2 weeks. Once approved, attend required job activities. Payments are monthly via bank transfer.

5. **Online Options**: Use national platforms like the "12333" social insurance app/website (*si.12333.gov.cn*) or city-specific apps (e.g., WeChat/Alipay mini-programs). Some cities allow "entitlement without application" via auto-matching.
...
| **Application Locations** | - Offline: District social insurance centers or community service centers.<br>- Online: Guangdong "Shuiyunban" app, WeChat/Alipay, or *si.12333.gov.cn*.<br>- Hotline: 12333. | - Offline: District labor bureaus or street-level employment offices.<br>- Online: Beijing "Beiwangtong" app, WeChat/Alipay, or *si.12333.gov.cn*.<br>- Hotline: 12333. |
...
- **For Expats**: Refunds of personal contributions possible upon leaving China, but only for pension/unemployment portions.
