...
lang: en
layout: post
title: Search Keywords for Stereo Microscope
translated: false
type: note
---

**Question:** What keyword should I search on JD.com (京东) to find a stereo microscope suitable for electronics/GPU repair?
...
| `电路板维修显微镜` | PCB repair microscope |
...
- Brand suggestions to filter by: **凤凰 (Phoenix)**, **麦克奥迪 (Motic)**, **明美**, or **ZEISS 仿款**

The single best keyword to start with is:

> **`体视显微镜 维修`**

That will show you stereo microscopes marketed specifically for repair use, at the right price range for hobbyists.
