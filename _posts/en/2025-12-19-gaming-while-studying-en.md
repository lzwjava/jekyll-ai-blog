...
title: Gaming and Studying Simultaneously
translated: false
type: note
---
...
- **Utilizing dead time effectively**: Many mobile games (e.g., PUBG Mobile, Clash of Clans, or idle games) have built-in waiting periods—lobby times, matchmaking, energy regeneration, or hiding/waiting for enemies. During these low-attention moments, you can switch to quick study activities like:
  ...
  - Watching bite-sized educational videos
  - Doing simple quizzes
  This turns otherwise wasted time into productive micro-study sessions without fully interrupting the game.

- **Motivation through reward association**: The game acts as a "reward" or distraction. Knowing you can return to the game soon can make boring study material feel more tolerable during short bursts. This is similar to the Pomodoro technique, where short work sessions are followed by breaks—in this case, the game break motivates the study sprint.
...
- **Risk of reduced performance in both**: Studies on media multitasking show lower academic performance and worse game results when attention is split. You might miss enemies in-game or misunderstand study concepts.

- **Better alternatives exist**:
  - Dedicated short study sessions (e.g., 10–15 minutes) followed by gaming as a reward.
  - Apps designed for micro-learning during waits (language apps like Duolingo are gamified themselves).
...
- [Research on task-switching costs](https://pubmed.ncbi.nlm.nih.gov/16923726/)
