...
title: B.O.W M190U Pro Mouse Review
translated: false
type: note
---
...
1. **Ergonomic Vertical Design**

   * The M190U Pro is a vertical mouse, which helps keep your wrist in a more natural posture and can reduce wrist strain over long periods. ([MyFone][1])
   * It has a detachable magnetic palm rest, which is pretty thoughtful — you can remove or reattach it depending on comfort. ([MyFone][1])

2. **Multiple DPI Settings**

   * It supports 4 DPI levels: 800, 1200, 2400, and 3200. ([MyFone][1])
...
3. **Silent / Quiet Buttons**

   * The buttons are designed to be relatively quiet, which is a plus for office or shared environments where clicking noise matters. ([Senao Online][2])
   * No need for software to configure — it’s plug-and-play. ([Senao Online][2])

4. **Affordable**

   * Very budget-friendly. For instance, at some points it's been sold for ~49.9 元（人民幣） in JD. ([ZOL DIY][3])
...
1. **Limited Side Buttons / Features**

   * It doesn’t emphasize a lot of extra buttons — it's more “business / office” than “gaming with macro buttons.”
   * According to the PChome spec, side buttons might not be fully supported in all systems (e.g., on Mac the side button might not work). ([PChome 24h][4])
...
3. **Warranty**
   ...
   * According to the seller page, the warranty is only 6 months for non-user-damage issues. ([MyFone][1])
...
5. **Not Wireless (for Pro version)**

   * This Pro version is wired via USB-A, so if you prefer a wireless setup, this isn’t it. ([MyFone][1])
   * Cable length is moderate: listed as 1.5 m. ([MyFone][1])
