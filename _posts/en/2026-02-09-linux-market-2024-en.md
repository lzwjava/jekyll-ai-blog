...
title: Linux Market Share and Top Distros
translated: false
type: note
---
...
- **Windows**: ~67.7%
- **Unknown** (often includes some Linux variants or unclassified): ~15.26%
- **OS X** (older macOS versions): ~7.03%
- **macOS** (newer versions): ~4.76%
- **Linux**: **4.02%**
- **Chrome OS**: ~1.23%
...
- Some reports (e.g., from late 2025) cite Linux desktop share around **4.1% to 4.7%** globally in 2025, with growth driven by Windows 10 end-of-life and better hardware support.
- In specific regions like the **United States**, Linux crossed **5%** in mid-2025 (e.g., ~5.03% in June 2025 per some trackers), but global averages remain lower.
- Gaming-focused metric: **Steam Hardware Survey** (January 2026) shows Linux at **3.38%** among Steam users (a subset of desktop users, skewed toward gamers; it peaked at ~3.58% in late 2025).
