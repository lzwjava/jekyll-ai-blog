...
lang: en
layout: post
title: iPhone Time-Lapse for Daylight Changes
translated: false
type: note
---

**Question:**
How can I create long-exposure or time-lapse style videos on an iPhone to capture daylight changes over time, like placing a camera by a window?
...
1. Open Camera → swipe to **Time-Lapse**
2. Put your phone on a **stable tripod**
3. Plug into power (critical for long recording)
4. Tap record and leave it for hours
...
1. Take a **Live Photo**
2. Open it in Photos
3. Swipe up → choose **Long Exposure**
...
But still:
👉 They don’t truly record continuous long-exposure video for hours
👉 They are better for artistic short clips
