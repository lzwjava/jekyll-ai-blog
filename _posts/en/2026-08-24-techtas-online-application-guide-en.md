...
lang: en
layout: post
title: TechTAS Online Application Guide
translated: false
type: note
---

**Question:** What is the Technology Talent Admission Scheme (TechTAS) and how does the online application work?
...
For the applicant: valid travel document, recent photo, proof of academic qualifications or technical skills, and relevant supporting documents depending on nationality (Mainland, Macao, Taiwan, or overseas).

For the employing company: a quota allotment letter issued by the Innovation and Technology Commission, company chop, employment contract or letter of appointment with details on post, salary, benefits and period, and Business Registration Certificate.

**Payment:**
There is no application fee for quota applications. Visa application fees are paid online by credit card (VISA, Mastercard, UnionPay, JCB), PPS, FPS, or Mainland e-wallets (Alipay, WeChat Pay, UnionPay App). The fee is non-refundable regardless of the result.
