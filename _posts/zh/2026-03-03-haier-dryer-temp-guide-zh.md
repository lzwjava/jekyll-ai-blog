...
- **L-1** = Low temperature（加热选项中最凉爽/最低的加热级别，适合羊毛、丝绸或合成纤维等娇嫩面料，以防止损坏）。
- **L-2** = Medium temperature（日常物品的平衡中档设置）。
- **L-3** = High temperature（这些选项中最热的级别，最适合棉质、毛巾或重负荷等耐用面料，能够承受更多热量以实现更快或更彻底的干燥）。
- **COOL** = 无加热 / 仅凉风（使用室温空气翻滚，用于蓬松空气、刷新、防皱或无需任何加热的娇嫩物品）。

是的，**L-3 是 L- 系列加热设置中最热的**（数字越高 = 热量越高）。这些设置在 Haier heat pump dryer 型号中很常见，该系统整体热量水平低于传统排气式干衣机以提高能效，但 L-3 仍提供该系统中最强的加热。
...
- [JustAnswer expert explanation on Haier heat pump dryer settings](https://www.justanswer.co.uk/hvac/njjuv-l1-temp-settings-please-heat-pump-dryer-don-t.html)