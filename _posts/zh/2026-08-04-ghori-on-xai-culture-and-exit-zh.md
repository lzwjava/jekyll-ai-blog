...
lang: zh
layout: post
title: Ghori谈xAI文化与离职
translated: true
type: note
---

问题：Ghori还分享了哪些关于xAI/Grok的其他细节，是我尚未涵盖的？

回答：我提取了完整的StartupHub文章和Grokipedia的个人简介以获取更多具体信息。

**关于自主性/文化的直接引述**  
他第一天的原话是："我的第一天，他们只给了我一台笔记本电脑和一张工牌。我就想，好吧，现在呢？我连团队都没有，也没人告诉我该做什么。"至于他最喜欢什么："没人对我说不。如果我有好主意，通常当天就能实施并展示给Elon或其他人，然后得到反馈。"

**"每笔提交250万美元"的说法**  
Ghori调侃式地量化了他团队近期的贡献："我们刚刚算了一下，目前主仓库的每次代码提交大约值250万美元。我今天做了五次提交。"——这是他用来具象化"每小时=巨大价值"文化的方式。

**对软件限制的第一性原理观点**  
他认为软件中许多公认的限制（尤其是延迟和速度）"并非事实"——他说现有行业堆栈中有"大量愚蠢的东西"，剔除后几乎任何场景都能获得2到8倍的速度提升。在他看来，通向AGI的真正瓶颈不是软件复杂性，而是能量和硬件可用性的物理制约。

**特斯拉算力的逻辑，以真实引述呈现**  
他将挑战描述为："我们需要100万个人类模拟器。我们需要100万台计算机。怎么做？"并指出特斯拉车载计算机"在资本效率上远高于"云虚拟机或直接购买英伟达芯片。
...
- 趣闻：他在自己后院设计并制造了一台液体燃料火箭发动机，在一次点火测试中自己烧着了。
