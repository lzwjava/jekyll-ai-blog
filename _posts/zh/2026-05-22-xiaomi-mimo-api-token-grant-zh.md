...
- 您已被选中（可能基于API使用情况或早期注册）获得免费Token赠额  
- 登录 [platform.mimo.ai](https://platform.mimo.ai) 或小米MiMo API控制台  
- 查看 **控制台 → 充值详情**，查找标记为“Bonus Token Plan”或“Bonus Credits”的记录  
- **存在有效期**——请在过期前使用积分  
