...
- **Fermat's Last Theorem**：他最著名的断言，写在 Diophantus 的 *Arithmetica* 一书的页边空白处，声称方程 $x^n + y^n = z^n$ 对于 $n > 2$ 没有正整数解。这一断言的真实性由 Princeton University 的英国数学家 Andrew Wiles 证明，他的证明最终于1994年11月被接受——比 Fermat 的原始断言晚了300多年。

- **Fermat's Little Theorem**：断言如果 $p$ 是素数且 $a$ 是任何不被 $p$ 整除的整数，则 $a^{p-1} \equiv 1 \pmod{p}$。这一定理的严格证明最早由 Leonhard Euler 于1736年完成。

- **Fermat Numbers**：定义为 $F_n = 2^{2^n} + 1$。已知仅有前5个 Fermat numbers 是素数。

- **Fermat's Factorization Method**：一种基于将复合数表示为两个平方差的因式分解技术。

- 他还研究了完美数、Pell's equation，以及他称为“友好整数”（amicable numbers）的数。
