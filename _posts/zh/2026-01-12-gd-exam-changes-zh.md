...
**备注：**
1. 只有在原计划表中已取得合格或免考的课程方可顶替新计划课程；不允许反向顶替。
2. 对于 1 门对应课程和 1 门完考课程，只能选择一种顶替方式，不得重复使用。
3. 对应顶替课程，原计划表中同行的 1 门课程顶替 1 门新计划课程；其他课程不得顶替。
4. 选择考顶替课程，原计划表中的任何 1 门课程均可顶替新计划中的任何 1 门课程。
5. 原计划中的“计算机及应用课程实验（二）”课程包含多个笔试实践考试学分，按课程顶替方式与对应的笔试课程学分合并。
6. 课程表具体规定以《广东省自学考试新旧专业考试计划课程对应表说明》为准。