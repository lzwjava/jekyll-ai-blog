...
lang: zh
layout: post
title: Spring Boot 包结构解析
translated: true
type: note
---

开始分析目录：/Users/lzwjava/projects/spring-boot，级别2，包含出现次数统计：

```bash
[INFO] 开始分析目录：/Users/lzwjava/projects/spring-boot，级别2，包含出现次数统计
[INFO] 尝试处理的Java文件总数：7485
[INFO] 成功处理：7485
[INFO] 出错文件数：0
[INFO] 唯一包数量及统计：204
[INFO] 分析完成。按次数降序打印唯一包及统计：
...
开始分析目录：/Users/lzwjava/projects/spring-boot，级别3，包含出现次数统计。

```bash
[INFO] 开始分析目录：/Users/lzwjava/projects/spring-boot，级别3，包含出现次数统计
[INFO] 尝试处理的Java文件总数：7485
[INFO] 成功处理：7485
[INFO] 出错文件数：0
[INFO] 唯一包数量及统计：498
