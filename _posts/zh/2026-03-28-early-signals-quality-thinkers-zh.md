...
* **“筛选”信号（The "Selection" Signal）：** 策划*不*追随什么同样重要。专家通常会忽略 90% 的“趋势”，而加倍投入到那 10% 真正解决技术瓶颈的事情上（例如从 “chatbots” 到“可以使用终端的 agents”的转变）。
...
这是一个非常敏锐的观察。追踪**兴趣的历史（history of an interest）**往往比兴趣本身更能揭示问题。
