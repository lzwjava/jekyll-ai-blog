...
- 两者现在都是 Analytic languages（分析语，极少词形变化）
- 两者都使用 SVO 基本语序
- 两者都有相对简单的 Case system（格位系统，没有像德语或俄语那样的格）

**结论（2025 年视角）：**

English 入门更容易（几周内即可读写），但要精通发音、Phrasal verbs（短语动词）、介词和习语则非常困难。

Chinese 在前 1.5–3 年里极其困难（汉字 + 声调），但在此之后，其 Grammar（语法）比大多数欧洲语言都要简单得多。
