...
问题：在 Honor of Kings 中如何使用 Angela？

回答：

Angela（在《王者荣耀》中文版中也称为安琪拉）是 Honor of Kings 中的中路法师，擅长爆发魔法伤害、群体控制（眩晕）和范围伤害（AOE）攻击。她擅长快速清兵、远程骚扰敌人，并用眩晕和大招设置击杀。她的技能围绕叠加被动“燃烧”效果展开，以获得增加的移动速度和伤害增幅，使她在poke、gank和团战中很强。
...
| 3 | Insatiable Tome (噬神之书) | 战斗续航法吸血。 |
| 4 | Void Staff (虚无法杖) | % 魔法穿透，对抗坦克/高魔抗。 |
| 5 | Tome of Wisdom (贤者之书) | 最大魔法强度 + 生命，用于后期核弹。 |
| 6 | 灵活：Daybreak (辉月) 用于生存，或 Bloodweeper 用于更多 CDR/法吸。 |
...
- **团战**：草丛 2 > 1 > 3 针对后排。跟在坦克身后；大招提供护盾。
- **逃生**：2（减速/眩晕追击者）> 1（叠层加速）> Flash。
