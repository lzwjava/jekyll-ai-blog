...
1. **Sales & Business Development** (highest concentration of happy ESTPs)
   - Enterprise / high-ticket B2B sales
   - Real estate sales / commercial brokerage
   - Car / yacht / luxury goods sales
   - Tech / SaaS sales (尤其是早期阶段 / founder-led companies)
   - Medical device / pharmaceutical sales
   - 佣金导向且提成不设限的职位

2. **Entrepreneurship & Founding**
   - Serial entrepreneurship (多个 1–5 年的项目)
   ...
   - 早期阶段 Startup co-founder (0–50 人的混乱扩张期)

3. **Trades, Technical & Field-Based Roles**
   - Commercial pilot / helicopter pilot
   - Air traffic controller
   - Paramedic / firefighter / SWAT / special forces
   - Offshore oil rig worker / commercial diver
   - Electrician / plumber / HVAC (尤其是带领自己的团队)
   - Heavy equipment operator / crane operator

4. **Action-Oriented Professional Services**
   - Management consulting (侧重 implementation / turnaround 项目，而非 strategy slide decks)
...
5. **High-Adrenaline / High-Risk / High-Reward Fields**
   - Proprietary trading / day trading / crypto trading
   - Hedge fund / prop desk floor trader (目前较少见)
   - Bounty hunter / private investigator
   - Stunt performer / film action coordinator
   - Adventure tourism operator (skydiving, white-water rafting 等)

6. **Marketing & Growth Roles with Freedom**
   - Growth hacker / performance marketing lead
   - Influencer / 具有强个人品牌的 content creator
...
- Software developer (maintenance / legacy code 阶段)
- HR generalist / corporate policy roles
- 大多数政府 / civil service 工作
- 监管严格的 corporate middle-management
- Data analyst (纯报告类，非 insight + action 类)
...
- 具有身体行动 + 解决问题特性的外勤职位
- 在 Startup 中进行短期高强度冲刺 (2–4 年)，随后休息 / 旅行
