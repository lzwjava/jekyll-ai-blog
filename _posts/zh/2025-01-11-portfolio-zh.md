...
PDF 文件可在此处找到 [here](/assets/resume/智维.Li.Portfolio.pdf)。

这个软件合集代表了我多年来有幸参与的多样化项目，与各种知名公司和合作伙伴合作。

我感激这些合作提供的机会和经验，并期待继续为未来的事业贡献我的技能和专业知识。

## Uva & Codeforces, Java & C++, 2008-2013 & 2021

在在线评测系统上解决了大约 1000 个算法问题。

Uva Online Judge 记录请见 [here](https://uhunt.onlinejudge.org/id/113519)。

<div align="center"><img src="/assets/images/portfolio/uva.png"/><img /></div>

我所解决的算法问题范围涵盖了各种领域，包括 data structures、graph、mathematics、string processing、geometry 以及其他若干高级或专业主题。

## Flower Recognition, Android, 2014.4 - 2014.8

开发了一款花卉识别 Android 应用，帮助用户通过拍照并绘制圆圈来辅助识别花卉。
...
[开源于 GitHub](https://github.com/lzwjava/flower-recognition)，33 commits。

## iword, Android, 2014.3

一款帮助用户通过观看电影片段学习英语的 Android 应用。
...
[SegmentFault: 2014 AVOS Cloud 黑客松回顾](https://segmentfault.com/a/1190000000427302)

## Bjfu Assistant, Android, 2014.1 - 2014.6

一款校园助手 Android 应用，集成了查询成绩和参与校友论坛等功能。
...
LeanChat 是一款聊天应用，包括好友管理、群组管理、基于位置的消息、附近的人、个人资料以及登录/注册功能，充分利用了 LeanCloud 的存储和通信能力。
...
[开源于 GitHub](https://github.com/lzwjava/leanchat-android)，412 commits。
...
[开源于 GitHub](https://github.com/lzwjava/leanchat-ios)，446 commits。
...
参与了 LeanCloud Java SDK 和 Objective-C SDK 的开发，为开发者提供工具，便于将 LeanCloud 服务集成到应用中。

**Technologies Used:** Java, Objective-C, LeanCloud

**Responsibilities:**
- 为 LeanCloud 的 Java SDK 和 Objective-C SDK 贡献开发工作。
- 确保 LeanCloud 服务（如 object storage、file storage 和 messaging）的无缝集成。
...
开发了一款 Chrome 插件，当浏览器标签页过多导致混乱时自动关闭最旧的标签页，从而提升浏览器性能和用户体验。

**Technologies Used:** JavaScript, Chrome API

开源于 [GitHub](https://github.com/lzwjava/TabsKiller)，19 commits。
...
创建了一款 Xcode 插件，用于在当前仓库中无缝导航至 GitHub 的关键功能。该插件允许用户快速访问 GitHub History、Blame、Pull Requests、Issues 和 Notifications。

**Technologies Used:** Objective-C, Xcode Plugin API

开源于 [GitHub](https://github.com/lzwjava/Reveal-In-GitHub)，57 commits。
...
CodeReview 是一个专业的代码审查、沟通和分享平台。工程师可以提交代码，由专家审查以提升代码质量。
...
- 使用 Vue.js 实现前端功能。
- 集成 Alibaba Cloud 以提供可扩展和可靠的基础设施。
- 处理用户管理、代码提交和审查流程、通知系统、支付集成以及活动/工作坊管理。
...
趣直播是一个知识直播平台，用户可以参与编程或设计等各种知识讲座。用户可以付费参加直播课程或向讲师打赏。
...
- 集成了 OBS 工具用于直播。
- 实现了用户注册、支付和通知功能。
- 实现了显著的用户参与度，约有 30000 名用户和数百万页面浏览量。
...
Mianbao Live 是一家一站式内容变现和社会经济解决方案提供商。
...
Chongding 是一款类似于 HQ Trivia 的移动端答题应用，用户可以参与直播答题游戏并赢取奖金。
...
- 开发了后端服务和管理面板前端。
- 设计并实现了实时答题游戏功能。
- 为直播与游戏事件同步贡献了技术方案，使用 SEI (Supplemental Enhancement Information)。
...
ShowMeBug 是一个支持实战编程的技术能力评估平台，能够高效、准确地评估和招聘技术人才。

将 ShowMeBug 与企业微信集成，实现无缝访问企业微信生态中的技术面试工具。
...
LvchenSign 专注于为各种企业和活动制作广告标牌。以质量和创意为重点，努力提供提升品牌并吸引受众的视觉解决方案。
...
开源于 [GitHub](https://github.com/lzwjava/lvchensign)，40 commits。在线页面：[lvchesign.com](http://lvchensign.com)。
...
- 集成了 Avaloq API 以增强底层基础设施并提升用户体验。

<div align="center">

<img src="/assets/images/portfolio/clientconnect.png"/><img/>
<p><a href="https://www.dbs.com/private-banking/digital-experience.page">图片来源：https://www.dbs.com</a></p>
...
**Responsibilities:**
- 增强了公募基金申购和赎回功能，提升用户体验和系统可靠性。
- 修复了结构化投资产品、投资组合和交易列表相关微服务的 bug 并优化代码，从而贡献于整体系统稳定性和准确性。
- 进行了性能测试并分析日志生成 QPS 报告，与团队成员协作优化性能。
- 开发了自动化测试生成工具，用于测试工具 Karate，从而简化测试流程并提升测试覆盖率。
...
PayMe from HSBC 是向朋友发送付款以及在线下在线向商户进行移动支付的便捷方式。
...
- 应用面向对象编程原则优雅处理情况，并使用面向切面编程审计自动充值表的变更日志。
- 在 AWS 迁移过程中协助团队，排查 IAM 和 RDS 配置以确保平稳过渡。
...
- 实现了 Prometheus 用于监控和 ELK stack 用于日志管理。
...
**Responsibilities:**
- 作为后端工程师，通过 TEKsystems 外包至 HSBC Bank，在 HSBC 企业技术部门的一个 Finance Transformation Platform 模块中开发和优化后端系统。
- 维护财务数据处理功能，包括导入、验证和导出，同时增强新财务标题的提交和审批工作流。积累了会计、账簿和银行系统的经验。
- 参与完整开发生命周期，从本地开发到 UAT 测试和生产发布。帮助停用运行在 WebSphere Application Server 上的遗留应用。使用 Ansible 和 Jenkins 自动化发布，协助将 Angular 升级到主要版本，并乐于处理各种任务——尤其是为团队解决瓶颈。
- 领导模块的集成和 API 测试，使用 Copilot API 自动生成约 70 个测试用例，覆盖 Java 中的 Spring Filters、Python unittest、JSON 截断、prompt engineering 和区域端点。
- 将自己打造成一个自治的人形 AI 代理，尽可能自动化——通过脚本、日志、文档和分享。通过实现 LLM 输出缓存和验证，为 20 个定制代理创建专用提示和上下文，并利用 400 个 Copilot 编写的可重用脚本和 1100 个 Copilot 编写的跨技术栈指南，在大型银行的工程体验开始变得愉快。
...
- 加入 HSBC 内部 AI 社区；下班后保持对 AI 进展的更新；使用 Andrej Karpathy 的 nanoGPT 训练小型模型；利用 OpenRouter 和 Claude Code 在个人项目中进行大量编码；过去一年消耗约 3.2 亿 tokens；学习了 MCP、LangChain、Codex、reasoning 等知识。

以下是 HSBC Business Internet Banking 平台的截图，展示了类似技术和架构部署的企业级财务系统类型。

<div align="center">

<img src="/assets/images/portfolio/hsbc-platform.png" width="200px" /><img/>

<p><a href="https://www.online-banking.business.hsbc.com.hk">图片来源：HSBC Business Internet Banking Information Hub</a></p>
