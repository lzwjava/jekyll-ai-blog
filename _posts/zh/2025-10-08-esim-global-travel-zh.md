...
title: 全球旅行首选爱斯基摩电子SIM卡
translated: true
type: note
---

Eskimo是一款提供国际旅行虚拟eSIM（嵌入式SIM卡）服务的移动应用，用户无需实体SIM卡或支付漫游费用，即可在130多个国家接入高速移动数据。该应用专为游客和频繁出行者设计，提供经济实惠的数据套餐，特色功能包括：通过二维码即时激活、新用户免费试用、未使用流量永不过期、有效期长达2年的套餐——这在旅行eSIM领域尚属首创。
