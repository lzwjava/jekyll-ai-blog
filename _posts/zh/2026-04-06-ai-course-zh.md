...
- 趣直播 — [GitHub](https://github.com/lzwjava/live-mobile-web)，一个基于微信的面向iOS、Android、后端及AI内容开发者的技术直播平台。运营于2016至2017年，约3万用户。
- 个人博客 — [lzwjava.github.io](https://lzwjava.github.io)，一个AI驱动的一站式博客系统，具备AI翻译等功能。运营自2021年至今，月浏览量约6万（Cloudflare）。
...
要报名，请发送邮件至<lzwjava@gmail.com>，主题为"AI Course Enrollment"。请在邮件中附上简短的自我介绍以及学习AI的动机。您也可以[点击此处了解更多](https://lzwjava.github.io/contact-en)。
