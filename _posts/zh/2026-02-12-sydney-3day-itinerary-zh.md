...
Question: 如何游览 Sydney？制定一份 3 日游计划
...
- **从机场到市区**：
  - **Train** (Airport Link) → 最快（到 Central Station 或 Circular Quay 约 13 分钟），使用 Opal 卡或感应式支付单程费用约 AUD 15–20。
  - **Taxi / rideshare** (Uber, Ola) → 约 AUD 45–65，视交通状况需 20–40 分钟。
  - **Shuttle buses** 或公共巴士也可供选择。
...
- 穿过 **Royal Botanic Garden**（免费），从那里可以回望歌剧院和海港的美景。
- 前往 **Sydney Harbour Bridge** — 走人行道通过（免费，单程约 30–45 分钟），或参加著名的 **BridgeClimb**（需提前预订，3–3.5 小时，价格昂贵但令人难忘）。
- **午餐** — The Rocks 区域（历史悠久的酒馆、咖啡馆，周末有集市）。
...
- **午餐** — Bondi（炸鱼薯条、咖啡馆，或在 Icebergs Dining Room 享用高档景观餐）。
...
- 可选：短途沿海徒步或海滩时光。
- 中午左右乘坐渡轮返回。
- **下午** — 参观 **Taronga Zoo**（从 Circular Quay 直接乘坐渡轮，拥有绝佳的海港景观 + 澳洲特色动物：考拉、袋鼠、鸭嘴兽）。预留 3–4 小时。
- 备选方案：如果您比起动物园更喜欢大自然，可以参加 **Blue Mountains 日游**（最热门的周边游，约 12 小时，包括 Three Sisters、Scenic World 和野生动物）。
...
该计划涵盖了**必读景点**，且行程不会过于匆忙。如果您有特定兴趣（美食、探险、亲子、省钱），请告诉我以便进行调整！
