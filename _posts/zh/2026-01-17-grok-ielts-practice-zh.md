...
title: 利用 Grok 指令增强雅思备考练习
translated: true
type: note
---

问题：我该如何在 Grok 中使用 custom instructions 来提升我的 IELTS 备考效果，让其回答变得更难读、更具挑战性？

回答：

你可以利用 Grok 的 **custom instructions** 功能（适用于 grok.x.ai 或 X app 登录用户）来永久性地设定 Grok 在对话中的回复方式。这对于 IELTS 练习非常完美，因为你可以指示 Grok 刻意提高难度——强迫你更仔细地阅读，应对高级 vocabulary、复杂的 sentence structures 和微妙的观点——这能直接训练阅读理解能力、vocabulary range 以及整体的 language processing 速度。
...
### 推荐的 custom instruction 文本（可直接复制粘贴）

**选项 A – 均衡的高难度（推荐给大多数目标分为 7.0+ 的 IELTS 考生）**
...
**选项 C – 侧重于 writing & speaking model（针对性极强）**
...
- 随着你的水平提高，每隔几周重新审视并调整这些指令。

这种设置能将 Grok 变成一位非常严苛的 IELTS 教练，比标准回答更能压榨你的 receptive 和 productive 技能——这正是许多人从 6.5–7.0 突破到 7.5+ 所需要的。
