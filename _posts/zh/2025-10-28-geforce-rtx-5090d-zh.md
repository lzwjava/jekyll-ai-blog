...
title: 英伟达GeForce RTX 5090D显卡
translated: true
type: note
---

**5090D** 指代 NVIDIA GeForce RTX 5090D，这是 NVIDIA 基于 Blackwell 架构的 RTX 50 系列高端图形处理单元（GPU）。作为标准 RTX 5090 的变体版本，该产品主要面向中国市场设计，通过硬件调整（如 V2 版本采用的缩减至 384 位内存总线与 24GB GDDR7 显存）以符合出口管制规定，同时保持与完整版 5090 近乎相同的游戏性能。
