...
title: Ultra Mobile PayGo 电话号码使用方法
translated: true
type: note
---

问题：Ultra Mobile PayGo USA 电话号码有何用途？
...
- **国际漫游**：支持语音、短信/彩信国外漫游，从您的 PayGo 钱包余额中扣费（数据漫游可通过附加组件获得）。非常适合需要偶尔海外连接的旅行者。
- **Wi-Fi 通话和热点**：免费 Wi-Fi 通话，可通过互联网连接使用，以及移动热点共享，用于与其他设备共享数据。
- **语音邮件和账户管理**：拨打 1 或 123 访问语音邮件，并通过短信（例如，发送 BAL 到 6700）、Ultra Mobile 应用程序或在线门户管理余额/服务。
- **携号转入和灵活性**：轻松将现有号码转入服务，并将其用于验证（例如，应用程序/银行的两步验证）或作为隐私的副线。
