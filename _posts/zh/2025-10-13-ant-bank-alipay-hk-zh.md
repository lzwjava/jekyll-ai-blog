...
- **支付与转账**：无缝集成跨境支付，包括向中国大陆、日本和其他地区的转账。

您可以直接通过AlipayHK应用使用蚂蚁银行服务，无需单独下载——它作为小程序嵌入，方便随时随地进行银行操作。

### 中国大陆公民能否使用港澳通行证或回乡证开设蚂蚁银行账户？
...
- **身份证明文件**：
  - 有效的中国大陆居民身份证。
  - 回乡证（作为您访问香港并在香港开立账户的资格证明）。
  - 无需香港身份证——蚂蚁银行等虚拟银行明确接受大陆身份证。
- **地理位置**：您必须亲身在香港完成开户流程（虚拟银行对非居民要求现场验证）。
- **其他**：需要一个香港手机号码（抵达后可以购买游客SIM卡）和地址证明（例如，酒店预订或通行证本身可能适用于短期停留）。
- **流程**：
  1. 下载AlipayHK应用（iOS/Android可用），并使用您的中国手机号或邮箱注册账户。
  2. 在应用中，导航至蚂蚁银行小程序。
  3. 提交您的身份证件和通行证详情进行电子化客户身份验证——审批通常是即时或几分钟内完成。
  4. 无需初始存款，也没有开户费。

这适用于个人账户；商业账户有更严格的规定。请注意，虽然大陆公民可以关联账户用于跨境使用（例如通过AlipayHK在中国进行支付），但某些功能如人民币转账可能会根据香港金融管理局的规定有限制。
...
- [大陆居民如何获得香港银行卡？](https://www.binance.com/pt/square/post/23378582738882)
- [香港银行开户指南](https://en.xiaoz.org/post/19437)
- [转账与汇款常见问题 - AlipayHK](https://www.alipayhk.com/en/faq-shoppers/transfer-and-remittance/)
