...
人们通常说的“RoPE 哥们”指的是**苏剑林**。

他是一位中国的自然语言处理研究员/工程师，因提出**RoPE（旋转位置编码）**而闻名。RoPE是一种广泛应用于现代大语言模型架构（如类LLaMA模型）的位置编码方法。
...
* [https://arxiv.org/abs/2104.09864](https://arxiv.org/abs/2104.09864)（RoFormer / RoPE论文）