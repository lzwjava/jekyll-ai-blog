...
问题：为什么有时专注力轻松自如，能快速完成几十道考题、code 或阅读材料，而有时甚至一道选择题都无法集中注意力？

答案：

这种专注能力的极端对比非常常见——几乎所有从事深度认知工作的人都会经历它。大脑的专注能力不是稳定的“技能水平”，而是一种**瞬时状态**，受许多快速变化的变量影响。
...
- **Cortisol / nervous system state**——压力/负担过重导致高cortisol → 执行功能关闭
- **Dopamine baseline**——在高刺激活动（social media、gaming、porn、激动对话）后，大脑暂时降低dopamine敏感度 → 正常工作感觉无聊且痛苦
- **Inflammation / gut-brain axis**——细微食物反应、前一天饮酒、疾病前期症状
...
4. 过去12–36小时内是否消费了高dopamine内容？
5. 我是否暗自认为完成这项任务不会真正帮助我/会暴露我不称职？
...
- 10 min 非常简单的“gateway task”（整理笔记、抄写公式、画mindmap）
- 完全换地点（library、café、不同房间）
- 写下如果你失败这项任务最害怕的结果 → 往往减少无意识阻力
- 5 min 极高强度运动（push-ups、burpees、jump rope）
- 15 min 故意phone/internet blackout + 把phone放另一个房间

关键认识是：**focus 主要不是意志力问题——而是状态管理问题**。

当你处于“魔法专注”状态时，几乎一切在生物和心理上都对齐。当你卡住时，通常几个因素同时失调。

所以与其用“我必须专注！”来对抗自己，通常更有效的是问：
“目前什么在阻挡我大脑的自然专注引擎？”

修复最大的1–2个障碍 → 专注往往出人意料地快速恢复。

参考文献：

- 无（这是从神经科学、心理学和生产力模式中综合而来；无单一来源引用）
