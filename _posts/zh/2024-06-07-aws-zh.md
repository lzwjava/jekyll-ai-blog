...
> 无法连接到您的实例
> EC2 Instance Connect无法连接到您的实例。请确保您的实例网络设置已正确配置以使用EC2 Instance Connect。更多信息请参见<https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-connect-prerequisites.html。>
