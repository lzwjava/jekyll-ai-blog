...
- **Sino-Forest Corp (2011)**: 这被广泛认为是 Muddy Waters 的成名作和最具影响力的报告。他们指控这家中国林业公司是一个“数十亿美元的 Ponzi scheme”，通过虚假木材持有量来夸大资产和收益。股价随后暴跌超过 80%，最终导致公司破产、监管机构调查，并使 John Paulson 等投资者遭受巨额损失。

### Other Notable Historical Reports

- **Luckin Coffee (2020)**: 指控其伪造销售数据，直接导致了该公司的造假丑闻和退市。
- **NQ Mobile (2013)**: 声称其拥有虚构的客户和收入。
- **NMC Health (2019)**: 揭露了其夸大的现金余额和财务违规行为。

### Recent Major Reports (2025)

- **AppLovin (APP US, March 2025)**: 指控该公司通过收集 user IDs 违反了 platform terms of service，并且在 e-commerce 转化中的增量贡献极低（仅 25-35%），同时存在高 churn 和隐私违规问题。随后的一份后续报告中指出其 CEO 的回应是不真实的。
- **FTAI Aviation Ltd. (FTAI US, January 2025)**: 指称其财务报告存在误导，将一次性发动机销售归类为经常性维护收入（recurring maintenance revenue），且涉及潜在的制裁违规（出售给伊朗实体）以及夸大的利润率。
- **e.l.f. Beauty, Inc. (ELF US, early 2025)**: 指称其虚增收入和利润，可能是由于销售不足导致了 inventory 积压。
