...
- I configured it to automatically switch networks. The network seems unstable when it’s switching between networks.

- I’ve only used it for one day, so I need to gain more experience.
