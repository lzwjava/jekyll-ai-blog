...
I'm offering a series of AI agent courses. 50 CNY per session (30 minutes). Pay per session, no package required. I'm happy to share what I've learned.
...
- Previously at TEKsystems (outsourced to a UK-based international bank). Previous experience includes LeanCloud, Beijing Square Root, Beyondsoft (outsourced to a Singapore bank), and Farben Information (outsourced to a UK-based international bank).
...
* How to use Hermes Agent (the CLI AI assistant I use daily)
* How to use Claude Code — the coding agent from Anthropic
* Agent loops, tool calling, memory — the concepts explained simply
* Building your own simple agent workflow
