...
- Participated in the full development lifecycle, from local development to UAT testing and production releases. Helped decommission legacy applications running on WebSphere Application Server. Automated data extraction script releases using Ansible and Jenkins, assisted in upgrading Angular to a major version, and enjoyed tackling all kinds of tasks—especially resolving bottlenecks for the team.
