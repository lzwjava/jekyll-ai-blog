...
- Studied for one year at Beijing Forestry University before dropping out. Pursuing an associate degree through self-taught education, with fourteen courses completed.
...
- AI Engineer outsourced to HSBC Bank under TEKsystems, leveraging Copilot and its API to accelerate backend development for a module of the Finance Transformation Platform in HSBC’s Enterprise Technology Department. 
...
- National Higher Education Self-study Examination. Passed 14 courses as of today, Introduction to Operating Systems, Introduction to Data Structures, Advanced Language Programming (I), English (I), Advanced Mathematics, Database and Applications, Computer Application Technology, Introduction to Law, Computer Organization and Architecture, Introduction to Programming—Java, Mobile Application Development Technology, Web Design and Production, Fundamentals of Computer Programming, and Ideological and Moral Cultivation and Rule of Law.
...
- Expected Positions: AI Engineer / Full Stack Engineer / Backend Engineer / Machine Learning Engineer / Member of Technical Staff
