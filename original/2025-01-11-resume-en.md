...
- Native in Chinese, proficient in English (IELTS 6.5). Read over 320 books spanning textbooks, personal development, business, technology and history. Read around 2000 comprehensive, long AI answers in the past year.
...
- Generous knowledge sharer with AI assistance to help fix grammar, having around 400 original posts on the blog attracting around 60,000 page views a year, and who documents a lot in the corporate environment too.
...
- Participated the full development lifecycle, from local development to UAT testing and production releases. Copilot was heavily utilized for tasks such as analyzing root causes, generating reusable Python scripts, and documenting around 900 technical guides. Some of these guides became key references for teammates facing similar challenges.
- Made myself an autonomous humanoid AI agent that automates as much as possible—through scripting, logging, documenting, and sharing. With caching and validation of LLM outputs, dedicated prompts and contexts for 20 customized or vertical agents, and 400 reusable Copilot-written scripts across the tech stack, the engineering experience in a large bank has started to feel good.
...
- Worked with technologies such as Java, Spring, IBM Db2, Maven, Nexus, Angular, Python, HashiCorp Vault and Ansible, along with tools including Windows, Control-M, IBM WebSphere Application Server, and Copilot.  
