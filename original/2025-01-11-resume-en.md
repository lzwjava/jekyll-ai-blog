...
- Native in Chinese, proficient in English (IELTS 6.5). Read over 320 books spanning textbooks, personal development, business, technology and history. Read around 5000 comprehensive, long AI answers in the past year.
- Developed 10 open-source GitHub projects as a main developer, each with over 500 commits available at https://github.com/lzwjava. Detailed software portfolio available at https://lzwjava.github.io/portfolio-en.
- Generous knowledge share with around 400 original posts on the blog attracting around 60,000 page views a year, and who documents a lot in the corporate environment too.
...
- Engineer with an entrepreneurial spirit and a product mindset, using 3 mobile phones and five hundred of apps and games to play with. Work as an autonomous AI agent, proficient with extensive AI tools, and becoming better with comprehensive logging and testing.
...
###  TEKsystems, Backend Engineer(Outsourced to HSBC Bank), 2025.02 - Present
...
- Joined the internal HSBC AI Community; Received the Contribution Award for the internal high-profile project, AIPlayer, at HSBC; stayed updated on AI progress after work; trained small models using Andrej Karpathy's nanoGPT; utilized OpenRouter and Claude Code for extensive coding in personal projects; consumed approximately 1 billion tokens over the past year; learned a bit about MCP, LangChain, Codex, reasoning, and more.
- Developing autonomous AI engineering workflows using OpenClaw for multi-machine cluster control, training domain-specialized models on H200 GPUs, and building self-hosted open-source systems with Claude Code to deliver end-to-end independent software projects.
