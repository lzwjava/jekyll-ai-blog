...
3. Members treat each other with equality and respect.

4. We don’t pursue large numbers; the wisdom of a small group is enough to stay ahead of the times.

5. Admin role rotates among group members, one at a time. Each admin serves for one month, then passes the role to the next member. Admins are responsible for sharing at least 5 posts related to AI, LLM, or adjacent topics during their term.

6. Topics related to circumvention tools or sensitive politics should be discussed in private chats to remain compliant.
