...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Test Cloudflare DoH")
    parser.add_argument("hostname", nargs="?", default="www.google.com",
                        help="Hostname to query (default: www.google.com)")
    parser.add_argument("--qtype", "-q", default="A",
                        help="Query type (default: A)")
    args = parser.parse_args()

    success = test_cloudflare_doh(args.hostname, args.qtype)
    print(f"\nSuccess: {success}")